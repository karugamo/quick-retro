 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=function(t,e){if(!t)throw Yn(e)},Yn=function(t){return new Error("Firebase Database ("+ku.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E_="FirebaseError";class Qn extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=E_,Object.setPrototypeOf(this,Qn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ms.prototype.create)}}class Ms{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?b_(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new Qn(i,a,s)}}function b_(t,e){return t.replace(C_,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const C_=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ds=hg;function gg(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:Bu,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw an.create("bad-app-name",{appName:String(s)});const i=gi.get(s);if(i){if(_i(t,i.options)&&_i(n,i.config))return i;throw an.create("duplicate-app",{appName:s})}const r=new M_(s);for(const a of Zr.values())r.addComponent(a);const o=new _g(t,n,r);return gi.set(s,o),o}function Wu(t=Bu){const e=gi.get(t);if(!e)throw an.create("no-app",{appName:t});return e}function Mt(t,e,n){var s;let i=(s=dg[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),$o.warn(a.join(" "));return}Fn(new on(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kl=new Ho("@firebase/auth");function ii(t,...e){kl.logLevel<=K.ERROR&&kl.error(`Auth (${Ds}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lg=new Ls(3e4,6e4);function zu(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function Yi(t,e,n,s,i={}){return Ku(t,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const a=Jn(Object.assign({key:t.config.apiKey},o)).slice(1),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode),qu.fetch()(Yu(t,t.config.apiHost,n,a),Object.assign({method:e,headers:l,referrerPolicy:"no-referrer"},r))})}async function Ku(t,e,n){t._canInitEmulator=!1;const s=Object.assign(Object.assign({},Dg),e);try{const i=new Fg(t),r=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw Er(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw Er(t,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw Er(t,"email-already-in-use",o);const u=s[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw kg(t,u,c);yt(t,u)}}catch(i){if(i instanceof Qn)throw i;yt(t,"network-request-failed")}}async function Gu(t,e,n,s,i={}){const r=await Yi(t,e,n,s,i);return"mfaPendingCredential"in r&&yt(t,"multi-factor-auth-required",{_serverResponse:r}),r}function Yu(t,e,n,s){const i=`${e}${n}?${s}`;return t.config.emulator?zo(t.config,i):`${t.config.apiScheme}://${i}`}class Fg{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(it(this.auth,"network-request-failed")),Lg.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Er(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const i=it(t,e,s);return i.customData._tokenResponse=n,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ug(t,e){return Yi(t,"POST","/v1/accounts:delete",e)}async function Bg(t,e){return Yi(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fs(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Wg(t,e=!1){const n=Xe(t),s=await n.getIdToken(e),i=Ko(s);O(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const r=typeof i.firebase=="object"?i.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:i,token:s,authTime:fs(br(i.auth_time)),issuedAtTime:fs(br(i.iat)),expirationTime:fs(br(i.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function br(t){return Number(t)*1e3}function Ko(t){const[e,n,s]=t.split(".");if(e===void 0||n===void 0||s===void 0)return ii("JWT malformed, contained fewer than 3 sections"),null;try{const i=Qr(n);return i?JSON.parse(i):(ii("Failed to decode base64 JWT payload"),null)}catch(i){return ii("Caught error parsing JWT payload as JSON",i),null}}function Hg(t){const e=Ko(t);return O(e,"internal-error"),O(typeof e.exp!="undefined","internal-error"),O(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ri(t,e,n){return`firebase:${t}:${e}:${n}`}class kn{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:i,name:r}=this.auth;this.fullUserKey=ri(this.userKey,i.apiKey,r),this.fullPersistenceKey=ri("persistence",i.apiKey,r),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?nn._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new kn(pt(Pl),e,s);const i=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let r=i[0]||pt(Pl);const o=ri(s,e.config.apiKey,e.name);let a=null;for(const c of n)try{const u=await c._get(o);if(u){const h=nn._fromJSON(e,u);c!==r&&(a=h),r=c;break}}catch{}const l=i.filter(c=>c._shouldAllowMigration);return!r._shouldAllowMigration||!l.length?new kn(r,e,s):(r=l[0],a&&await r._set(o,a.toJSON()),await Promise.all(n.map(async c=>{if(c!==r)try{await c._remove(o)}catch{}})),new kn(r,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ol(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(eh(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Xu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(nh(e))return"Blackberry";if(sh(e))return"Webos";if(Go(e))return"Safari";if((e.includes("chrome/")||Zu(e))&&!e.includes("edge/"))return"Chrome";if(th(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Xu(t=we()){return/firefox\//i.test(t)}function Go(t=we()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Zu(t=we()){return/crios\//i.test(t)}function eh(t=we()){return/iemobile/i.test(t)}function th(t=we()){return/android/i.test(t)}function nh(t=we()){return/blackberry/i.test(t)}function sh(t=we()){return/webos/i.test(t)}function Qi(t=we()){return/iphone|ipad|ipod/i.test(t)}function Gg(t=we()){var e;return Qi(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Yg(){return m_()&&document.documentMode===10}function ih(t=we()){return Qi(t)||th(t)||sh(t)||nh(t)||/windows phone/i.test(t)||eh(t)}function Qg(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi extends Qn{constructor(e,n,s,i){var r;super(n.code,n.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,yi.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,i){return new yi(e,n,s,i)}}function lh(t,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?yi._fromErrorAndOperation(t,r,e,s):r})}async function tm(t,e,n=!1){const s=await Ss(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Bt._forOperation(t,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sm(t,e,n=!1){const s="signIn",i=await lh(t,s,e),r=await Bt._fromIdTokenResponse(t,s,i);return n||await t._updateCurrentUser(r.user),r}function im(t,e,n,s){return Xe(t).onAuthStateChanged(e,n,s)}const vi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ch{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(vi,"1"),this.storage.removeItem(vi),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bm(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}function Cm(t){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",t),s.onload=e,s.onerror=i=>{const r=it("internal-error");r.customData=i,n(r)},s.type="text/javascript",s.charset="UTF-8",bm().appendChild(s)})}function Im(t){return`__${t}${Math.floor(Math.random()*1e6)}`}new Ls(3e4,6e4);/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Um(t,e={}){return Yi(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function py(t=Wu()){const e=Vo(t,"auth");return e.isInitialized()?e.getImmediate():Ag(t,{popupRedirectResolver:uy,persistence:[Em,lm,dh]})}fy("Browser");const jl="@firebase/database",ql="0.12.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eh=function(t){try{if(typeof window!="undefined"&&typeof window[t]!="undefined"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new gy(e)}}catch{}return new my},Xt=Eh("localStorage"),no=Eh("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci extends Bh{constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!Wo()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new Ci}getInitialEvent(e){return E(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zi{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new F(Un,e),i=new F(Un,n);return this.compare(s,i)!==0}minPost(){return F.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oo;function mv(t){oo=t}const Vh=function(t){return typeof t=="number"?"number:"+Ih(t):"string:"+t},jh=function(t){if(t.isLeafNode()){const e=t.val();E(typeof e=="string"||typeof e=="number"||typeof e=="object"&&lt(e,".sv"),"Priority must be a string or number.")}else E(t===oo||t.isEmpty(),"priority of unexpected type.");E(t===oo||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let qh,zh;function yv(t){qh=t}function vv(t){zh=t}class Ev extends Zi{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?pn(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return F.MIN}maxPost(){return new F(un,new he("[PRIORITY-POST]",zh))}makePost(e,n){const s=qh(e);return new F(n,new he("[PRIORITY-POST]",s))}toString(){return".priority"}}const oe=new Ev;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bv=Math.log(2);class Cv{constructor(e){const n=r=>parseInt(Math.log(r)/bv,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=n(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const Ii=function(t,e,n,s){t.sort(e);const i=function(l,c){const u=c-l;let h,f;if(u===0)return null;if(u===1)return h=t[l],f=n?n(h):h,new de(f,h.node,de.BLACK,null,null);{const g=parseInt(u/2,10)+l,b=i(l,g),S=i(g+1,c);return h=t[g],f=n?n(h):h,new de(f,h.node,de.BLACK,b,S)}},r=function(l){let c=null,u=null,h=t.length;const f=function(b,S){const N=h-b,U=h;h-=b;const ae=i(N+1,U),X=t[N],Z=n?n(X):X;g(new de(Z,X.node,S,null,ae))},g=function(b){c?(c.left=b,c=b):(u=b,c=b)};for(let b=0;b<l.count;++b){const S=l.nextBitIsOne(),N=Math.pow(2,l.count-(b+1));S?f(N,de.BLACK):(f(N,de.BLACK),f(N,de.RED))}return u},o=new Cv(t.length),a=r(o);return new Ae(s||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Rr;const En={};class _t{constructor(e,n){this.indexes_=e,this.indexSet_=n}static get Default(){return E(En&&oe,"ChildrenNode.ts has not been loaded"),Rr=Rr||new _t({".priority":En},{".priority":oe}),Rr}get(e){const n=Ln(this.indexes_,e);if(!n)throw new Error("No index defined for "+e);return n instanceof Ae?n:null}hasIndex(e){return lt(this.indexSet_,e.toString())}addIndex(e,n){E(e!==Pn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=n.getIterator(F.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let a;i?a=Ii(s,e.getCompare()):a=En;const l=e.toString(),c=Object.assign({},this.indexSet_);c[l]=e;const u=Object.assign({},this.indexes_);return u[l]=a,new _t(u,c)}addToIndexes(e,n){const s=pi(this.indexes_,(i,r)=>{const o=Ln(this.indexSet_,r);if(E(o,"Missing index implementation for "+r),i===En)if(o.isDefinedOn(e.node)){const a=[],l=n.getIterator(F.Wrap);let c=l.getNext();for(;c;)c.name!==e.name&&a.push(c),c=l.getNext();return a.push(e),Ii(a,o.getCompare())}else return En;else{const a=n.get(e.name);let l=i;return a&&(l=l.remove(new F(e.name,a))),l.insert(e,e.node)}});return new _t(s,this.indexSet_)}removeFromIndexes(e,n){const s=pi(this.indexes_,i=>{if(i===En)return i;{const r=n.get(e.name);return r?i.remove(new F(e.name,r)):i}});return new _t(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wv=!0;function ce(t,e=null){if(t===null)return x.EMPTY_NODE;if(typeof t=="object"&&".priority"in t&&(e=t[".priority"]),E(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof t=="object"&&".value"in t&&t[".value"]!==null&&(t=t[".value"]),typeof t!="object"||".sv"in t){const n=t;return new he(n,ce(e))}if(!(t instanceof Array)&&wv){const n=[];let s=!1;if(be(t,(o,a)=>{if(o.substring(0,1)!=="."){const l=ce(a);l.isEmpty()||(s=s||!l.getPriority().isEmpty(),n.push(new F(o,l)))}}),n.length===0)return x.EMPTY_NODE;const r=Ii(n,gv,o=>o.name,aa);if(s){const o=Ii(n,oe.getCompare());return new x(r,ce(e),new _t({".priority":o},{".priority":oe}))}else return new x(r,ce(e),_t.Default)}else{let n=x.EMPTY_NODE;return be(t,(s,i)=>{if(lt(t,s)&&s.substring(0,1)!=="."){const r=ce(i);(r.isLeafNode()||!r.isEmpty())&&(n=n.updateImmediateChild(s,r))}}),n.updatePriority(ce(e))}}yv(ce);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sv extends Zi{compare(e,n){const s=e.node.compareTo(n.node);return s===0?pn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return F.MIN}maxPost(){return F.MAX}makePost(e,n){const s=ce(e);return new F(n,s)}toString(){return".value"}}const Rv=new Sv;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class la{constructor(e){this.index_=e}updateChild(e,n,s,i,r,o){E(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(n)?o.trackChildChange(ks(n,a)):E(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Bn(n,s)):o.trackChildChange(As(n,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(n,s).withIndex(this.index_)}updateFullNode(e,n,s){return s!=null&&(e.isLeafNode()||e.forEachChild(oe,(i,r)=>{n.hasChild(i)||s.trackChildChange(ks(i,r))}),n.isLeafNode()||n.forEachChild(oe,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(As(i,r,o))}else s.trackChildChange(Bn(i,r))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?x.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ti(){return{value:null,children:new Map}}function Gh(t,e,n){if(B(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=L(e);t.children.has(s)||t.children.set(s,Ti());const i=t.children.get(s);e=Q(e),Gh(i,e,n)}}function ao(t,e,n){t.value!==null?n(e,t.value):Ov(t,(s,i)=>{const r=new q(e.toString()+"/"+s);ao(i,r,n)})}function Ov(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mv{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&be(this.last_,(s,i)=>{n[s]=n[s]-i}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cc=10*1e3,Dv=30*1e3,Lv=5*60*1e3;class Fv{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new Mv(e);const s=cc+(Dv-cc)*Math.random();ps(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;be(e,(i,r)=>{r>0&&lt(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),ps(this.reportStats_.bind(this),Math.floor(Math.random()*2*Lv))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wn{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=Ke.MERGE}operationForChild(e){if(B(this.path)){const n=this.children.subtree(new q(e));return n.isEmpty()?null:n.value?new hn(this.source,$(),n.value):new Wn(this.source,$(),n)}else return E(L(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Wn(this.source,Q(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function er(t,e){return{eventCache:t,serverCache:e}}function _s(t,e,n,s){return er(new Ht(e,n,s),t.serverCache)}function Yh(t,e,n,s){return er(t.eventCache,new Ht(e,n,s))}function Ri(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function dn(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sE{constructor(){this.changeMap=new Map}trackChildChange(e){const n=e.type,s=e.childName;E(n==="child_added"||n==="child_changed"||n==="child_removed","Only child changes supported for tracking"),E(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(n==="child_added"&&r==="child_removed")this.changeMap.set(s,As(s,e.snapshotNode,i.snapshotNode));else if(n==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(n==="child_removed"&&r==="child_changed")this.changeMap.set(s,ks(s,i.oldSnap));else if(n==="child_changed"&&r==="child_added")this.changeMap.set(s,Bn(s,e.snapshotNode));else if(n==="child_changed"&&r==="child_changed")this.changeMap.set(s,As(s,e.snapshotNode,i.oldSnap));else throw Yn("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iE{getCompleteChild(e){return null}getChildAfterChild(e,n,s){return null}}const td=new iE;class _a{constructor(e,n,s=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=s}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new Ht(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return pa(this.writes_,e,s)}}getChildAfterChild(e,n,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:dn(this.viewCache_),r=nE(this.writes_,i,n,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rE(t){return{filter:t}}function oE(t,e){E(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),E(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function aE(t,e,n,s,i){const r=new sE;let o,a;if(n.type===Ke.OVERWRITE){const c=n;c.source.fromUser?o=ho(t,e,c.path,c.snap,s,i,r):(E(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!B(c.path),o=Ai(t,e,c.path,c.snap,s,i,a,r))}else if(n.type===Ke.MERGE){const c=n;c.source.fromUser?o=cE(t,e,c.path,c.children,s,i,r):(E(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=fo(t,e,c.path,c.children,s,i,a,r))}else if(n.type===Ke.ACK_USER_WRITE){const c=n;c.revert?o=dE(t,e,c.path,s,i,r):o=uE(t,e,c.path,c.affectedTree,s,i,r)}else if(n.type===Ke.LISTEN_COMPLETE)o=hE(t,e,n.path,s,r);else throw Yn("Unknown operation type: "+n.type);const l=r.getChanges();return lE(e,o,l),{viewCache:o,changes:l}}function lE(t,e,n){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=Ri(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&n.push(Kh(Ri(e)))}}function nd(t,e,n,s,i,r){const o=e.eventCache;if(ki(s,n)!=null)return e;{let a,l;if(B(n))if(E(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=dn(e),u=c instanceof x?c:x.EMPTY_NODE,h=fa(s,u);a=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=Ni(s,dn(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=L(n);if(c===".priority"){E(Wt(n)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const h=dc(s,n,u,l);h!=null?a=t.filter.updatePriority(u,h):a=o.getNode()}else{const u=Q(n);let h;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const f=dc(s,n,o.getNode(),l);f!=null?h=o.getNode().getImmediateChild(c).updateChild(u,f):h=o.getNode().getImmediateChild(c)}else h=pa(s,c,e.serverCache);h!=null?a=t.filter.updateChild(o.getNode(),c,h,u,i,r):a=o.getNode()}}return _s(e,a,o.isFullyInitialized()||B(n),t.filter.filtersNodes())}}function Ai(t,e,n,s,i,r,o,a){const l=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(B(n))c=u.updateFullNode(l.getNode(),s,null);else if(u.filtersNodes()&&!l.isFiltered()){const g=l.getNode().updateChild(n,s);c=u.updateFullNode(l.getNode(),g,null)}else{const g=L(n);if(!l.isCompleteForPath(n)&&Wt(n)>1)return e;const b=Q(n),N=l.getNode().getImmediateChild(g).updateChild(b,s);g===".priority"?c=u.updatePriority(l.getNode(),N):c=u.updateChild(l.getNode(),g,N,b,td,null)}const h=Yh(e,c,l.isFullyInitialized()||B(n),u.filtersNodes()),f=new _a(i,h,r);return nd(t,h,n,i,f,a)}function ho(t,e,n,s,i,r,o){const a=e.eventCache;let l,c;const u=new _a(i,e,r);if(B(n))c=t.filter.updateFullNode(e.eventCache.getNode(),s,o),l=_s(e,c,!0,t.filter.filtersNodes());else{const h=L(n);if(h===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),s),l=_s(e,c,a.isFullyInitialized(),a.isFiltered());else{const f=Q(n),g=a.getNode().getImmediateChild(h);let b;if(B(f))b=s;else{const S=u.getCompleteChild(h);S!=null?ia(f)===".priority"&&S.getChild(Wh(f)).isEmpty()?b=S:b=S.updateChild(f,s):b=x.EMPTY_NODE}if(g.equals(b))l=e;else{const S=t.filter.updateChild(a.getNode(),h,b,f,u,o);l=_s(e,S,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function fc(t,e){return t.eventCache.isCompleteForChild(e)}function cE(t,e,n,s,i,r,o){let a=e;return s.foreach((l,c)=>{const u=re(n,l);fc(e,L(u))&&(a=ho(t,a,u,c,i,r,o))}),s.foreach((l,c)=>{const u=re(n,l);fc(e,L(u))||(a=ho(t,a,u,c,i,r,o))}),a}function pc(t,e,n){return n.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function fo(t,e,n,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;B(n)?c=s:c=new Y(null).setTree(n,s);const u=e.serverCache.getNode();return c.children.inorderTraversal((h,f)=>{if(u.hasChild(h)){const g=e.serverCache.getNode().getImmediateChild(h),b=pc(t,g,f);l=Ai(t,l,new q(h),b,i,r,o,a)}}),c.children.inorderTraversal((h,f)=>{const g=!e.serverCache.isCompleteForChild(h)&&f.value===void 0;if(!u.hasChild(h)&&!g){const b=e.serverCache.getNode().getImmediateChild(h),S=pc(t,b,f);l=Ai(t,l,new q(h),S,i,r,o,a)}}),l}function uE(t,e,n,s,i,r,o){if(ki(i,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(s.value!=null){if(B(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Ai(t,e,n,l.getNode().getChild(n),i,r,a,o);if(B(n)){let c=new Y(null);return l.getNode().forEachChild(Pn,(u,h)=>{c=c.set(new q(u),h)}),fo(t,e,n,c,i,r,a,o)}else return e}else{let c=new Y(null);return s.foreach((u,h)=>{const f=re(n,u);l.isCompleteForPath(f)&&(c=c.set(u,l.getNode().getChild(f)))}),fo(t,e,n,c,i,r,a,o)}}function hE(t,e,n,s,i){const r=e.serverCache,o=Yh(e,r.getNode(),r.isFullyInitialized()||B(n),r.isFiltered());return nd(t,o,n,s,td,i)}function dE(t,e,n,s,i,r){let o;if(ki(s,n)!=null)return e;{const a=new _a(s,e,i),l=e.eventCache.getNode();let c;if(B(n)||L(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Ni(s,dn(e));else{const h=e.serverCache.getNode();E(h instanceof x,"serverChildren would be complete if leaf node"),u=fa(s,h)}u=u,c=t.filter.updateFullNode(l,u,r)}else{const u=L(n);let h=pa(s,u,e.serverCache);h==null&&e.serverCache.isCompleteForChild(u)&&(h=l.getImmediateChild(u)),h!=null?c=t.filter.updateChild(l,u,h,Q(n),a,r):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(l,u,x.EMPTY_NODE,Q(n),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Ni(s,dn(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||ki(s,$())!=null,_s(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fE{constructor(e,n){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new la(s.getIndex()),r=xv(s);this.processor_=rE(r);const o=n.serverCache,a=n.eventCache,l=i.updateFullNode(x.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(x.EMPTY_NODE,a.getNode(),null),u=new Ht(l,o.isFullyInitialized(),i.filtersNodes()),h=new Ht(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=er(h,u),this.eventGenerator_=new Uv(this.query_)}get query(){return this.query_}}function pE(t){return t.viewCache_.serverCache.getNode()}function _E(t){return Ri(t.viewCache_)}function gE(t,e){const n=dn(t.viewCache_);return n&&(t.query._queryParams.loadsAllData()||!B(e)&&!n.getImmediateChild(L(e)).isEmpty())?n.getChild(e):null}function _c(t){return t.eventRegistrations_.length===0}function mE(t,e){t.eventRegistrations_.push(e)}function gc(t,e,n){const s=[];if(n){E(e==null,"A cancel should cancel all event registrations.");const i=t.query._path;t.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(n,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<t.eventRegistrations_.length;++r){const o=t.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(t.eventRegistrations_.slice(r+1));break}}t.eventRegistrations_=i}else t.eventRegistrations_=[];return s}function mc(t,e,n,s){e.type===Ke.MERGE&&e.source.queryId!==null&&(E(dn(t.viewCache_),"We should always have a full cache before handling merges"),E(Ri(t.viewCache_),"Missing event cache, even though we have a server cache"));const i=t.viewCache_,r=aE(t.processor_,i,e,n,s);return oE(t.processor_,r.viewCache),E(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),t.viewCache_=r.viewCache,sd(t,r.changes,r.viewCache.eventCache.getNode(),null)}function yE(t,e){const n=t.viewCache_.eventCache,s=[];return n.getNode().isLeafNode()||n.getNode().forEachChild(oe,(r,o)=>{s.push(Bn(r,o))}),n.isFullyInitialized()&&s.push(Kh(n.getNode())),sd(t,s,n.getNode(),e)}function sd(t,e,n,s){const i=s?[s]:t.eventRegistrations_;return Bv(t.eventGenerator_,e,n,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xi;class id{constructor(){this.views=new Map}}function vE(t){E(!xi,"__referenceConstructor has already been defined"),xi=t}function EE(){return E(xi,"Reference.ts has not been loaded"),xi}function bE(t){return t.views.size===0}function ga(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return E(r!=null,"SyncTree gave us an op for an invalid query."),mc(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(mc(o,e,n,s));return r}}function rd(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=Ni(n,i?s:null),l=!1;a?l=!0:s instanceof x?(a=fa(n,s),l=!1):(a=x.EMPTY_NODE,l=!1);const c=er(new Ht(a,l,!1),new Ht(s,i,!1));return new fE(e,c)}return o}function CE(t,e,n,s,i,r){const o=rd(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),mE(o,n),yE(o,n)}function IE(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const a=$t(t);if(i==="default")for(const[l,c]of t.views.entries())o=o.concat(gc(c,n,s)),_c(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(i);l&&(o=o.concat(gc(l,n,s)),_c(l)&&(t.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!$t(t)&&r.push(new(EE())(e._repo,e._path)),{removed:r,events:o}}function od(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Lt(t,e){let n=null;for(const s of t.views.values())n=n||gE(s,e);return n}function ad(t,e){if(e._queryParams.loadsAllData())return nr(t);{const s=e._queryIdentifier;return t.views.get(s)}}function ld(t,e){return ad(t,e)!=null}function $t(t){return nr(t)!=null}function nr(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pi;function wE(t){E(!Pi,"__referenceConstructor has already been defined"),Pi=t}function TE(){return E(Pi,"Reference.ts has not been loaded"),Pi}let SE=1;class yc{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Y(null),this.pendingWriteTree_=tE(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function cd(t,e,n,s,i){return Vv(t.pendingWriteTree_,e,n,s,i),i?Zn(t,new hn(ua(),e,n)):[]}function RE(t,e,n,s){jv(t.pendingWriteTree_,e,n,s);const i=Y.fromObject(n);return Zn(t,new Wn(ua(),e,i))}function xt(t,e,n=!1){const s=qv(t.pendingWriteTree_,e);if(zv(t.pendingWriteTree_,e)){let r=new Y(null);return s.snap!=null?r=r.set($(),!0):be(s.children,o=>{r=r.set(new q(o),!0)}),Zn(t,new Si(s.path,r,n))}else return[]}function $s(t,e,n){return Zn(t,new hn(ha(),e,n))}function NE(t,e,n){const s=Y.fromObject(n);return Zn(t,new Wn(ha(),e,s))}function kE(t,e){return Zn(t,new Ps(ha(),e))}function AE(t,e,n){const s=ya(t,n);if(s){const i=va(s),r=i.path,o=i.queryId,a=Se(r,e),l=new Ps(da(o),a);return Ea(t,r,l)}else return[]}function po(t,e,n,s){const i=e._path,r=t.syncPointTree_.get(i);let o=[];if(r&&(e._queryIdentifier==="default"||ld(r,e))){const a=IE(r,e,n,s);bE(r)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const l=a.removed;o=a.events;const c=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(i,(h,f)=>$t(f));if(c&&!u){const h=t.syncPointTree_.subtree(i);if(!h.isEmpty()){const f=ME(h);for(let g=0;g<f.length;++g){const b=f[g],S=b.query,N=dd(t,b);t.listenProvider_.startListening(ms(S),Oi(t,S),N.hashFn,N.onComplete)}}}!u&&l.length>0&&!s&&(c?t.listenProvider_.stopListening(ms(e),null):l.forEach(h=>{const f=t.queryToTagMap.get(sr(h));t.listenProvider_.stopListening(ms(h),f)})),DE(t,l)}return o}function xE(t,e,n,s){const i=ya(t,s);if(i!=null){const r=va(i),o=r.path,a=r.queryId,l=Se(o,e),c=new hn(da(a),l,n);return Ea(t,o,c)}else return[]}function PE(t,e,n,s){const i=ya(t,s);if(i){const r=va(i),o=r.path,a=r.queryId,l=Se(o,e),c=Y.fromObject(n),u=new Wn(da(a),l,c);return Ea(t,o,u)}else return[]}function vc(t,e,n){const s=e._path;let i=null,r=!1;t.syncPointTree_.foreachOnPath(s,(h,f)=>{const g=Se(h,s);i=i||Lt(f,g),r=r||$t(f)});let o=t.syncPointTree_.get(s);o?(r=r||$t(o),i=i||Lt(o,$())):(o=new id,t.syncPointTree_=t.syncPointTree_.set(s,o));let a;i!=null?a=!0:(a=!1,i=x.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((f,g)=>{const b=Lt(g,$());b&&(i=i.updateImmediateChild(f,b))}));const l=ld(o,e);if(!l&&!e._queryParams.loadsAllData()){const h=sr(e);E(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=LE();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const c=tr(t.pendingWriteTree_,s);let u=CE(o,e,n,c,i,a);if(!l&&!r){const h=ad(o,e);u=u.concat(FE(t,e,h))}return u}function ma(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=Se(o,e),c=Lt(a,l);if(c)return c});return Xh(i,e,r,n,!0)}function OE(t,e){const n=e._path;let s=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const h=Se(c,n);s=s||Lt(u,h)});let i=t.syncPointTree_.get(n);i?s=s||Lt(i,$()):(i=new id,t.syncPointTree_=t.syncPointTree_.set(n,i));const r=s!=null,o=r?new Ht(s,!0,!1):null,a=tr(t.pendingWriteTree_,e._path),l=rd(i,e,a,r?o.getNode():x.EMPTY_NODE,r);return _E(l)}function Zn(t,e){return ud(e,t.syncPointTree_,null,tr(t.pendingWriteTree_,$()))}function ud(t,e,n,s){if(B(t.path))return hd(t,e,n,s);{const i=e.get($());n==null&&i!=null&&(n=Lt(i,$()));let r=[];const o=L(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=Zh(s,o);r=r.concat(ud(a,l,c,u))}return i&&(r=r.concat(ga(i,t,s,n))),r}}function hd(t,e,n,s){const i=e.get($());n==null&&i!=null&&(n=Lt(i,$()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=Zh(s,o),u=t.operationForChild(o);u&&(r=r.concat(hd(u,a,l,c)))}),i&&(r=r.concat(ga(i,t,s,n))),r}function dd(t,e){const n=e.query,s=Oi(t,n);return{hashFn:()=>(pE(e)||x.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?AE(t,n._path,s):kE(t,n._path);{const r=Ty(i,n);return po(t,n,null,r)}}}}function Oi(t,e){const n=sr(e);return t.queryToTagMap.get(n)}function sr(t){return t._path.toString()+"$"+t._queryIdentifier}function ya(t,e){return t.tagToQueryMap.get(e)}function va(t){const e=t.indexOf("$");return E(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new q(t.substr(0,e))}}function Ea(t,e,n){const s=t.syncPointTree_.get(e);E(s,"Missing sync point for query tag that we're tracking");const i=tr(t.pendingWriteTree_,e);return ga(s,n,i,null)}function ME(t){return t.fold((e,n,s)=>{if(n&&$t(n))return[nr(n)];{let i=[];return n&&(i=od(n)),be(s,(r,o)=>{i=i.concat(o)}),i}})}function ms(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(TE())(t._repo,t._path):t}function DE(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=sr(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function LE(){return SE++}function FE(t,e,n){const s=e._path,i=Oi(t,e),r=dd(t,n),o=t.listenProvider_.startListening(ms(e),i,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(s);if(i)E(!$t(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,h)=>{if(!B(c)&&u&&$t(u))return[nr(u).query];{let f=[];return u&&(f=f.concat(od(u).map(g=>g.query))),be(h,(g,b)=>{f=f.concat(b)}),f}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(ms(u),Oi(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wa{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function Ta(t,e){let n=e instanceof q?e:new q(e),s=t,i=L(n);for(;i!==null;){const r=Ln(s.node.children,i)||{children:{},childCount:0};s=new wa(i,s,r),n=Q(n),i=L(n)}return s}function es(t){return t.node.value}function _d(t,e){t.node.value=e,_o(t)}function gd(t){return t.node.childCount>0}function HE(t){return es(t)===void 0&&!gd(t)}function ir(t,e){be(t.node.children,(n,s)=>{e(new wa(n,t,s))})}function md(t,e,n,s){n&&!s&&e(t),ir(t,i=>{md(i,e,!0,s)}),n&&s&&e(t)}function $E(t,e,n){let s=n?t:t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function Vs(t){return new q(t.parent===null?t.name:Vs(t.parent)+"/"+t.name)}function _o(t){t.parent!==null&&VE(t.parent,t.name,t)}function VE(t,e,n){const s=HE(n),i=lt(t.node.children,e);s&&i?(delete t.node.children[e],t.node.childCount--,_o(t)):!s&&!i&&(t.node.children[e]=n.node,t.node.childCount++,_o(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jE=/[\[\].#$\/\u0000-\u001F\u007F]/,qE=/[\[\].#$\u0000-\u001F\u007F]/,kr=10*1024*1024,Sa=function(t){return typeof t=="string"&&t.length!==0&&!jE.test(t)},yd=function(t){return typeof t=="string"&&t.length!==0&&!qE.test(t)},zE=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),yd(t)},KE=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!Xo(t)||t&&typeof t=="object"&&lt(t,".sv")},vd=function(t,e,n,s){s&&e===void 0||rr(Ki(t,"value"),e,n)},rr=function(t,e,n){const s=n instanceof q?new av(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Gt(s));if(typeof e=="function")throw new Error(t+"contains a function "+Gt(s)+" with contents = "+e.toString());if(Xo(e))throw new Error(t+"contains "+e.toString()+" "+Gt(s));if(typeof e=="string"&&e.length>kr/3&&Gi(e)>kr)throw new Error(t+"contains a string greater than "+kr+" utf8 bytes "+Gt(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(be(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!Sa(o)))throw new Error(t+" contains an invalid key ("+o+") "+Gt(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);lv(s,o),rr(t,a,s),cv(s)}),i&&r)throw new Error(t+' contains ".value" child '+Gt(s)+" in addition to actual children.")}},GE=function(t,e){let n,s;for(n=0;n<e.length;n++){s=e[n];const r=Ns(s);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!Sa(r[o]))throw new Error(t+"contains an invalid key ("+r[o]+") in path "+s.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(ov);let i=null;for(n=0;n<e.length;n++){if(s=e[n],i!==null&&Ue(i,s))throw new Error(t+"contains a path "+i.toString()+" that is ancestor of another path "+s.toString());i=s}},YE=function(t,e,n,s){if(s&&e===void 0)return;const i=Ki(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const r=[];be(e,(o,a)=>{const l=new q(o);if(rr(i,a,re(n,l)),ia(l)===".priority"&&!KE(a))throw new Error(i+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),GE(i,r)},Ed=function(t,e,n,s){if(!(s&&n===void 0)&&!yd(n))throw new Error(Ki(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},QE=function(t,e,n,s){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Ed(t,e,n,s)},Ra=function(t,e){if(L(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},JE=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!Sa(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!zE(n))throw new Error(Ki(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XE{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function or(t,e){let n=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();n!==null&&!ra(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(i)}n&&t.eventLists_.push(n)}function Na(t,e,n){or(t,n),bd(t,s=>ra(s,e))}function Je(t,e,n){or(t,n),bd(t,s=>Ue(s,e)||Ue(e,s))}function bd(t,e){t.recursionDepth_++;let n=!0;for(let s=0;s<t.eventLists_.length;s++){const i=t.eventLists_[s];if(i){const r=i.path;e(r)?(ZE(t.eventLists_[s]),t.eventLists_[s]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function ZE(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const s=n.getEventRunner();sn&&ye("event: "+n.toString()),Xn(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eb="repo_interrupt",tb=25;class nb{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new XE,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ti(),this.transactionQueueTree_=new wa,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function sb(t,e,n){if(t.stats_=ta(t.repoInfo_),t.forceRestClient_||ky())t.server_=new wi(t.repoInfo_,(s,i,r,o)=>{bc(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Cc(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{ue(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new gt(t.repoInfo_,e,(s,i,r,o)=>{bc(t,s,i,r,o)},s=>{Cc(t,s)},s=>{ib(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=Ly(t.repoInfo_,()=>new Fv(t.stats_,t.server_)),t.infoData_=new Pv,t.infoSyncTree_=new yc({startListening:(s,i,r,o)=>{let a=[];const l=t.infoData_.getNode(s._path);return l.isEmpty()||(a=$s(t.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),ka(t,"connected",!1),t.serverSyncTree_=new yc({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);Je(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function Cd(t){const n=t.infoData_.getNode(new q(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function ar(t){return UE({timestamp:Cd(t)})}function bc(t,e,n,s,i){t.dataUpdateCount++;const r=new q(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const l=pi(n,c=>ce(c));o=PE(t.serverSyncTree_,r,l,i)}else{const l=ce(n);o=xE(t.serverSyncTree_,r,l,i)}else if(s){const l=pi(n,c=>ce(c));o=NE(t.serverSyncTree_,r,l)}else{const l=ce(n);o=$s(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=$n(t,r)),Je(t.eventQueue_,a,o)}function Cc(t,e){ka(t,"connected",e),e===!1&&lb(t)}function ib(t,e){be(e,(n,s)=>{ka(t,n,s)})}function ka(t,e,n){const s=new q("/.info/"+e),i=ce(n);t.infoData_.updateSnapshot(s,i);const r=$s(t.infoSyncTree_,s,i);Je(t.eventQueue_,s,r)}function Aa(t){return t.nextWriteId_++}function rb(t,e){const n=OE(t.serverSyncTree_,e);return n!=null?Promise.resolve(n):t.server_.get(e).then(s=>{const i=ce(s).withIndex(e._queryParams.getIndex()),r=$s(t.serverSyncTree_,e._path,i);return Na(t.eventQueue_,e._path,r),Promise.resolve(i)},s=>(js(t,"get for query "+ue(e)+" failed: "+s),Promise.reject(new Error(s))))}function ob(t,e,n,s,i){js(t,"set",{path:e.toString(),value:n,priority:s});const r=ar(t),o=ce(n,s),a=ma(t.serverSyncTree_,e),l=pd(o,a,r),c=Aa(t),u=cd(t.serverSyncTree_,e,l,c,!0);or(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(f,g)=>{const b=f==="ok";b||Re("set at "+e+" failed: "+f);const S=xt(t.serverSyncTree_,c,!b);Je(t.eventQueue_,e,S),go(t,i,f,g)});const h=Pa(t,e);$n(t,h),Je(t.eventQueue_,h,[])}function ab(t,e,n,s){js(t,"update",{path:e.toString(),value:n});let i=!0;const r=ar(t),o={};if(be(n,(a,l)=>{i=!1,o[a]=fd(re(e,a),ce(l),t.serverSyncTree_,r)}),i)ye("update() called with empty data.  Don't do anything."),go(t,s,"ok",void 0);else{const a=Aa(t),l=RE(t.serverSyncTree_,e,o,a);or(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,u)=>{const h=c==="ok";h||Re("update at "+e+" failed: "+c);const f=xt(t.serverSyncTree_,a,!h),g=f.length>0?$n(t,e):e;Je(t.eventQueue_,g,f),go(t,s,c,u)}),be(n,c=>{const u=Pa(t,re(e,c));$n(t,u)}),Je(t.eventQueue_,e,[])}}function lb(t){js(t,"onDisconnectEvents");const e=ar(t),n=Ti();ao(t.onDisconnect_,$(),(i,r)=>{const o=fd(i,r,t.serverSyncTree_,e);Gh(n,i,o)});let s=[];ao(n,$(),(i,r)=>{s=s.concat($s(t.serverSyncTree_,i,r));const o=Pa(t,i);$n(t,o)}),t.onDisconnect_=Ti(),Je(t.eventQueue_,$(),s)}function cb(t,e,n){let s;L(e._path)===".info"?s=vc(t.infoSyncTree_,e,n):s=vc(t.serverSyncTree_,e,n),Na(t.eventQueue_,e._path,s)}function Ic(t,e,n){let s;L(e._path)===".info"?s=po(t.infoSyncTree_,e,n):s=po(t.serverSyncTree_,e,n),Na(t.eventQueue_,e._path,s)}function ub(t){t.persistentConnection_&&t.persistentConnection_.interrupt(eb)}function js(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),ye(n,...e)}function go(t,e,n,s){e&&Xn(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function Id(t,e,n){return ma(t.serverSyncTree_,e,n)||x.EMPTY_NODE}function xa(t,e=t.transactionQueueTree_){if(e||lr(t,e),es(e)){const n=Td(t,e);E(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&hb(t,Vs(e),n)}else gd(e)&&ir(e,n=>{xa(t,n)})}function hb(t,e,n){const s=n.map(c=>c.currentWriteId),i=Id(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];E(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Se(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{js(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let f=0;f<n.length;f++)n[f].status=2,u=u.concat(xt(t.serverSyncTree_,n[f].currentWriteId)),n[f].onComplete&&h.push(()=>n[f].onComplete(null,!0,n[f].currentOutputSnapshotResolved)),n[f].unwatcher();lr(t,Ta(t.transactionQueueTree_,e)),xa(t,t.transactionQueueTree_),Je(t.eventQueue_,e,u);for(let f=0;f<h.length;f++)Xn(h[f])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Re("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}$n(t,e)}},o)}function $n(t,e){const n=wd(t,e),s=Vs(n),i=Td(t,n);return db(t,i,s),s}function db(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Se(n,l.path);let u=!1,h;if(E(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,h=l.abortReason,i=i.concat(xt(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=tb)u=!0,h="maxretry",i=i.concat(xt(t.serverSyncTree_,l.currentWriteId,!0));else{const f=Id(t,l.path,o);l.currentInputSnapshot=f;const g=e[a].update(f.val());if(g!==void 0){rr("transaction failed: Data returned ",g,l.path);let b=ce(g);typeof g=="object"&&g!=null&&lt(g,".priority")||(b=b.updatePriority(f.getPriority()));const N=l.currentWriteId,U=ar(t),ae=pd(b,f,U);l.currentOutputSnapshotRaw=b,l.currentOutputSnapshotResolved=ae,l.currentWriteId=Aa(t),o.splice(o.indexOf(N),1),i=i.concat(cd(t.serverSyncTree_,l.path,ae,l.currentWriteId,l.applyLocally)),i=i.concat(xt(t.serverSyncTree_,N,!0))}else u=!0,h="nodata",i=i.concat(xt(t.serverSyncTree_,l.currentWriteId,!0))}Je(t.eventQueue_,n,i),i=[],u&&(e[a].status=2,function(f){setTimeout(f,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}lr(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)Xn(s[a]);xa(t,t.transactionQueueTree_)}function wd(t,e){let n,s=t.transactionQueueTree_;for(n=L(e);n!==null&&es(s)===void 0;)s=Ta(s,n),e=Q(e),n=L(e);return s}function Td(t,e){const n=[];return Sd(t,e,n),n.sort((s,i)=>s.order-i.order),n}function Sd(t,e,n){const s=es(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);ir(e,i=>{Sd(t,i,n)})}function lr(t,e){const n=es(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,_d(e,n.length>0?n:void 0)}ir(e,s=>{lr(t,s)})}function Pa(t,e){const n=Vs(wd(t,e)),s=Ta(t.transactionQueueTree_,e);return $E(s,i=>{Ar(t,i)}),Ar(t,s),md(s,i=>{Ar(t,i)}),n}function Ar(t,e){const n=es(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(E(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(E(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(xt(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?_d(e,void 0):n.length=r+1,Je(t.eventQueue_,Vs(e),i);for(let o=0;o<s.length;o++)Xn(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fb(t){let e="";const n=t.split("/");for(let s=0;s<n.length;s++)if(n[s].length>0){let i=n[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function pb(t){const e={};t.charAt(0)==="?"&&(t=t.substring(1));for(const n of t.split("&")){if(n.length===0)continue;const s=n.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):Re(`Invalid query segment '${n}' in query '${t}'`)}return e}const wc=function(t,e){const n=_b(t),s=n.namespace;n.domain==="firebase.com"&&cn(n.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&n.domain!=="localhost"&&cn("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),n.secure||Ey();const i=n.scheme==="ws"||n.scheme==="wss";return{repoInfo:new Oy(n.host,n.secure,s,i,e,"",s!==n.subdomain),path:new q(n.pathString)}},_b=function(t){let e="",n="",s="",i="",r="",o=!0,a="https",l=443;if(typeof t=="string"){let c=t.indexOf("//");c>=0&&(a=t.substring(0,c-1),t=t.substring(c+2));let u=t.indexOf("/");u===-1&&(u=t.length);let h=t.indexOf("?");h===-1&&(h=t.length),e=t.substring(0,Math.min(u,h)),u<h&&(i=fb(t.substring(u,h)));const f=pb(t.substring(Math.min(t.length,h)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const g=e.slice(0,c);if(g.toLowerCase()==="localhost")n="localhost";else if(g.split(".").length<=2)n=g;else{const b=e.indexOf(".");s=e.substring(0,b).toLowerCase(),n=e.substring(b+1),r=s}"ns"in f&&(r=f.ns)}return{host:e,port:l,domain:n,subdomain:s,secure:o,scheme:a,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oa{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return B(this._path)?null:ia(this._path)}get ref(){return new ct(this._repo,this._path)}get _queryIdentifier(){const e=lc(this._queryParams),n=Zo(e);return n==="{}"?"default":n}get _queryObject(){return lc(this._queryParams)}isEqual(e){if(e=Xe(e),!(e instanceof Oa))return!1;const n=this._repo===e._repo,s=ra(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+rv(this._path)}}class ct extends Oa{constructor(e,n){super(e,n,new ca,!1)}get parent(){const e=Wh(this._path);return e===null?null:new ct(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Vn{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new q(e),s=jn(this.ref,e);return new Vn(this._node.getChild(n),s,oe)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Vn(i,jn(this.ref,s),oe)))}hasChild(e){const n=new q(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function ot(t,e){return t=Xe(t),t._checkNotDeleted("ref"),e!==void 0?jn(t._root,e):t._root}function jn(t,e){return t=Xe(t),L(t._path)===null?QE("child","path",e,!1):Ed("child","path",e,!1),new ct(t._repo,re(t._path,e))}function Ma(t,e){t=Xe(t),Ra("push",t._path),vd("push",e,t._path,!0);const n=Cd(t._repo),s=Nv(n),i=jn(t,s),r=jn(t,s);let o;return e!=null?o=kd(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function mb(t){return Ra("remove",t._path),kd(t,null)}function kd(t,e){t=Xe(t),Ra("set",t._path),vd("set",e,t._path,!1);const n=new Os;return ob(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Ad(t,e){YE("update",e,t._path,!1);const n=new Os;return ab(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function yb(t){return t=Xe(t),rb(t._repo,t).then(e=>new Vn(e,new ct(t._repo,t._path),t._queryParams.getIndex()))}class Da{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Rd("value",this,new Vn(e.snapshotNode,new ct(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Nd(this,e,n):null}matches(e){return e instanceof Da?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class La{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Nd(this,e,n):null}createEvent(e,n){E(e.childName!=null,"Child events should have a childName.");const s=jn(new ct(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Rd(e.type,this,new Vn(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof La?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function vb(t,e,n,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const l=n,c=(u,h)=>{Ic(t._repo,t,a),l(u,h)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new gb(n,r||void 0),a=e==="value"?new Da(o):new La(e,o);return cb(t._repo,t,a),()=>Ic(t._repo,t,a)}function mo(t,e,n,s){return vb(t,"value",e,n,s)}vE(ct);wE(ct);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eb="FIREBASE_DATABASE_EMULATOR_HOST",yo={};let bb=!1;function Cb(t,e,n,s,i){let r=s||t.options.databaseURL;r===void 0&&(t.options.projectId||cn("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),ye("Using default host for project ",t.options.projectId),r=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=wc(r,i),a=o.repoInfo,l,c;typeof process!="undefined"&&process.env&&(c=process.env[Eb]),c?(l=!0,r=`http://${c}?ns=${a.namespace}`,o=wc(r,i),a=o.repoInfo):l=!o.repoInfo.secure;const u=i&&l?new io(io.OWNER):new xy(t.name,t.options,e);JE("Invalid Firebase Database URL",o),B(o.path)||cn("Database URL must point to the root of a Firebase Database (not including a child path).");const h=wb(a,t,u,new Ay(t.name,n));return new Tb(h,t)}function Ib(t,e){const n=yo[e];(!n||n[t.key]!==t)&&cn(`Database ${e}(${t.repoInfo_}) has already been deleted.`),ub(t),delete n[t.key]}function wb(t,e,n,s){let i=yo[e.name];i||(i={},yo[e.name]=i);let r=i[t.toURLString()];return r&&cn("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new nb(t,bb,n,s),i[t.toURLString()]=r,r}class Tb{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(sb(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new ct(this._repo,$())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Ib(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&cn("Cannot call "+e+" on a deleted database.")}}function Sb(t=Wu(),e){return Vo(t,"database").getImmediate({identifier:e})}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rb(t){_y(Ds),Fn(new on("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Cb(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),Mt(jl,ql,t),Mt(jl,ql,"esm2017")}gt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};gt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};Rb();const Nb={apiKey:"AIzaSyAsXHXd9Spu67AO6DV06x2E_EnVOIAu9UU",authDomain:"quick-retro.firebaseapp.com",projectId:"quick-retro",storageBucket:"quick-retro.appspot.com",messagingSenderId:"293134428599",appId:"1:293134428599:web:bad71d4fedbda8080ce032",databaseURL:"https://quick-retro-default-rtdb.europe-west1.firebasedatabase.app"},kb=gg(Nb),at=Sb(kb),xr=fn({});function Ab(t){if(!t)return xr;const e=ot(at,`users/${t}/boards`),n={};mo(e,s,r);function s(o){const a=o.exists()?Object.values(o.val()):[];for(const l of a){if(n[l])continue;const c=mo(ot(at,`boards/${l}`),i.bind(null,l),r);n[l]=c}for(const l in n)a.includes(l)||(n[l](),delete n[l])}function i(o,a){xr[o]=a.val()}function r(o){console.error(o)}return xr}function xb(t){const e=fn({loading:!0});mo(ot(at,`boards/${t}`),s=>{e.exists=s.exists(),e.loading=!1,e.exists&&Object.entries(s.val()).forEach(([i,r])=>{e[i]=r})},n);function n(s){console.log(s),e.exists=!1,e.loading=!1}return e}function Pb(t,e){const n=ot(at,`boards/${t}`);Ad(n,{cardsHidden:e})}function Ob(t,e){const n=ot(at,`boards/${t}`);Ad(n,{title:e})}function Mb(t,e,n){const s=ot(at,`boards/${t}/columns/${e}/cards`);Ma(s,n)}function Db(t,e,n){mb(ot(at,`boards/${t}/columns/${e}/cards/${n}`))}async function Lb(t,e){const n=ot(at,"boards"),s=await Ma(n,{author:t,cardsHidden:!0,title:"",columns:e.columns.map(i=>za(qa({},i),{cards:{}}))});if(!!s.key)return await xd(t,s.key),s.key}async function xd(t,e){const n=await yb(ot(at,`users/${t}/boards`));if((n.exists()?Object.values(n.val()):[]).includes(e))return;const i=ot(at,`users/${t}/boards`);await Ma(i,e)}function Fb(){const t=fn({}),e=py();return em(e).catch(n=>{console.error(n)}),im(e,n=>{n&&Object.entries(n).forEach(([s,i])=>{t[s]=i})}),t}var bt=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n};const Ub=Vt({props:{text:null,onClick:null},setup(t){return(e,n)=>(J(),pe("button",{onClick:n[0]||(n[0]=(...s)=>t.onClick&&t.onClick(...s))},On(t.text),1))}});var Bb=bt(Ub,[["__scopeId","data-v-f7270f9a"]]);const Wb={};function Hb(t,e){return J(),pe("button",null,"\u2716")}var $b=bt(Wb,[["render",Hb],["__scopeId","data-v-2f15e8b8"]]);const Vb=Fo("\u2716"),jb=Vt({props:{text:null,color:null,author:null,onDelete:null,id:null},setup(t){const{author:e}=t;Ru(r=>({a47967ba:t.color}));const s=st("user").uid===e,i=st("board");return(r,o)=>{var a;return J(),pe("li",{class:qn({hidden:!s&&((a=Fe(i))==null?void 0:a.cardsHidden)})},[We($b,{onClick:o[0]||(o[0]=l=>t.onDelete(t.id))},{default:iu(()=>[Vb]),_:1}),Fo(" "+On(t.text),1)],2)}}});var qb=bt(jb,[["__scopeId","data-v-171d1ade"]]);const zb=Vt({props:{title:null,color:null,boardId:null,columnId:null,cards:null},setup(t){const{columnId:e,boardId:n}=t;Ru(a=>({"62139bba":t.color}));const s=fn({inputText:""}),i=st("user");function r(a){a.preventDefault(),s.inputText.trim()!==""&&(!(i!=null&&i.uid)||(Mb(n,e,{text:s.inputText,author:i.uid}),s.inputText=""))}function o(a){Db(n,e,a)}return(a,l)=>(J(),pe("section",null,[_e("h2",null,On(t.title),1),_e("ul",null,[(J(!0),pe(fe,null,Cs(t.cards,(c,u)=>(J(),Ut(qb,{id:u,author:c.author,text:c.text,color:t.color,onDelete:o},null,8,["id","author","text","color"]))),256))]),_e("form",{target:"#",onSubmit:r},[mu(_e("input",{placeholder:"Add new card","onUpdate:modelValue":l[0]||(l[0]=c=>Fe(s).inputText=c)},null,512),[[Nu,Fe(s).inputText]])],32)]))}});var Kb=bt(zb,[["__scopeId","data-v-345fc8cf"]]);const Gb={class:"board"},Yb={class:"columns"},Qb={class:"options"},Jb=Vt({setup(t){const e=st("board"),n=st("boardId"),s=st("user");Gf(()=>{s.uid&&xd(s.uid,n)});function i(){Pb(n,!e.cardsHidden)}function r(){return e.cardsHidden?"Show all cards":"Hide other cards"}function o(u){u.key==="Enter"&&u.preventDefault()}function a(u){const h=(u==null?void 0:u.target).value.trim();Ob(n,h),c.value=h||"Untitled Retro"}function l(){c.value==="Untitled Retro"&&(c.value="")}const c=Yc(e.title||"Untitled Retro");return(u,h)=>(J(),pe(fe,null,[_e("div",Gb,[mu(_e("input",{class:qn({untitled:c.value==="Untitled Retro"}),"onUpdate:modelValue":h[0]||(h[0]=f=>c.value=f),onKeypress:o,onFocusout:a,onFocusin:l},null,34),[[Nu,c.value]]),_e("section",Yb,[(J(!0),pe(fe,null,Cs(Fe(e).columns,(f,g)=>{var b;return J(),Ut(Kb,{cards:(b=f.cards)!=null?b:[],"column-id":String(g),"board-id":Fe(n),key:String(g),title:f.title,color:f.color},null,8,["cards","column-id","board-id","title","color"])}),128))])]),_e("section",Qb,[We(Bb,{"on-click":i,text:r()},null,8,["text"])])],64))}});var Xb=bt(Jb,[["__scopeId","data-v-069c8f25"]]);const Zb={},eC={class:"loader"};function tC(t,e){return J(),pe("div",eC,"Loading...")}var nC=bt(Zb,[["render",tC],["__scopeId","data-v-840bd5c8"]]);const sC={key:0},iC={key:1},rC={key:1},oC=Vt({props:{boardId:null},setup(t){const{boardId:e}=t,n=xb(e);return ui("boardId",e),ui("board",n),(s,i)=>(J(),pe(fe,null,[Fe(n).loading?Js("",!0):(J(),pe("main",sC,[Fe(n).exists?(J(),Ut(Xb,{key:0})):Js("",!0),Fe(n).exists?Js("",!0):(J(),pe("div",iC,"Couldn't find board"))])),Fe(n).loading?(J(),pe("main",rC,[We(nC)])):Js("",!0)],64))}});var aC=bt(oC,[["__scopeId","data-v-b2bd279e"]]);const lC={class:"columns"},cC=Vt({props:{board:null,isTemplate:{type:Boolean}},setup(t){return(e,n)=>(J(),pe("div",{class:qn(["board",{template:t.isTemplate}])},[_e("h3",null,On(t.board.title||"Untitled Retro"),1),_e("div",lC,[(J(!0),pe(fe,null,Cs(t.board.columns,s=>(J(),pe("div",{class:"column",style:Mi({backgroundColor:s.color})},On(s.title),5))),256))])],2))}});var Tc=bt(cC,[["__scopeId","data-v-3db063ea"]]);const uC=[{title:"Mad Sad Glad",columns:[{title:"Mad",color:"#f44336"},{title:"Sad",color:"#e91e63"},{title:"Glad",color:"#9c27b0"}]},{title:"Start Stop Continue",columns:[{title:"Start",color:"#2196f3"},{title:"Stop",color:"#ff9800"},{title:"Continue",color:"#009688"}]},{title:"Sailboat",columns:[{title:"What is the wind pushing our sails that make us go fast",color:"#f44336"},{title:"What anchors are holding us back",color:"#e91e63"},{title:"What rocks are ahead of us that risk our future",color:"#9c27b0"},{title:"What is our ideal island destination",color:"#673ab7"}]}];const Pd=t=>(Wf("data-v-cea9fdd0"),t=t(),Hf(),t),hC={class:"container"},dC=Pd(()=>_e("h2",null,"start a new board",-1)),fC=Pd(()=>_e("h2",null,"your boards",-1)),pC=Vt({props:{navigateToBoard:null},setup(t){const{navigateToBoard:e}=t,n=st("user"),s=Tu(()=>Ab(n.uid));async function i(r){if(!(n!=null&&n.uid))return;const o=await Lb(n.uid,r);o&&e(o)}return(r,o)=>(J(),pe("div",hC,[_e("main",null,[_e("h1",null,"\u{1F680} quick retro "+On("")+"\u{1F680}",1),dC,_e("section",null,[(J(!0),pe(fe,null,Cs(Fe(uC),a=>(J(),Ut(Tc,{onClick:l=>i(a),board:a,"is-template":!0},null,8,["onClick","board"]))),256))]),fC,_e("section",null,[(J(!0),pe(fe,null,Cs(Fe(s),(a,l)=>(J(),Ut(Tc,{onClick:c=>t.navigateToBoard(l),board:a,"is-template":!1},null,8,["onClick","board"]))),256))])])]))}});var _C=bt(pC,[["__scopeId","data-v-cea9fdd0"]]);const gC=Vt({setup(t){const e=Yc(window.location.hash.slice(1));function n(i){console.log("navigating to board",i),history.pushState({},"",`#${i}`),e.value=i}addEventListener("popstate",()=>{console.log(window.location.hash.slice(1)),e.value=window.location.hash.slice(1)});const s=Fb();return ui("user",s),(i,r)=>e.value&&e.value.length>0?(J(),Ut(aC,{key:0,boardId:e.value},null,8,["boardId"])):(J(),Ut(_C,{key:1,"navigate-to-board":n}))}});h_(gC).mount("#app");
