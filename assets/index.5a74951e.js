 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yo{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=Lt.ACK_USER_WRITE,this.source=kc()}operationForChild(e){if(ce(this.path)){if(this.affectedTree.value!=null)return A(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new Ie(e));return new yo(ve(),n,this.revert)}}else return A(se(this.path)===e,"operationForChild called for unrelated child."),new yo(Ae(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function GE(t){return{filter:t}}function YE(t,e){A(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),A(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function XE(t,e,n,r,i){const s=new qE;let o,a;if(n.type===Lt.OVERWRITE){const c=n;c.source.fromUser?o=bl(t,e,c.path,c.snap,r,i,s):(A(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!ce(c.path),o=To(t,e,c.path,c.snap,r,i,a,s))}else if(n.type===Lt.MERGE){const c=n;c.source.fromUser?o=QE(t,e,c.path,c.children,r,i,s):(A(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=yl(t,e,c.path,c.children,r,i,a,s))}else if(n.type===Lt.ACK_USER_WRITE){const c=n;c.revert?o=tT(t,e,c.path,r,i,s):o=ZE(t,e,c.path,c.affectedTree,r,i,s)}else if(n.type===Lt.LISTEN_COMPLETE)o=eT(t,e,n.path,r,s);else throw ii("Unknown operation type: "+n.type);const l=s.getChanges();return JE(e,o,l),{viewCache:o,changes:l}}function JE(t,e,n){const r=e.eventCache;if(r.isFullyInitialized()){const i=r.getNode().isLeafNode()||r.getNode().isEmpty(),s=wo(t);(n.length>0||!t.eventCache.isFullyInitialized()||i&&!r.getNode().equals(s)||!r.getNode().getPriority().equals(s.getPriority()))&&n.push(rg(wo(e)))}}function hg(t,e,n,r,i,s){const o=e.eventCache;if(Eo(r,n)!=null)return e;{let a,l;if(ce(n))if(A(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=pr(e),u=c instanceof Y?c:Y.EMPTY_NODE,d=Mc(r,u);a=t.filter.updateFullNode(e.eventCache.getNode(),d,s)}else{const c=Co(r,pr(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,s)}else{const c=se(n);if(c===".priority"){A(An(n)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const d=zd(r,n,u,l);d!=null?a=t.filter.updatePriority(u,d):a=o.getNode()}else{const u=Ae(n);let d;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const h=zd(r,n,o.getNode(),l);h!=null?d=o.getNode().getImmediateChild(c).updateChild(u,h):d=o.getNode().getImmediateChild(c)}else d=Dc(r,c,e.serverCache);d!=null?a=t.filter.updateChild(o.getNode(),c,d,u,i,s):a=o.getNode()}}return Fi(e,a,o.isFullyInitialized()||ce(n),t.filter.filtersNodes())}}function To(t,e,n,r,i,s,o,a){const l=e.serverCache;let c;const u=o?t.filter:t.filter.getIndexedFilter();if(ce(n))c=u.updateFullNode(l.getNode(),r,null);else if(u.filtersNodes()&&!l.isFiltered()){const _=l.getNode().updateChild(n,r);c=u.updateFullNode(l.getNode(),_,null)}else{const _=se(n);if(!l.isCompleteForPath(n)&&An(n)>1)return e;const g=Ae(n),b=l.getNode().getImmediateChild(_).updateChild(g,r);_===".priority"?c=u.updatePriority(l.getNode(),b):c=u.updateChild(l.getNode(),_,b,g,dg,null)}const d=sg(e,c,l.isFullyInitialized()||ce(n),u.filtersNodes()),h=new Lc(i,d,s);return hg(t,d,n,i,h,a)}function bl(t,e,n,r,i,s,o){const a=e.eventCache;let l,c;const u=new Lc(i,e,s);if(ce(n))c=t.filter.updateFullNode(e.eventCache.getNode(),r,o),l=Fi(e,c,!0,t.filter.filtersNodes());else{const d=se(n);if(d===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),r),l=Fi(e,c,a.isFullyInitialized(),a.isFiltered());else{const h=Ae(n),_=a.getNode().getImmediateChild(d);let g;if(ce(h))g=r;else{const C=u.getCompleteChild(d);C!=null?Ic(h)===".priority"&&C.getChild(Xp(h)).isEmpty()?g=C:g=C.updateChild(h,r):g=Y.EMPTY_NODE}if(_.equals(g))l=e;else{const C=t.filter.updateChild(a.getNode(),d,g,h,u,o);l=Fi(e,C,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function Wd(t,e){return t.eventCache.isCompleteForChild(e)}function QE(t,e,n,r,i,s,o){let a=e;return r.foreach((l,c)=>{const u=$e(n,l);Wd(e,se(u))&&(a=bl(t,a,u,c,i,s,o))}),r.foreach((l,c)=>{const u=$e(n,l);Wd(e,se(u))||(a=bl(t,a,u,c,i,s,o))}),a}function jd(t,e,n){return n.foreach((r,i)=>{e=e.updateChild(r,i)}),e}function yl(t,e,n,r,i,s,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;ce(n)?c=r:c=new Pe(null).setTree(n,r);const u=e.serverCache.getNode();return c.children.inorderTraversal((d,h)=>{if(u.hasChild(d)){const _=e.serverCache.getNode().getImmediateChild(d),g=jd(t,_,h);l=To(t,l,new Ie(d),g,i,s,o,a)}}),c.children.inorderTraversal((d,h)=>{const _=!e.serverCache.isCompleteForChild(d)&&h.value===void 0;if(!u.hasChild(d)&&!_){const g=e.serverCache.getNode().getImmediateChild(d),C=jd(t,g,h);l=To(t,l,new Ie(d),C,i,s,o,a)}}),l}function ZE(t,e,n,r,i,s,o){if(Eo(i,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(r.value!=null){if(ce(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return To(t,e,n,l.getNode().getChild(n),i,s,a,o);if(ce(n)){let c=new Pe(null);return l.getNode().forEachChild(Fr,(u,d)=>{c=c.set(new Ie(u),d)}),yl(t,e,n,c,i,s,a,o)}else return e}else{let c=new Pe(null);return r.foreach((u,d)=>{const h=$e(n,u);l.isCompleteForPath(h)&&(c=c.set(u,l.getNode().getChild(h)))}),yl(t,e,n,c,i,s,a,o)}}function eT(t,e,n,r,i){const s=e.serverCache,o=sg(e,s.getNode(),s.isFullyInitialized()||ce(n),s.isFiltered());return hg(t,o,n,r,dg,i)}function tT(t,e,n,r,i,s){let o;if(Eo(r,n)!=null)return e;{const a=new Lc(r,e,i),l=e.eventCache.getNode();let c;if(ce(n)||se(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Co(r,pr(e));else{const d=e.serverCache.getNode();A(d instanceof Y,"serverChildren would be complete if leaf node"),u=Mc(r,d)}u=u,c=t.filter.updateFullNode(l,u,s)}else{const u=se(n);let d=Dc(r,u,e.serverCache);d==null&&e.serverCache.isCompleteForChild(u)&&(d=l.getImmediateChild(u)),d!=null?c=t.filter.updateChild(l,u,d,Ae(n),a,s):e.eventCache.getNode().hasChild(u)?c=t.filter.updateChild(l,u,Y.EMPTY_NODE,Ae(n),a,s):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Co(r,pr(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,s)))}return o=e.serverCache.isFullyInitialized()||Eo(r,ve())!=null,Fi(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
