 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sC(t){jm(Ts),An(new Yt("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return XE(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),Rt(kl,Pl,t),Rt(kl,Pl,"esm2017")}lt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};lt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};sC();const iC={apiKey:"AIzaSyAsXHXd9Spu67AO6DV06x2E_EnVOIAu9UU",authDomain:"quick-retro.firebaseapp.com",projectId:"quick-retro",storageBucket:"quick-retro.appspot.com",messagingSenderId:"293134428599",appId:"1:293134428599:web:bad71d4fedbda8080ce032",databaseURL:"https://quick-retro-default-rtdb.europe-west1.firebasedatabase.app"},rC=q_(iC),Yi=nC(rC);function oC(t){const e=Wn({});return YE(Gi(Yi,t),n=>{Object.entries(n.val()).forEach(([s,i])=>{e[s]=i})}),e}function aC(t,e){const n=Gi(Yi,t);KE(n,{cardsHidden:e})}function lC(t,e,n){const s=Gi(Yi,`${t}/columns/${e}/cards`);qE(s,n)}function cC(t,e,n){zE(Gi(Yi,`${t}/columns/${e}/cards/${n}`))}function uC(){const t=Wn({}),e=$m();return Ag(e).catch(n=>{console.error(n)}),Og(e,n=>{console.log("auth status",n),n&&Object.entries(n).forEach(([s,i])=>{t[s]=i})}),t}var hd=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n};const hC=wo({props:{text:null,color:null,author:null,onDelete:null,id:null},setup(t){const{author:e}=t;uu(r=>({"26d6cd06":t.color}));const s=vn("user").uid===e,i=vn("board");return(r,o)=>{var a;return jt(),hs("li",{class:Ei({hidden:!s&&((a=Sn(i))==null?void 0:a.cardsHidden)})},[Qe("button",{onClick:o[0]||(o[0]=l=>t.onDelete(t.id))},"\u2716"),iu(" "+ao(t.text),1)],2)}}});var dC=hd(hC,[["__scopeId","data-v-7a5d75d4"]]);const fC=wo({props:{title:null,color:null,boardId:null,columnId:null,cards:null},setup(t){const{columnId:e,boardId:n}=t;uu(a=>({"4d00c290":t.color}));const s=Wn({inputText:""}),i=vn("user");function r(a){a.preventDefault(),s.inputText.trim()!==""&&(!(i!=null&&i.uid)||(lC(n,e,{text:s.inputText,author:i.uid}),s.inputText=""))}function o(a){cC(n,e,a)}return(a,l)=>(jt(),hs("section",null,[Qe("h2",null,ao(t.title),1),Qe("ul",null,[(jt(!0),hs(Te,null,ru(t.cards,(c,u)=>(jt(),nu(dC,{id:u,author:c.author,text:c.text,color:t.color,onDelete:o},null,8,["id","author","text","color"]))),256))]),Qe("form",{target:"#",onSubmit:r},[zf(Qe("input",{"onUpdate:modelValue":l[0]||(l[0]=c=>Sn(s).inputText=c)},null,512),[[Fp,Sn(s).inputText]])],32)]))}});var pC=hd(fC,[["__scopeId","data-v-57aa2a5a"]]);const _C=Qe("h1",null,"\u{1F680} quick retro \u{1F680}",-1),gC=wo({setup(t){const e="1",n=oC(e),s=uC();Tr("user",s),Tr("board",n);function i(){aC(e,!n.cardsHidden)}return(r,o)=>(jt(),hs(Te,null,[_C,Qe("main",null,[(jt(!0),hs(Te,null,ru(Sn(n).columns,a=>(jt(),nu(pC,{cards:a.cards,"column-id":a.id,"board-id":e,key:a.id,title:a.title,color:a.color},null,8,["cards","column-id","title","color"]))),128))]),Qe("button",{onClick:i},ao(Sn(n).cardsHidden?"show":"hide"),1)],64))}});Hp(gC).mount("#app");
