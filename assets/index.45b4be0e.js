 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ui=new Map,qr=new Map;function G_(t,e){try{t.container.addComponent(e)}catch(n){Lo.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Pn(t){const e=t.name;if(qr.has(e))return Lo.debug(`There were multiple attempts to register component ${e}.`),!1;qr.set(e,t);for(const n of ui.values())G_(n,t);return!0}function Fo(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ks=z_;function J_(t,e={}){typeof e!="object"&&(e={name:e});const n=Object.assign({name:Tu,automaticDataCollectionEnabled:!1},e),s=n.name;if(typeof s!="string"||!s)throw en.create("bad-app-name",{appName:String(s)});const i=ui.get(s);if(i){if(ci(t,i.options)&&ci(n,i.config))return i;throw en.create("duplicate-app",{appName:s})}const r=new __(s);for(const a of qr.values())r.addComponent(a);const o=new Q_(t,n,r);return ui.set(s,o),o}function Su(t=Tu){const e=ui.get(t);if(!e)throw en.create("no-app",{appName:t});return e}function xt(t,e,n){var s;let i=(s=K_[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Lo.warn(a.join(" "));return}Pn(new Zt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yl=new Do("@firebase/auth");function Zs(t,...e){yl.logLevel<=K.ERROR&&yl.error(`Auth (${ks}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hg(t,e){const n=Fo(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),r=n.getOptions();if(ci(r,e!=null?e:{}))return i;pt(i,"already-initialized")}return n.initialize({options:e})}function dg(t,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(ut);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mg=new As(3e4,6e4);function Pu(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function Wi(t,e,n,s,i={}){return Ou(t,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const a=qn(Object.assign({key:t.config.apiKey},o)).slice(1),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode),xu.fetch()(Du(t,t.config.apiHost,n,a),Object.assign({method:e,headers:l,referrerPolicy:"no-referrer"},r))})}async function Ou(t,e,n){t._canInitEmulator=!1;const s=Object.assign(Object.assign({},gg),e);try{const i=new yg(t),r=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw fr(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw fr(t,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw fr(t,"email-already-in-use",o);const u=s[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw ug(t,u,c);pt(t,u)}}catch(i){if(i instanceof jn)throw i;pt(t,"network-request-failed")}}async function Mu(t,e,n,s,i={}){const r=await Wi(t,e,n,s,i);return"mfaPendingCredential"in r&&pt(t,"multi-factor-auth-required",{_serverResponse:r}),r}function Du(t,e,n,s){const i=`${e}${n}?${s}`;return t.config.emulator?Wo(t.config,i):`${t.config.apiScheme}://${i}`}class yg{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(tt(this.auth,"network-request-failed")),mg.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function fr(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const i=tt(t,e,s);return i.customData._tokenResponse=n,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vg(t,e){return Wi(t,"POST","/v1/accounts:delete",e)}async function Eg(t,e){return Wi(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function as(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Cg(t,e=!1){const n=it(t),s=await n.getIdToken(e),i=Ho(s);O(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const r=typeof i.firebase=="object"?i.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:i,token:s,authTime:as(pr(i.auth_time)),issuedAtTime:as(pr(i.iat)),expirationTime:as(pr(i.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function pr(t){return Number(t)*1e3}function Ho(t){const[e,n,s]=t.split(".");if(e===void 0||n===void 0||s===void 0)return Zs("JWT malformed, contained fewer than 3 sections"),null;try{const i=$r(n);return i?JSON.parse(i):(Zs("Failed to decode base64 JWT payload"),null)}catch(i){return Zs("Caught error parsing JWT payload as JSON",i),null}}function Ig(t){const e=Ho(t);return O(e,"internal-error"),O(typeof e.exp!="undefined","internal-error"),O(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class di extends jn{constructor(e,n,s,i){var r;super(n.code,n.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,di.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,i){return new di(e,n,s,i)}}function Gu(t,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?di._fromErrorAndOperation(t,r,e,s):r})}async function Lg(t,e,n=!1){const s=await vs(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Mt._forOperation(t,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ug(t,e,n=!1){const s="signIn",i=await Gu(t,s,e),r=await Mt._fromIdTokenResponse(t,s,i);return n||await t._updateCurrentUser(r.user),r}function Bg(t,e,n,s){return it(t).onAuthStateChanged(e,n,s)}const fi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yu{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(fi,"1"),this.storage.removeItem(fi),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const n=this.receivers.find(i=>i.isListeningto(e));if(n)return n;const s=new $i(e);return this.receivers.push(s),s}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const n=e,{eventId:s,eventType:i,data:r}=n.data,o=this.handlersMap[i];if(!(o!=null&&o.size))return;n.ports[0].postMessage({status:"ack",eventId:s,eventType:i});const a=Array.from(o).map(async c=>c(n.origin,r)),l=await jg(a);n.ports[0].postMessage({status:"done",eventId:s,eventType:i,response:l})}_subscribe(e,n){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(n)}_unsubscribe(e,n){this.handlersMap[e]&&n&&this.handlersMap[e].delete(n),(!n||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}$i.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vm(t,e={}){return Wi(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gi extends Th{constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!Mo()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new gi}getInitialEvent(e){return E(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const n of e.values())this.sendListen_(n);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let n="js";e["sdk."+n+"."+rh.replace(/\./g,"-")]=1,Mo()?e["framework.cordova"]=1:Eu()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=gi.getInstance().currentlyOnline();return Vr(this.interruptReasons_)&&e}}dt.nextPersistentConnectionId_=0;dt.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ji{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,n){const s=new F(On,e),i=new F(On,n);return this.compare(s,i)!==0}minPost(){return F.MIN}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let zs;class Nh extends ji{static get __EMPTY_NODE(){return zs}static set __EMPTY_NODE(e){zs=e}compare(e,n){return cn(e.name,n.name)}isDefinedOn(e){throw Vn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return F.MIN}maxPost(){return new F(sn,zs)}makePost(e,n){return E(typeof e=="string","KeyIndex indexValue must always be a string."),new F(e,zs)}toString(){return".key"}}const Rn=new Nh;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class av extends ji{compare(e,n){const s=e.node.compareTo(n.node);return s===0?cn(e.name,n.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return F.MIN}maxPost(){return F.MAX}makePost(e,n){const s=he(e);return new F(n,s)}toString(){return".value"}}const lv=new av;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vi(){return{value:null,children:new Map}}function Mh(t,e,n){if(B(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=L(e);t.children.has(s)||t.children.set(s,vi());const i=t.children.get(s);e=Q(e),Mh(i,e,n)}}function Zr(t,e,n){t.value!==null?n(e,t.value):pv(t,(s,i)=>{const r=new q(e.toString()+"/"+s);Zr(i,r,n)})}function pv(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e,n,s){this.path=e,this.affectedTree=n,this.revert=s,this.type=qe.ACK_USER_WRITE,this.source=ia()}operationForChild(e){if(B(this.path)){if(this.affectedTree.value!=null)return E(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new q(e));return new Ei($(),n,this.revert)}}else return E(L(this.path)===e,"operationForChild called for unrelated child."),new Ei(Q(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ts{constructor(e,n){this.source=e,this.path=n,this.type=qe.LISTEN_COMPLETE}operationForChild(e){return B(this.path)?new Ts(this.source,$()):new Ts(this.source,Q(this.path))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rn{constructor(e,n,s){this.source=e,this.path=n,this.snap=s,this.type=qe.OVERWRITE}operationForChild(e){return B(this.path)?new rn(this.source,$(),this.snap.getImmediateChild(e)):new rn(this.source,Q(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qi(t,e){return{eventCache:t,serverCache:e}}function cs(t,e,n,s){return qi(new on(e,n,s),t.serverCache)}function Dh(t,e,n,s){return qi(t.eventCache,new on(e,n,s))}function eo(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function an(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let wi;class Zv{constructor(){this.views=new Map}}function eE(t){E(!wi,"__referenceConstructor has already been defined"),wi=t}function tE(){return E(wi,"Reference.ts has not been loaded"),wi}function nE(t){return t.views.size===0}function ha(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return E(r!=null,"SyncTree gave us an op for an invalid query."),oc(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(oc(o,e,n,s));return r}}function sE(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=Ci(n,i?s:null),l=!1;a?l=!0:s instanceof x?(a=la(n,s),l=!1):(a=x.EMPTY_NODE,l=!1);const c=qi(new on(a,l,!1),new on(s,i,!1));return new Gv(e,c)}return o}function iE(t,e,n,s,i,r){const o=sE(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),Jv(o,n),Xv(o,n)}function rE(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const a=Lt(t);if(i==="default")for(const[l,c]of t.views.entries())o=o.concat(rc(c,n,s)),ic(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(i);l&&(o=o.concat(rc(l,n,s)),ic(l)&&(t.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!Lt(t)&&r.push(new(tE())(e._repo,e._path)),{removed:r,events:o}}function jh(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Nn(t,e){let n=null;for(const s of t.views.values())n=n||Qv(s,e);return n}function qh(t,e){if(e._queryParams.loadsAllData())return zi(t);{const s=e._queryIdentifier;return t.views.get(s)}}function zh(t,e){return qh(t,e)!=null}function Lt(t){return zi(t)!=null}function zi(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DE="repo_interrupt",LE=25;class FE{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new OE,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=vi(),this.transactionQueueTree_=new va,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function UE(t,e,n){if(t.stats_=Yo(t.repoInfo_),t.forceRestClient_||uy())t.server_=new yi(t.repoInfo_,(s,i,r,o)=>{uc(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>hc(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{de(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new dt(t.repoInfo_,e,(s,i,r,o)=>{uc(t,s,i,r,o)},s=>{hc(t,s)},s=>{BE(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=my(t.repoInfo_,()=>new yv(t.stats_,t.server_)),t.infoData_=new fv,t.infoSyncTree_=new ac({startListening:(s,i,r,o)=>{let a=[];const l=t.infoData_.getNode(s._path);return l.isEmpty()||(a=Ki(t.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),ba(t,"connected",!1),t.serverSyncTree_=new ac({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);Qe(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function ad(t){const n=t.infoData_.getNode(new q(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function Xi(t){return vE({timestamp:ad(t)})}function uc(t,e,n,s,i){t.dataUpdateCount++;const r=new q(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const l=li(n,c=>he(c));o=pE(t.serverSyncTree_,r,l,i)}else{const l=he(n);o=fE(t.serverSyncTree_,r,l,i)}else if(s){const l=li(n,c=>he(c));o=uE(t.serverSyncTree_,r,l)}else{const l=he(n);o=Ki(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Fn(t,r)),Qe(t.eventQueue_,a,o)}function hc(t,e){ba(t,"connected",e),e===!1&&$E(t)}function BE(t,e){ye(e,(n,s)=>{ba(t,n,s)})}function ba(t,e,n){const s=new q("/.info/"+e),i=he(n);t.infoData_.updateSnapshot(s,i);const r=Ki(t.infoSyncTree_,s,i);Qe(t.eventQueue_,s,r)}function wa(t){return t.nextWriteId_++}function WE(t,e,n,s,i){Zi(t,"set",{path:e.toString(),value:n,priority:s});const r=Xi(t),o=he(n,s),a=da(t.serverSyncTree_,e),l=Xh(o,a,r),c=wa(t),u=Kh(t.serverSyncTree_,e,l,c,!0);Ji(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(f,g)=>{const C=f==="ok";C||we("set at "+e+" failed: "+f);const S=Rt(t.serverSyncTree_,c,!C);Qe(t.eventQueue_,e,S),lo(t,i,f,g)});const h=Sa(t,e);Fn(t,h),Qe(t.eventQueue_,h,[])}function HE(t,e,n,s){Zi(t,"update",{path:e.toString(),value:n});let i=!0;const r=Xi(t),o={};if(ye(n,(a,l)=>{i=!1,o[a]=Jh(ie(e,a),he(l),t.serverSyncTree_,r)}),i)_e("update() called with empty data.  Don't do anything."),lo(t,s,"ok",void 0);else{const a=wa(t),l=cE(t.serverSyncTree_,e,o,a);Ji(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,u)=>{const h=c==="ok";h||we("update at "+e+" failed: "+c);const f=Rt(t.serverSyncTree_,a,!h),g=f.length>0?Fn(t,e):e;Qe(t.eventQueue_,g,f),lo(t,s,c,u)}),ye(n,c=>{const u=Sa(t,ie(e,c));Fn(t,u)}),Qe(t.eventQueue_,e,[])}}function $E(t){Zi(t,"onDisconnectEvents");const e=Xi(t),n=vi();Zr(t.onDisconnect_,$(),(i,r)=>{const o=Jh(i,r,t.serverSyncTree_,e);Mh(n,i,o)});let s=[];Zr(n,$(),(i,r)=>{s=s.concat(Ki(t.serverSyncTree_,i,r));const o=Sa(t,i);Fn(t,o)}),t.onDisconnect_=vi(),Qe(t.eventQueue_,$(),s)}function VE(t,e,n){let s;L(e._path)===".info"?s=lc(t.infoSyncTree_,e,n):s=lc(t.serverSyncTree_,e,n),rd(t.eventQueue_,e._path,s)}function dc(t,e,n){let s;L(e._path)===".info"?s=oo(t.infoSyncTree_,e,n):s=oo(t.serverSyncTree_,e,n),rd(t.eventQueue_,e._path,s)}function jE(t){t.persistentConnection_&&t.persistentConnection_.interrupt(DE)}function Zi(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),_e(n,...e)}function lo(t,e,n,s){e&&zn(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function ld(t,e,n){return da(t.serverSyncTree_,e,n)||x.EMPTY_NODE}function Ta(t,e=t.transactionQueueTree_){if(e||er(t,e),Gn(e)){const n=ud(t,e);E(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&qE(t,Ls(e),n)}else ed(e)&&Yi(e,n=>{Ta(t,n)})}function qE(t,e,n){const s=n.map(c=>c.currentWriteId),i=ld(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];E(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=Re(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{Zi(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let f=0;f<n.length;f++)n[f].status=2,u=u.concat(Rt(t.serverSyncTree_,n[f].currentWriteId)),n[f].onComplete&&h.push(()=>n[f].onComplete(null,!0,n[f].currentOutputSnapshotResolved)),n[f].unwatcher();er(t,Ea(t.transactionQueueTree_,e)),Ta(t,t.transactionQueueTree_),Qe(t.eventQueue_,e,u);for(let f=0;f<h.length;f++)zn(h[f])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{we("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}Fn(t,e)}},o)}function Fn(t,e){const n=cd(t,e),s=Ls(n),i=ud(t,n);return zE(t,i,s),s}function zE(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=Re(n,l.path);let u=!1,h;if(E(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,h=l.abortReason,i=i.concat(Rt(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=LE)u=!0,h="maxretry",i=i.concat(Rt(t.serverSyncTree_,l.currentWriteId,!0));else{const f=ld(t,l.path,o);l.currentInputSnapshot=f;const g=e[a].update(f.val());if(g!==void 0){Qi("transaction failed: Data returned ",g,l.path);let C=he(g);typeof g=="object"&&g!=null&&st(g,".priority")||(C=C.updatePriority(f.getPriority()));const N=l.currentWriteId,U=Xi(t),oe=Xh(C,f,U);l.currentOutputSnapshotRaw=C,l.currentOutputSnapshotResolved=oe,l.currentWriteId=wa(t),o.splice(o.indexOf(N),1),i=i.concat(Kh(t.serverSyncTree_,l.path,oe,l.currentWriteId,l.applyLocally)),i=i.concat(Rt(t.serverSyncTree_,N,!0))}else u=!0,h="nodata",i=i.concat(Rt(t.serverSyncTree_,l.currentWriteId,!0))}Qe(t.eventQueue_,n,i),i=[],u&&(e[a].status=2,function(f){setTimeout(f,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}er(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)zn(s[a]);Ta(t,t.transactionQueueTree_)}function cd(t,e){let n,s=t.transactionQueueTree_;for(n=L(e);n!==null&&Gn(s)===void 0;)s=Ea(s,n),e=Q(e),n=L(e);return s}function ud(t,e){const n=[];return hd(t,e,n),n.sort((s,i)=>s.order-i.order),n}function hd(t,e,n){const s=Gn(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);Yi(e,i=>{hd(t,i,n)})}function er(t,e){const n=Gn(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,Zh(e,n.length>0?n:void 0)}Yi(e,s=>{er(t,s)})}function Sa(t,e){const n=Ls(cd(t,e)),s=Ea(t.transactionQueueTree_,e);return bE(s,i=>{br(t,i)}),br(t,s),td(s,i=>{br(t,i)}),n}function br(t,e){const n=Gn(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(E(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(E(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Rt(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Zh(e,void 0):n.length=r+1,Qe(t.eventQueue_,Ls(e),i);for(let o=0;o<s.length;o++)zn(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
