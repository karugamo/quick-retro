 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vb(t){cy(Ls),Un(new Zt("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return pb(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),xt(Wl,Hl,t),xt(Wl,Hl,"esm2017")}ft.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};ft.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};vb();const Eb={apiKey:"AIzaSyAsXHXd9Spu67AO6DV06x2E_EnVOIAu9UU",authDomain:"quick-retro.firebaseapp.com",projectId:"quick-retro",storageBucket:"quick-retro.appspot.com",messagingSenderId:"293134428599",appId:"1:293134428599:web:bad71d4fedbda8080ce032",databaseURL:"https://quick-retro-default-rtdb.europe-west1.firebasedatabase.app"},bb=ug(Eb),fn=yb(bb);function Cb(){const t=ln({});return Sd(dn(fn,"boards"),e=>{Object.entries(e.val()).forEach(([n,s])=>{t[n]=s})}),t}function Ib(t){const e=ln({loading:!0});return Sd(dn(fn,`boards/${t}`),n=>{e.exists=n.exists(),e.loading=!1,e.exists&&Object.entries(n.val()).forEach(([s,i])=>{e[s]=i})}),e}function wb(t,e){const n=dn(fn,`boards/${t}`);Td(n,{cardsHidden:e})}function Tb(t,e){const n=dn(fn,`boards/${t}`);Td(n,{title:e})}function Sb(t,e,n){const s=dn(fn,`boards/${t}/columns/${e}/cards`);Id(s,n)}function Rb(t,e,n){ub(dn(fn,`boards/${t}/columns/${e}/cards/${n}`))}async function Nb(t,e){const n=dn(fn,"boards");return(await Id(n,{author:t,cardsHidden:!0,title:"",columns:e.columns.map(i=>$a(Ha({},i),{cards:{}}))})).key}function kb(){const t=ln({}),e=ly();return Gg(e).catch(n=>{console.error(n)}),Xg(e,n=>{n&&Object.entries(n).forEach(([s,i])=>{t[s]=i})}),t}var pn=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n};const Ab=cn({props:{text:null,onClick:null},setup(t){return(e,n)=>(Q(),le("button",{onClick:n[0]||(n[0]=(...s)=>t.onClick&&t.onClick(...s))},jt(t.text),1))}});var xb=pn(Ab,[["__scopeId","data-v-f7270f9a"]]);const Pb=cn({props:{text:null,color:null,author:null,onDelete:null,id:null},setup(t){const{author:e}=t;Cu(r=>({"26d6cd06":t.color}));const s=dt("user").uid===e,i=dt("board");return(r,o)=>{var a;return Q(),le("li",{class:Os({hidden:!s&&((a=Fe(i))==null?void 0:a.cardsHidden)})},[ce("button",{onClick:o[0]||(o[0]=l=>t.onDelete(t.id))},"\u2716"),gu(" "+jt(t.text),1)],2)}}});var Ob=pn(Pb,[["__scopeId","data-v-7a5d75d4"]]);const Mb=cn({props:{title:null,color:null,boardId:null,columnId:null,cards:null},setup(t){const{columnId:e,boardId:n}=t;Cu(a=>({"62139bba":t.color}));const s=ln({inputText:""}),i=dt("user");function r(a){a.preventDefault(),s.inputText.trim()!==""&&(!(i!=null&&i.uid)||(Sb(n,e,{text:s.inputText,author:i.uid}),s.inputText=""))}function o(a){Rb(n,e,a)}return(a,l)=>(Q(),le("section",null,[ce("h2",null,jt(t.title),1),ce("ul",null,[(Q(!0),le(he,null,In(t.cards,(c,u)=>(Q(),Dn(Ob,{id:u,author:c.author,text:c.text,color:t.color,onDelete:o},null,8,["id","author","text","color"]))),256))]),ce("form",{target:"#",onSubmit:r},[hu(ce("input",{placeholder:"Add new card","onUpdate:modelValue":l[0]||(l[0]=c=>Fe(s).inputText=c)},null,512),[[Iu,Fe(s).inputText]])],32)]))}});var Db=pn(Mb,[["__scopeId","data-v-345fc8cf"]]);const Lb={class:"board"},Fb={class:"columns"},Ub={class:"options"},Bb=cn({setup(t){const e=dt("board"),n=dt("boardId");function s(){wb(n,!e.cardsHidden)}function i(){return e.cardsHidden?"Show all cards":"Hide other cards"}function r(c){c.key==="Enter"&&c.preventDefault()}function o(c){const u=(c==null?void 0:c.target).value.trim();Tb(n,u),l.value=u||"Untitled Retro"}function a(){l.value==="Untitled Retro"&&(l.value="")}const l=jc(e.title||"Untitled Retro");return(c,u)=>(Q(),le(he,null,[ce("div",Lb,[hu(ce("input",{class:Os({untitled:l.value==="Untitled Retro"}),"onUpdate:modelValue":u[0]||(u[0]=h=>l.value=h),onKeypress:r,onFocusout:o,onFocusin:a},null,34),[[Iu,l.value]]),ce("section",Fb,[(Q(!0),le(he,null,In(Fe(e).columns,(h,f)=>{var g;return Q(),Dn(Db,{cards:(g=h.cards)!=null?g:[],"column-id":String(f),"board-id":Fe(n),key:String(f),title:h.title,color:h.color},null,8,["cards","column-id","board-id","title","color"])}),128))])]),ce("section",Ub,[Ye(xb,{"on-click":s,text:i()},null,8,["text"])])],64))}});var Wb=pn(Bb,[["__scopeId","data-v-4993674a"]]);const Hb={},$b={class:"loader"};function Vb(t,e){return Q(),le("div",$b,"Loading...")}var jb=pn(Hb,[["render",Vb],["__scopeId","data-v-840bd5c8"]]);const qb={key:0},zb={key:1},Kb={key:1},Gb=cn({props:{boardId:null},setup(t){const{boardId:e}=t,n=Ib(e);return ci("boardId",e),ci("board",n),(s,i)=>(Q(),le(he,null,[Fe(n).loading?Qs("",!0):(Q(),le("main",qb,[Fe(n).exists?(Q(),Dn(Wb,{key:0})):Qs("",!0),Fe(n).exists?Qs("",!0):(Q(),le("div",zb,"Couldn't find board"))])),Fe(n).loading?(Q(),le("main",Kb,[Ye(jb)])):Qs("",!0)],64))}});var Yb=pn(Gb,[["__scopeId","data-v-958615b4"]]);const Qb=[{title:"Mad Sad Glad",columns:[{title:"Mad",color:"#f44336"},{title:"Sad",color:"#e91e63"},{title:"Glad",color:"#9c27b0"}]},{title:"Start Stop Continue",columns:[{title:"Start",color:"#2196f3"},{title:"Stop",color:"#ff9800"},{title:"Continue",color:"#009688"}]},{title:"Sailboat",columns:[{title:"What is the wind pushing our sails that make us go fast",color:"#f44336"},{title:"What anchors are holding us back",color:"#e91e63"},{title:"What rocks are ahead of us that risk our future",color:"#9c27b0"},{title:"What is our ideal island destination",color:"#673ab7"}]}];const Pa=t=>(Mf("data-v-7b2fefc0"),t=t(),Df(),t),Jb=Pa(()=>ce("h1",null,"\u{1F680} quick retro \u{1F680}",-1)),Xb=Pa(()=>ce("h2",null,"start a new board",-1)),Zb=["onClick"],eC={class:"columns"},tC=["title"],nC=Pa(()=>ce("h2",null,"your boards",-1)),sC=["onClick"],iC={class:"columns"},rC=cn({props:{navigateToBoard:null},setup(t){const{navigateToBoard:e}=t,n=Cb(),s=dt("user"),i=Eu(()=>Object.fromEntries(Object.entries(n).filter(([o,a])=>a.author===(s==null?void 0:s.uid))));async function r(o){if(!(s!=null&&s.uid))return;const a=await Nb(s.uid,o);a&&e(a)}return(o,a)=>(Q(),le("main",null,[Jb,Xb,ce("section",null,[(Q(!0),le(he,null,In(Fe(Qb),l=>(Q(),le("div",{class:"board template",onClick:c=>r(l)},[ce("h3",null,jt(l.title),1),ce("div",eC,[(Q(!0),le(he,null,In(l.columns,c=>(Q(),le("div",{class:"column",style:ms({backgroundColor:c.color}),title:c.title},jt(c.title),13,tC))),256))])],8,Zb))),256))]),nC,ce("section",null,[(Q(!0),le(he,null,In(Fe(i),(l,c)=>(Q(),le("div",{class:"board",onClick:u=>t.navigateToBoard(c)},[ce("h3",null,jt(l.title||"Untitled Retro"),1),ce("div",iC,[(Q(!0),le(he,null,In(l.columns,u=>(Q(),le("div",{class:"column",style:ms({backgroundColor:u.color})},jt(u.title),5))),256))])],8,sC))),256))])]))}});var oC=pn(rC,[["__scopeId","data-v-7b2fefc0"]]);const aC=cn({setup(t){const e=jc(window.location.hash.slice(1));console.log(window.location.hash);function n(i){history.pushState({},"",`#${i}`),e.value=i}addEventListener("popstate",()=>{e.value=window.location.hash.slice(1)});const s=kb();return ci("user",s),(i,r)=>e.value&&e.value.length>0?(Q(),Dn(Yb,{key:0,boardId:e.value},null,8,["boardId"])):(Q(),Dn(oC,{key:1,"navigate-to-board":n}))}});r_(aC).mount("#app");
