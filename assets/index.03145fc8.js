var Ad=Object.defineProperty,xd=Object.defineProperties;var Pd=Object.getOwnPropertyDescriptors;var Ba=Object.getOwnPropertySymbols;var Od=Object.prototype.hasOwnProperty,Md=Object.prototype.propertyIsEnumerable;var Wa=(t,e,n)=>e in t?Ad(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,Ha=(t,e)=>{for(var n in e||(e={}))Od.call(e,n)&&Wa(t,n,e[n]);if(Ba)for(var n of Ba(e))Md.call(e,n)&&Wa(t,n,e[n]);return t},$a=(t,e)=>xd(t,Pd(e));const Dd=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerpolicy&&(r.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?r.credentials="include":i.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=n(i);fetch(i.href,r)}};Dd();function _o(t,e){const n=Object.create(null),s=t.split(",");for(let i=0;i<s.length;i++)n[s[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const Ld="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Fd=_o(Ld);function Cc(t){return!!t||t===""}function xi(t){if(M(t)){const e={};for(let n=0;n<t.length;n++){const s=t[n],i=_e(s)?Wd(s):xi(s);if(i)for(const r in i)e[r]=i[r]}return e}else{if(_e(t))return t;if(ge(t))return t}}const Ud=/;(?![^(]*\))/g,Bd=/:(.+)/;function Wd(t){const e={};return t.split(Ud).forEach(n=>{if(n){const s=n.split(Bd);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function Vn(t){let e="";if(_e(t))e=t;else if(M(t))for(let n=0;n<t.length;n++){const s=Vn(t[n]);s&&(e+=s+" ")}else if(ge(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const gs=t=>_e(t)?t:t==null?"":M(t)||ge(t)&&(t.toString===Sc||!D(t.toString))?JSON.stringify(t,Ic,2):String(t),Ic=(t,e)=>e&&e.__v_isRef?Ic(t,e.value):Sn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[s,i])=>(n[`${s} =>`]=i,n),{})}:wc(e)?{[`Set(${e.size})`]:[...e.values()]}:ge(e)&&!M(e)&&!Rc(e)?String(e):e,G={},Tn=[],Ke=()=>{},Hd=()=>!1,$d=/^on[^a-z]/,Pi=t=>$d.test(t),go=t=>t.startsWith("onUpdate:"),Ie=Object.assign,mo=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},Vd=Object.prototype.hasOwnProperty,W=(t,e)=>Vd.call(t,e),M=Array.isArray,Sn=t=>Oi(t)==="[object Map]",wc=t=>Oi(t)==="[object Set]",D=t=>typeof t=="function",_e=t=>typeof t=="string",yo=t=>typeof t=="symbol",ge=t=>t!==null&&typeof t=="object",Tc=t=>ge(t)&&D(t.then)&&D(t.catch),Sc=Object.prototype.toString,Oi=t=>Sc.call(t),jd=t=>Oi(t).slice(8,-1),Rc=t=>Oi(t)==="[object Object]",vo=t=>_e(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Xs=_o(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Mi=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},qd=/-(\w)/g,On=Mi(t=>t.replace(qd,(e,n)=>n?n.toUpperCase():"")),zd=/\B([A-Z])/g,jn=Mi(t=>t.replace(zd,"-$1").toLowerCase()),Nc=Mi(t=>t.charAt(0).toUpperCase()+t.slice(1)),ur=Mi(t=>t?`on${Nc(t)}`:""),ms=(t,e)=>!Object.is(t,e),Zs=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},ri=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},Nr=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let Va;const Kd=()=>Va||(Va=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});let et;class Gd{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&et&&(this.parent=et,this.index=(et.scopes||(et.scopes=[])).push(this)-1)}run(e){if(this.active){const n=et;try{return et=this,e()}finally{et=n}}}on(){et=this}off(){et=this.parent}stop(e){if(this.active){let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.scopes)for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.active=!1}}}function Yd(t,e=et){e&&e.active&&e.effects.push(t)}const Eo=t=>{const e=new Set(t);return e.w=0,e.n=0,e},kc=t=>(t.w&Ot)>0,Ac=t=>(t.n&Ot)>0,Qd=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=Ot},Jd=t=>{const{deps:e}=t;if(e.length){let n=0;for(let s=0;s<e.length;s++){const i=e[s];kc(i)&&!Ac(i)?i.delete(t):e[n++]=i,i.w&=~Ot,i.n&=~Ot}e.length=n}},kr=new WeakMap;let rs=0,Ot=1;const Ar=30;let Ve;const Yt=Symbol(""),xr=Symbol("");class bo{constructor(e,n=null,s){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,Yd(this,s)}run(){if(!this.active)return this.fn();let e=Ve,n=kt;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Ve,Ve=this,kt=!0,Ot=1<<++rs,rs<=Ar?Qd(this):ja(this),this.fn()}finally{rs<=Ar&&Jd(this),Ot=1<<--rs,Ve=this.parent,kt=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Ve===this?this.deferStop=!0:this.active&&(ja(this),this.onStop&&this.onStop(),this.active=!1)}}function ja(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let kt=!0;const xc=[];function qn(){xc.push(kt),kt=!1}function zn(){const t=xc.pop();kt=t===void 0?!0:t}function De(t,e,n){if(kt&&Ve){let s=kr.get(t);s||kr.set(t,s=new Map);let i=s.get(n);i||s.set(n,i=Eo()),Pc(i)}}function Pc(t,e){let n=!1;rs<=Ar?Ac(t)||(t.n|=Ot,n=!kc(t)):n=!t.has(Ve),n&&(t.add(Ve),Ve.deps.push(t))}function pt(t,e,n,s,i,r){const o=kr.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&M(t))o.forEach((l,c)=>{(c==="length"||c>=s)&&a.push(l)});else switch(n!==void 0&&a.push(o.get(n)),e){case"add":M(t)?vo(n)&&a.push(o.get("length")):(a.push(o.get(Yt)),Sn(t)&&a.push(o.get(xr)));break;case"delete":M(t)||(a.push(o.get(Yt)),Sn(t)&&a.push(o.get(xr)));break;case"set":Sn(t)&&a.push(o.get(Yt));break}if(a.length===1)a[0]&&Pr(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);Pr(Eo(l))}}function Pr(t,e){for(const n of M(t)?t:[...t])(n!==Ve||n.allowRecurse)&&(n.scheduler?n.scheduler():n.run())}const Xd=_o("__proto__,__v_isRef,__isVue"),Oc=new Set(Object.getOwnPropertyNames(Symbol).map(t=>Symbol[t]).filter(yo)),Zd=Co(),ef=Co(!1,!0),tf=Co(!0),qa=nf();function nf(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const s=V(this);for(let r=0,o=this.length;r<o;r++)De(s,"get",r+"");const i=s[e](...n);return i===-1||i===!1?s[e](...n.map(V)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){qn();const s=V(this)[e].apply(this,n);return zn(),s}}),t}function Co(t=!1,e=!1){return function(s,i,r){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&r===(t?e?vf:Uc:e?Fc:Lc).get(s))return s;const o=M(s);if(!t&&o&&W(qa,i))return Reflect.get(qa,i,r);const a=Reflect.get(s,i,r);return(yo(i)?Oc.has(i):Xd(i))||(t||De(s,"get",i),e)?a:ve(a)?!o||!vo(i)?a.value:a:ge(a)?t?Bc(a):un(a):a}}const sf=Mc(),rf=Mc(!0);function Mc(t=!1){return function(n,s,i,r){let o=n[s];if(ys(o)&&ve(o)&&!ve(i))return!1;if(!t&&!ys(i)&&(Wc(i)||(i=V(i),o=V(o)),!M(n)&&ve(o)&&!ve(i)))return o.value=i,!0;const a=M(n)&&vo(s)?Number(s)<n.length:W(n,s),l=Reflect.set(n,s,i,r);return n===V(r)&&(a?ms(i,o)&&pt(n,"set",s,i):pt(n,"add",s,i)),l}}function of(t,e){const n=W(t,e);t[e];const s=Reflect.deleteProperty(t,e);return s&&n&&pt(t,"delete",e,void 0),s}function af(t,e){const n=Reflect.has(t,e);return(!yo(e)||!Oc.has(e))&&De(t,"has",e),n}function lf(t){return De(t,"iterate",M(t)?"length":Yt),Reflect.ownKeys(t)}const Dc={get:Zd,set:sf,deleteProperty:of,has:af,ownKeys:lf},cf={get:tf,set(t,e){return!0},deleteProperty(t,e){return!0}},uf=Ie({},Dc,{get:ef,set:rf}),Io=t=>t,Di=t=>Reflect.getPrototypeOf(t);function js(t,e,n=!1,s=!1){t=t.__v_raw;const i=V(t),r=V(e);e!==r&&!n&&De(i,"get",e),!n&&De(i,"get",r);const{has:o}=Di(i),a=s?Io:n?So:vs;if(o.call(i,e))return a(t.get(e));if(o.call(i,r))return a(t.get(r));t!==i&&t.get(e)}function qs(t,e=!1){const n=this.__v_raw,s=V(n),i=V(t);return t!==i&&!e&&De(s,"has",t),!e&&De(s,"has",i),t===i?n.has(t):n.has(t)||n.has(i)}function zs(t,e=!1){return t=t.__v_raw,!e&&De(V(t),"iterate",Yt),Reflect.get(t,"size",t)}function za(t){t=V(t);const e=V(this);return Di(e).has.call(e,t)||(e.add(t),pt(e,"add",t,t)),this}function Ka(t,e){e=V(e);const n=V(this),{has:s,get:i}=Di(n);let r=s.call(n,t);r||(t=V(t),r=s.call(n,t));const o=i.call(n,t);return n.set(t,e),r?ms(e,o)&&pt(n,"set",t,e):pt(n,"add",t,e),this}function Ga(t){const e=V(this),{has:n,get:s}=Di(e);let i=n.call(e,t);i||(t=V(t),i=n.call(e,t)),s&&s.call(e,t);const r=e.delete(t);return i&&pt(e,"delete",t,void 0),r}function Ya(){const t=V(this),e=t.size!==0,n=t.clear();return e&&pt(t,"clear",void 0,void 0),n}function Ks(t,e){return function(s,i){const r=this,o=r.__v_raw,a=V(o),l=e?Io:t?So:vs;return!t&&De(a,"iterate",Yt),o.forEach((c,u)=>s.call(i,l(c),l(u),r))}}function Gs(t,e,n){return function(...s){const i=this.__v_raw,r=V(i),o=Sn(r),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=i[t](...s),u=n?Io:e?So:vs;return!e&&De(r,"iterate",l?xr:Yt),{next(){const{value:h,done:f}=c.next();return f?{value:h,done:f}:{value:a?[u(h[0]),u(h[1])]:u(h),done:f}},[Symbol.iterator](){return this}}}}function Et(t){return function(...e){return t==="delete"?!1:this}}function hf(){const t={get(r){return js(this,r)},get size(){return zs(this)},has:qs,add:za,set:Ka,delete:Ga,clear:Ya,forEach:Ks(!1,!1)},e={get(r){return js(this,r,!1,!0)},get size(){return zs(this)},has:qs,add:za,set:Ka,delete:Ga,clear:Ya,forEach:Ks(!1,!0)},n={get(r){return js(this,r,!0)},get size(){return zs(this,!0)},has(r){return qs.call(this,r,!0)},add:Et("add"),set:Et("set"),delete:Et("delete"),clear:Et("clear"),forEach:Ks(!0,!1)},s={get(r){return js(this,r,!0,!0)},get size(){return zs(this,!0)},has(r){return qs.call(this,r,!0)},add:Et("add"),set:Et("set"),delete:Et("delete"),clear:Et("clear"),forEach:Ks(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(r=>{t[r]=Gs(r,!1,!1),n[r]=Gs(r,!0,!1),e[r]=Gs(r,!1,!0),s[r]=Gs(r,!0,!0)}),[t,n,e,s]}const[df,ff,pf,_f]=hf();function wo(t,e){const n=e?t?_f:pf:t?ff:df;return(s,i,r)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?s:Reflect.get(W(n,i)&&i in s?n:s,i,r)}const gf={get:wo(!1,!1)},mf={get:wo(!1,!0)},yf={get:wo(!0,!1)},Lc=new WeakMap,Fc=new WeakMap,Uc=new WeakMap,vf=new WeakMap;function Ef(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function bf(t){return t.__v_skip||!Object.isExtensible(t)?0:Ef(jd(t))}function un(t){return ys(t)?t:To(t,!1,Dc,gf,Lc)}function Cf(t){return To(t,!1,uf,mf,Fc)}function Bc(t){return To(t,!0,cf,yf,Uc)}function To(t,e,n,s,i){if(!ge(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const r=i.get(t);if(r)return r;const o=bf(t);if(o===0)return t;const a=new Proxy(t,o===2?s:n);return i.set(t,a),a}function Rn(t){return ys(t)?Rn(t.__v_raw):!!(t&&t.__v_isReactive)}function ys(t){return!!(t&&t.__v_isReadonly)}function Wc(t){return!!(t&&t.__v_isShallow)}function Hc(t){return Rn(t)||ys(t)}function V(t){const e=t&&t.__v_raw;return e?V(e):t}function $c(t){return ri(t,"__v_skip",!0),t}const vs=t=>ge(t)?un(t):t,So=t=>ge(t)?Bc(t):t;function Vc(t){kt&&Ve&&(t=V(t),Pc(t.dep||(t.dep=Eo())))}function jc(t,e){t=V(t),t.dep&&Pr(t.dep)}function ve(t){return!!(t&&t.__v_isRef===!0)}function qc(t){return If(t,!1)}function If(t,e){return ve(t)?t:new wf(t,e)}class wf{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:V(e),this._value=n?e:vs(e)}get value(){return Vc(this),this._value}set value(e){e=this.__v_isShallow?e:V(e),ms(e,this._rawValue)&&(this._rawValue=e,this._value=this.__v_isShallow?e:vs(e),jc(this))}}function Fe(t){return ve(t)?t.value:t}const Tf={get:(t,e,n)=>Fe(Reflect.get(t,e,n)),set:(t,e,n,s)=>{const i=t[e];return ve(i)&&!ve(n)?(i.value=n,!0):Reflect.set(t,e,n,s)}};function zc(t){return Rn(t)?t:new Proxy(t,Tf)}class Sf{constructor(e,n,s,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this._dirty=!0,this.effect=new bo(e,()=>{this._dirty||(this._dirty=!0,jc(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=s}get value(){const e=V(this);return Vc(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Rf(t,e,n=!1){let s,i;const r=D(t);return r?(s=t,i=Ke):(s=t.get,i=t.set),new Sf(s,i,r||!i,n)}function At(t,e,n,s){let i;try{i=s?t(...s):t()}catch(r){Li(r,e,n)}return i}function Be(t,e,n,s){if(D(t)){const r=At(t,e,n,s);return r&&Tc(r)&&r.catch(o=>{Li(o,e,n)}),r}const i=[];for(let r=0;r<t.length;r++)i.push(Be(t[r],e,n,s));return i}function Li(t,e,n,s=!0){const i=e?e.vnode:null;if(e){let r=e.parent;const o=e.proxy,a=n;for(;r;){const c=r.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}r=r.parent}const l=e.appContext.config.errorHandler;if(l){At(l,null,10,[t,o,a]);return}}Nf(t,n,i,s)}function Nf(t,e,n,s=!0){console.error(t)}let oi=!1,Or=!1;const Me=[];let lt=0;const ls=[];let os=null,En=0;const cs=[];let Ct=null,bn=0;const Kc=Promise.resolve();let Ro=null,Mr=null;function kf(t){const e=Ro||Kc;return t?e.then(this?t.bind(this):t):e}function Af(t){let e=lt+1,n=Me.length;for(;e<n;){const s=e+n>>>1;Es(Me[s])<t?e=s+1:n=s}return e}function Gc(t){(!Me.length||!Me.includes(t,oi&&t.allowRecurse?lt+1:lt))&&t!==Mr&&(t.id==null?Me.push(t):Me.splice(Af(t.id),0,t),Yc())}function Yc(){!oi&&!Or&&(Or=!0,Ro=Kc.then(Xc))}function xf(t){const e=Me.indexOf(t);e>lt&&Me.splice(e,1)}function Qc(t,e,n,s){M(t)?n.push(...t):(!e||!e.includes(t,t.allowRecurse?s+1:s))&&n.push(t),Yc()}function Pf(t){Qc(t,os,ls,En)}function Of(t){Qc(t,Ct,cs,bn)}function No(t,e=null){if(ls.length){for(Mr=e,os=[...new Set(ls)],ls.length=0,En=0;En<os.length;En++)os[En]();os=null,En=0,Mr=null,No(t,e)}}function Jc(t){if(cs.length){const e=[...new Set(cs)];if(cs.length=0,Ct){Ct.push(...e);return}for(Ct=e,Ct.sort((n,s)=>Es(n)-Es(s)),bn=0;bn<Ct.length;bn++)Ct[bn]();Ct=null,bn=0}}const Es=t=>t.id==null?1/0:t.id;function Xc(t){Or=!1,oi=!0,No(t),Me.sort((n,s)=>Es(n)-Es(s));const e=Ke;try{for(lt=0;lt<Me.length;lt++){const n=Me[lt];n&&n.active!==!1&&At(n,null,14)}}finally{lt=0,Me.length=0,Jc(),oi=!1,Ro=null,(Me.length||ls.length||cs.length)&&Xc(t)}}function Mf(t,e,...n){if(t.isUnmounted)return;const s=t.vnode.props||G;let i=n;const r=e.startsWith("update:"),o=r&&e.slice(7);if(o&&o in s){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:f}=s[u]||G;f?i=n.map(g=>g.trim()):h&&(i=n.map(Nr))}let a,l=s[a=ur(e)]||s[a=ur(On(e))];!l&&r&&(l=s[a=ur(jn(e))]),l&&Be(l,t,6,i);const c=s[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Be(c,t,6,i)}}function Zc(t,e,n=!1){const s=e.emitsCache,i=s.get(t);if(i!==void 0)return i;const r=t.emits;let o={},a=!1;if(!D(t)){const l=c=>{const u=Zc(c,e,!0);u&&(a=!0,Ie(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!r&&!a?(s.set(t,null),null):(M(r)?r.forEach(l=>o[l]=null):Ie(o,r),s.set(t,o),o)}function Fi(t,e){return!t||!Pi(e)?!1:(e=e.slice(2).replace(/Once$/,""),W(t,e[0].toLowerCase()+e.slice(1))||W(t,jn(e))||W(t,e))}let qe=null,Ui=null;function ai(t){const e=qe;return qe=t,Ui=t&&t.type.__scopeId||null,e}function Df(t){Ui=t}function Lf(){Ui=null}function Ff(t,e=qe,n){if(!e||t._n)return t;const s=(...i)=>{s._d&&rl(-1);const r=ai(e),o=t(...i);return ai(r),s._d&&rl(1),o};return s._n=!0,s._c=!0,s._d=!0,s}function hr(t){const{type:e,vnode:n,proxy:s,withProxy:i,props:r,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:h,data:f,setupState:g,ctx:b,inheritAttrs:S}=t;let N,U;const ae=ai(t);try{if(n.shapeFlag&4){const X=i||s;N=tt(u.call(X,X,h,r,g,f,b)),U=l}else{const X=e;N=tt(X.length>1?X(r,{attrs:l,slots:a,emit:c}):X(r,null)),U=e.props?l:Uf(l)}}catch(X){us.length=0,Li(X,t,1),N=Ye(Ge)}let J=N;if(U&&S!==!1){const X=Object.keys(U),{shapeFlag:Ce}=J;X.length&&Ce&7&&(o&&X.some(go)&&(U=Bf(U,o)),J=en(J,U))}return n.dirs&&(J.dirs=J.dirs?J.dirs.concat(n.dirs):n.dirs),n.transition&&(J.transition=n.transition),N=J,ai(ae),N}const Uf=t=>{let e;for(const n in t)(n==="class"||n==="style"||Pi(n))&&((e||(e={}))[n]=t[n]);return e},Bf=(t,e)=>{const n={};for(const s in t)(!go(s)||!(s.slice(9)in e))&&(n[s]=t[s]);return n};function Wf(t,e,n){const{props:s,children:i,component:r}=t,{props:o,children:a,patchFlag:l}=e,c=r.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return s?Qa(s,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const f=u[h];if(o[f]!==s[f]&&!Fi(c,f))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Qa(s,o,c):!0:!!o;return!1}function Qa(t,e,n){const s=Object.keys(e);if(s.length!==Object.keys(t).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(e[r]!==t[r]&&!Fi(n,r))return!0}return!1}function Hf({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const $f=t=>t.__isSuspense;function Vf(t,e){e&&e.pendingBranch?M(t)?e.effects.push(...t):e.effects.push(t):Of(t)}function li(t,e){if(ye){let n=ye.provides;const s=ye.parent&&ye.parent.provides;s===n&&(n=ye.provides=Object.create(s)),n[t]=e}}function dt(t,e,n=!1){const s=ye||qe;if(s){const i=s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&D(e)?e.call(s.proxy):e}}function jf(t,e){return ko(t,null,{flush:"post"})}const Ja={};function dr(t,e,n){return ko(t,e,n)}function ko(t,e,{immediate:n,deep:s,flush:i,onTrack:r,onTrigger:o}=G){const a=ye;let l,c=!1,u=!1;if(ve(t)?(l=()=>t.value,c=Wc(t)):Rn(t)?(l=()=>t,s=!0):M(t)?(u=!0,c=t.some(Rn),l=()=>t.map(U=>{if(ve(U))return U.value;if(Rn(U))return Kt(U);if(D(U))return At(U,a,2)})):D(t)?e?l=()=>At(t,a,2):l=()=>{if(!(a&&a.isUnmounted))return h&&h(),Be(t,a,3,[f])}:l=Ke,e&&s){const U=l;l=()=>Kt(U())}let h,f=U=>{h=N.onStop=()=>{At(U,a,4)}};if(Cs)return f=Ke,e?n&&Be(e,a,3,[l(),u?[]:void 0,f]):l(),Ke;let g=u?[]:Ja;const b=()=>{if(!!N.active)if(e){const U=N.run();(s||c||(u?U.some((ae,J)=>ms(ae,g[J])):ms(U,g)))&&(h&&h(),Be(e,a,3,[U,g===Ja?void 0:g,f]),g=U)}else N.run()};b.allowRecurse=!!e;let S;i==="sync"?S=b:i==="post"?S=()=>Ne(b,a&&a.suspense):S=()=>{!a||a.isMounted?Pf(b):b()};const N=new bo(l,S);return e?n?b():g=N.run():i==="post"?Ne(N.run.bind(N),a&&a.suspense):N.run(),()=>{N.stop(),a&&a.scope&&mo(a.scope.effects,N)}}function qf(t,e,n){const s=this.proxy,i=_e(t)?t.includes(".")?eu(s,t):()=>s[t]:t.bind(s,s);let r;D(e)?r=e:(r=e.handler,n=e);const o=ye;Mn(this);const a=ko(i,r.bind(s),n);return o?Mn(o):Jt(),a}function eu(t,e){const n=e.split(".");return()=>{let s=t;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}function Kt(t,e){if(!ge(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),ve(t))Kt(t.value,e);else if(M(t))for(let n=0;n<t.length;n++)Kt(t[n],e);else if(wc(t)||Sn(t))t.forEach(n=>{Kt(n,e)});else if(Rc(t))for(const n in t)Kt(t[n],e);return t}function zf(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ao(()=>{t.isMounted=!0}),iu(()=>{t.isUnmounting=!0}),t}const Le=[Function,Array],Kf={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Le,onEnter:Le,onAfterEnter:Le,onEnterCancelled:Le,onBeforeLeave:Le,onLeave:Le,onAfterLeave:Le,onLeaveCancelled:Le,onBeforeAppear:Le,onAppear:Le,onAfterAppear:Le,onAppearCancelled:Le},setup(t,{slots:e}){const n=yu(),s=zf();let i;return()=>{const r=e.default&&nu(e.default(),!0);if(!r||!r.length)return;let o=r[0];if(r.length>1){for(const S of r)if(S.type!==Ge){o=S;break}}const a=V(t),{mode:l}=a;if(s.isLeaving)return fr(o);const c=Xa(o);if(!c)return fr(o);const u=Dr(c,a,s,n);Lr(c,u);const h=n.subTree,f=h&&Xa(h);let g=!1;const{getTransitionKey:b}=c.type;if(b){const S=b();i===void 0?i=S:S!==i&&(i=S,g=!0)}if(f&&f.type!==Ge&&(!qt(c,f)||g)){const S=Dr(f,a,s,n);if(Lr(f,S),l==="out-in")return s.isLeaving=!0,S.afterLeave=()=>{s.isLeaving=!1,n.update()},fr(o);l==="in-out"&&c.type!==Ge&&(S.delayLeave=(N,U,ae)=>{const J=tu(s,f);J[String(f.key)]=f,N._leaveCb=()=>{U(),N._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=ae})}return o}}},Gf=Kf;function tu(t,e){const{leavingVNodes:n}=t;let s=n.get(e.type);return s||(s=Object.create(null),n.set(e.type,s)),s}function Dr(t,e,n,s){const{appear:i,mode:r,persisted:o=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:h,onLeave:f,onAfterLeave:g,onLeaveCancelled:b,onBeforeAppear:S,onAppear:N,onAfterAppear:U,onAppearCancelled:ae}=e,J=String(t.key),X=tu(n,t),Ce=(j,le)=>{j&&Be(j,s,9,le)},We={mode:r,persisted:o,beforeEnter(j){let le=a;if(!n.isMounted)if(i)le=S||a;else return;j._leaveCb&&j._leaveCb(!0);const se=X[J];se&&qt(t,se)&&se.el._leaveCb&&se.el._leaveCb(),Ce(le,[j])},enter(j){let le=l,se=c,xe=u;if(!n.isMounted)if(i)le=N||l,se=U||c,xe=ae||u;else return;let Pe=!1;const He=j._enterCb=_n=>{Pe||(Pe=!0,_n?Ce(xe,[j]):Ce(se,[j]),We.delayedLeave&&We.delayedLeave(),j._enterCb=void 0)};le?(le(j,He),le.length<=1&&He()):He()},leave(j,le){const se=String(t.key);if(j._enterCb&&j._enterCb(!0),n.isUnmounting)return le();Ce(h,[j]);let xe=!1;const Pe=j._leaveCb=He=>{xe||(xe=!0,le(),He?Ce(b,[j]):Ce(g,[j]),j._leaveCb=void 0,X[se]===t&&delete X[se])};X[se]=t,f?(f(j,Pe),f.length<=1&&Pe()):Pe()},clone(j){return Dr(j,e,n,s)}};return We}function fr(t){if(Bi(t))return t=en(t),t.children=null,t}function Xa(t){return Bi(t)?t.children?t.children[0]:void 0:t}function Lr(t,e){t.shapeFlag&6&&t.component?Lr(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function nu(t,e=!1,n){let s=[],i=0;for(let r=0;r<t.length;r++){let o=t[r];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:r);o.type===de?(o.patchFlag&128&&i++,s=s.concat(nu(o.children,e,a))):(e||o.type!==Ge)&&s.push(a!=null?en(o,{key:a}):o)}if(i>1)for(let r=0;r<s.length;r++)s[r].patchFlag=-2;return s}function Ut(t){return D(t)?{setup:t,name:t.name}:t}const Fr=t=>!!t.type.__asyncLoader,Bi=t=>t.type.__isKeepAlive;function Yf(t,e){su(t,"a",e)}function Qf(t,e){su(t,"da",e)}function su(t,e,n=ye){const s=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(Wi(e,s,n),n){let i=n.parent;for(;i&&i.parent;)Bi(i.parent.vnode)&&Jf(s,e,n,i),i=i.parent}}function Jf(t,e,n,s){const i=Wi(e,t,s,!0);xo(()=>{mo(s[e],i)},n)}function Wi(t,e,n=ye,s=!1){if(n){const i=n[t]||(n[t]=[]),r=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;qn(),Mn(n);const a=Be(e,n,t,o);return Jt(),zn(),a});return s?i.unshift(r):i.push(r),r}}const mt=t=>(e,n=ye)=>(!Cs||t==="sp")&&Wi(t,e,n),Xf=mt("bm"),Ao=mt("m"),Zf=mt("bu"),ep=mt("u"),iu=mt("bum"),xo=mt("um"),tp=mt("sp"),np=mt("rtg"),sp=mt("rtc");function ip(t,e=ye){Wi("ec",t,e)}let Ur=!0;function rp(t){const e=ou(t),n=t.proxy,s=t.ctx;Ur=!1,e.beforeCreate&&Za(e.beforeCreate,t,"bc");const{data:i,computed:r,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:h,mounted:f,beforeUpdate:g,updated:b,activated:S,deactivated:N,beforeDestroy:U,beforeUnmount:ae,destroyed:J,unmounted:X,render:Ce,renderTracked:We,renderTriggered:j,errorCaptured:le,serverPrefetch:se,expose:xe,inheritAttrs:Pe,components:He,directives:_n,filters:Oa}=e;if(c&&op(c,s,null,t.appContext.config.unwrapInjectedRef),o)for(const ie in o){const Z=o[ie];D(Z)&&(s[ie]=Z.bind(n))}if(i){const ie=i.call(n,n);ge(ie)&&(t.data=un(ie))}if(Ur=!0,r)for(const ie in r){const Z=r[ie],ot=D(Z)?Z.bind(n,n):D(Z.get)?Z.get.bind(n,n):Ke,ar=!D(Z)&&D(Z.set)?Z.set.bind(n):Ke,Zn=bu({get:ot,set:ar});Object.defineProperty(s,ie,{enumerable:!0,configurable:!0,get:()=>Zn.value,set:gn=>Zn.value=gn})}if(a)for(const ie in a)ru(a[ie],s,n,ie);if(l){const ie=D(l)?l.call(n):l;Reflect.ownKeys(ie).forEach(Z=>{li(Z,ie[Z])})}u&&Za(u,t,"c");function Re(ie,Z){M(Z)?Z.forEach(ot=>ie(ot.bind(n))):Z&&ie(Z.bind(n))}if(Re(Xf,h),Re(Ao,f),Re(Zf,g),Re(ep,b),Re(Yf,S),Re(Qf,N),Re(ip,le),Re(sp,We),Re(np,j),Re(iu,ae),Re(xo,X),Re(tp,se),M(xe))if(xe.length){const ie=t.exposed||(t.exposed={});xe.forEach(Z=>{Object.defineProperty(ie,Z,{get:()=>n[Z],set:ot=>n[Z]=ot})})}else t.exposed||(t.exposed={});Ce&&t.render===Ke&&(t.render=Ce),Pe!=null&&(t.inheritAttrs=Pe),He&&(t.components=He),_n&&(t.directives=_n)}function op(t,e,n=Ke,s=!1){M(t)&&(t=Br(t));for(const i in t){const r=t[i];let o;ge(r)?"default"in r?o=dt(r.from||i,r.default,!0):o=dt(r.from||i):o=dt(r),ve(o)&&s?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:a=>o.value=a}):e[i]=o}}function Za(t,e,n){Be(M(t)?t.map(s=>s.bind(e.proxy)):t.bind(e.proxy),e,n)}function ru(t,e,n,s){const i=s.includes(".")?eu(n,s):()=>n[s];if(_e(t)){const r=e[t];D(r)&&dr(i,r)}else if(D(t))dr(i,t.bind(n));else if(ge(t))if(M(t))t.forEach(r=>ru(r,e,n,s));else{const r=D(t.handler)?t.handler.bind(n):e[t.handler];D(r)&&dr(i,r,t)}}function ou(t){const e=t.type,{mixins:n,extends:s}=e,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=t.appContext,a=r.get(e);let l;return a?l=a:!i.length&&!n&&!s?l=e:(l={},i.length&&i.forEach(c=>ci(l,c,o,!0)),ci(l,e,o)),r.set(e,l),l}function ci(t,e,n,s=!1){const{mixins:i,extends:r}=e;r&&ci(t,r,n,!0),i&&i.forEach(o=>ci(t,o,n,!0));for(const o in e)if(!(s&&o==="expose")){const a=ap[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const ap={data:el,props:$t,emits:$t,methods:$t,computed:$t,beforeCreate:Te,created:Te,beforeMount:Te,mounted:Te,beforeUpdate:Te,updated:Te,beforeDestroy:Te,beforeUnmount:Te,destroyed:Te,unmounted:Te,activated:Te,deactivated:Te,errorCaptured:Te,serverPrefetch:Te,components:$t,directives:$t,watch:cp,provide:el,inject:lp};function el(t,e){return e?t?function(){return Ie(D(t)?t.call(this,this):t,D(e)?e.call(this,this):e)}:e:t}function lp(t,e){return $t(Br(t),Br(e))}function Br(t){if(M(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function Te(t,e){return t?[...new Set([].concat(t,e))]:e}function $t(t,e){return t?Ie(Ie(Object.create(null),t),e):e}function cp(t,e){if(!t)return e;if(!e)return t;const n=Ie(Object.create(null),t);for(const s in e)n[s]=Te(t[s],e[s]);return n}function up(t,e,n,s=!1){const i={},r={};ri(r,Hi,1),t.propsDefaults=Object.create(null),au(t,e,i,r);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=s?i:Cf(i):t.type.props?t.props=i:t.props=r,t.attrs=r}function hp(t,e,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=t,a=V(i),[l]=t.propsOptions;let c=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let f=u[h];if(Fi(t.emitsOptions,f))continue;const g=e[f];if(l)if(W(r,f))g!==r[f]&&(r[f]=g,c=!0);else{const b=On(f);i[b]=Wr(l,a,b,g,t,!1)}else g!==r[f]&&(r[f]=g,c=!0)}}}else{au(t,e,i,r)&&(c=!0);let u;for(const h in a)(!e||!W(e,h)&&((u=jn(h))===h||!W(e,u)))&&(l?n&&(n[h]!==void 0||n[u]!==void 0)&&(i[h]=Wr(l,a,h,void 0,t,!0)):delete i[h]);if(r!==a)for(const h in r)(!e||!W(e,h)&&!0)&&(delete r[h],c=!0)}c&&pt(t,"set","$attrs")}function au(t,e,n,s){const[i,r]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Xs(l))continue;const c=e[l];let u;i&&W(i,u=On(l))?!r||!r.includes(u)?n[u]=c:(a||(a={}))[u]=c:Fi(t.emitsOptions,l)||(!(l in s)||c!==s[l])&&(s[l]=c,o=!0)}if(r){const l=V(n),c=a||G;for(let u=0;u<r.length;u++){const h=r[u];n[h]=Wr(i,l,h,c[h],t,!W(c,h))}}return o}function Wr(t,e,n,s,i,r){const o=t[n];if(o!=null){const a=W(o,"default");if(a&&s===void 0){const l=o.default;if(o.type!==Function&&D(l)){const{propsDefaults:c}=i;n in c?s=c[n]:(Mn(i),s=c[n]=l.call(null,e),Jt())}else s=l}o[0]&&(r&&!a?s=!1:o[1]&&(s===""||s===jn(n))&&(s=!0))}return s}function lu(t,e,n=!1){const s=e.propsCache,i=s.get(t);if(i)return i;const r=t.props,o={},a=[];let l=!1;if(!D(t)){const u=h=>{l=!0;const[f,g]=lu(h,e,!0);Ie(o,f),g&&a.push(...g)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!r&&!l)return s.set(t,Tn),Tn;if(M(r))for(let u=0;u<r.length;u++){const h=On(r[u]);tl(h)&&(o[h]=G)}else if(r)for(const u in r){const h=On(u);if(tl(h)){const f=r[u],g=o[h]=M(f)||D(f)?{type:f}:f;if(g){const b=il(Boolean,g.type),S=il(String,g.type);g[0]=b>-1,g[1]=S<0||b<S,(b>-1||W(g,"default"))&&a.push(h)}}}const c=[o,a];return s.set(t,c),c}function tl(t){return t[0]!=="$"}function nl(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function sl(t,e){return nl(t)===nl(e)}function il(t,e){return M(e)?e.findIndex(n=>sl(n,t)):D(e)&&sl(e,t)?0:-1}const cu=t=>t[0]==="_"||t==="$stable",Po=t=>M(t)?t.map(tt):[tt(t)],dp=(t,e,n)=>{const s=Ff((...i)=>Po(e(...i)),n);return s._c=!1,s},uu=(t,e,n)=>{const s=t._ctx;for(const i in t){if(cu(i))continue;const r=t[i];if(D(r))e[i]=dp(i,r,s);else if(r!=null){const o=Po(r);e[i]=()=>o}}},hu=(t,e)=>{const n=Po(e);t.slots.default=()=>n},fp=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=V(e),ri(e,"_",n)):uu(e,t.slots={})}else t.slots={},e&&hu(t,e);ri(t.slots,Hi,1)},pp=(t,e,n)=>{const{vnode:s,slots:i}=t;let r=!0,o=G;if(s.shapeFlag&32){const a=e._;a?n&&a===1?r=!1:(Ie(i,e),!n&&a===1&&delete i._):(r=!e.$stable,uu(e,i)),o=e}else e&&(hu(t,e),o={default:1});if(r)for(const a in i)!cu(a)&&!(a in o)&&delete i[a]};function du(t,e){const n=qe;if(n===null)return t;const s=$i(n)||n.proxy,i=t.dirs||(t.dirs=[]);for(let r=0;r<e.length;r++){let[o,a,l,c=G]=e[r];D(o)&&(o={mounted:o,updated:o}),o.deep&&Kt(a),i.push({dir:o,instance:s,value:a,oldValue:void 0,arg:l,modifiers:c})}return t}function Wt(t,e,n,s){const i=t.dirs,r=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let l=a.dir[s];l&&(qn(),Be(l,n,8,[t.el,a,t,e]),zn())}}function fu(){return{app:null,config:{isNativeTag:Hd,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let _p=0;function gp(t,e){return function(s,i=null){D(s)||(s=Object.assign({},s)),i!=null&&!ge(i)&&(i=null);const r=fu(),o=new Set;let a=!1;const l=r.app={_uid:_p++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:Lp,get config(){return r.config},set config(c){},use(c,...u){return o.has(c)||(c&&D(c.install)?(o.add(c),c.install(l,...u)):D(c)&&(o.add(c),c(l,...u))),l},mixin(c){return r.mixins.includes(c)||r.mixins.push(c),l},component(c,u){return u?(r.components[c]=u,l):r.components[c]},directive(c,u){return u?(r.directives[c]=u,l):r.directives[c]},mount(c,u,h){if(!a){const f=Ye(s,i);return f.appContext=r,u&&e?e(f,c):t(f,c,h),a=!0,l._container=c,c.__vue_app__=l,$i(f.component)||f.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return r.provides[c]=u,l}};return l}}function Hr(t,e,n,s,i=!1){if(M(t)){t.forEach((f,g)=>Hr(f,e&&(M(e)?e[g]:e),n,s,i));return}if(Fr(s)&&!i)return;const r=s.shapeFlag&4?$i(s.component)||s.component.proxy:s.el,o=i?null:r,{i:a,r:l}=t,c=e&&e.r,u=a.refs===G?a.refs={}:a.refs,h=a.setupState;if(c!=null&&c!==l&&(_e(c)?(u[c]=null,W(h,c)&&(h[c]=null)):ve(c)&&(c.value=null)),D(l))At(l,a,12,[o,u]);else{const f=_e(l),g=ve(l);if(f||g){const b=()=>{if(t.f){const S=f?u[l]:l.value;i?M(S)&&mo(S,r):M(S)?S.includes(r)||S.push(r):f?(u[l]=[r],W(h,l)&&(h[l]=u[l])):(l.value=[r],t.k&&(u[t.k]=l.value))}else f?(u[l]=o,W(h,l)&&(h[l]=o)):ve(l)&&(l.value=o,t.k&&(u[t.k]=o))};o?(b.id=-1,Ne(b,n)):b()}}}const Ne=Vf;function mp(t){return yp(t)}function yp(t,e){const n=Kd();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:h,nextSibling:f,setScopeId:g=Ke,cloneNode:b,insertStaticContent:S}=t,N=(d,p,_,y=null,m=null,I=null,T=!1,C=null,w=!!p.dynamicChildren)=>{if(d===p)return;d&&!qt(d,p)&&(y=Vs(d),vt(d,m,I,!0),d=null),p.patchFlag===-2&&(w=!1,p.dynamicChildren=null);const{type:v,ref:k,shapeFlag:R}=p;switch(v){case Oo:U(d,p,_,y);break;case Ge:ae(d,p,_,y);break;case ei:d==null&&J(p,_,y,T);break;case de:_n(d,p,_,y,m,I,T,C,w);break;default:R&1?We(d,p,_,y,m,I,T,C,w):R&6?Oa(d,p,_,y,m,I,T,C,w):(R&64||R&128)&&v.process(d,p,_,y,m,I,T,C,w,mn)}k!=null&&m&&Hr(k,d&&d.ref,I,p||d,!p)},U=(d,p,_,y)=>{if(d==null)s(p.el=a(p.children),_,y);else{const m=p.el=d.el;p.children!==d.children&&c(m,p.children)}},ae=(d,p,_,y)=>{d==null?s(p.el=l(p.children||""),_,y):p.el=d.el},J=(d,p,_,y)=>{[d.el,d.anchor]=S(d.children,p,_,y,d.el,d.anchor)},X=({el:d,anchor:p},_,y)=>{let m;for(;d&&d!==p;)m=f(d),s(d,_,y),d=m;s(p,_,y)},Ce=({el:d,anchor:p})=>{let _;for(;d&&d!==p;)_=f(d),i(d),d=_;i(p)},We=(d,p,_,y,m,I,T,C,w)=>{T=T||p.type==="svg",d==null?j(p,_,y,m,I,T,C,w):xe(d,p,m,I,T,C,w)},j=(d,p,_,y,m,I,T,C)=>{let w,v;const{type:k,props:R,shapeFlag:A,transition:P,patchFlag:H,dirs:ne}=d;if(d.el&&b!==void 0&&H===-1)w=d.el=b(d.el);else{if(w=d.el=o(d.type,I,R&&R.is,R),A&8?u(w,d.children):A&16&&se(d.children,w,null,y,m,I&&k!=="foreignObject",T,C),ne&&Wt(d,null,y,"created"),R){for(const ee in R)ee!=="value"&&!Xs(ee)&&r(w,ee,null,R[ee],I,d.children,y,m,at);"value"in R&&r(w,"value",null,R.value),(v=R.onVnodeBeforeMount)&&Ze(v,y,d)}le(w,d,d.scopeId,T,y)}ne&&Wt(d,null,y,"beforeMount");const z=(!m||m&&!m.pendingBranch)&&P&&!P.persisted;z&&P.beforeEnter(w),s(w,p,_),((v=R&&R.onVnodeMounted)||z||ne)&&Ne(()=>{v&&Ze(v,y,d),z&&P.enter(w),ne&&Wt(d,null,y,"mounted")},m)},le=(d,p,_,y,m)=>{if(_&&g(d,_),y)for(let I=0;I<y.length;I++)g(d,y[I]);if(m){let I=m.subTree;if(p===I){const T=m.vnode;le(d,T,T.scopeId,T.slotScopeIds,m.parent)}}},se=(d,p,_,y,m,I,T,C,w=0)=>{for(let v=w;v<d.length;v++){const k=d[v]=C?It(d[v]):tt(d[v]);N(null,k,p,_,y,m,I,T,C)}},xe=(d,p,_,y,m,I,T)=>{const C=p.el=d.el;let{patchFlag:w,dynamicChildren:v,dirs:k}=p;w|=d.patchFlag&16;const R=d.props||G,A=p.props||G;let P;_&&Ht(_,!1),(P=A.onVnodeBeforeUpdate)&&Ze(P,_,p,d),k&&Wt(p,d,_,"beforeUpdate"),_&&Ht(_,!0);const H=m&&p.type!=="foreignObject";if(v?Pe(d.dynamicChildren,v,C,_,y,H,I):T||ot(d,p,C,null,_,y,H,I,!1),w>0){if(w&16)He(C,p,R,A,_,y,m);else if(w&2&&R.class!==A.class&&r(C,"class",null,A.class,m),w&4&&r(C,"style",R.style,A.style,m),w&8){const ne=p.dynamicProps;for(let z=0;z<ne.length;z++){const ee=ne[z],$e=R[ee],yn=A[ee];(yn!==$e||ee==="value")&&r(C,ee,$e,yn,m,d.children,_,y,at)}}w&1&&d.children!==p.children&&u(C,p.children)}else!T&&v==null&&He(C,p,R,A,_,y,m);((P=A.onVnodeUpdated)||k)&&Ne(()=>{P&&Ze(P,_,p,d),k&&Wt(p,d,_,"updated")},y)},Pe=(d,p,_,y,m,I,T)=>{for(let C=0;C<p.length;C++){const w=d[C],v=p[C],k=w.el&&(w.type===de||!qt(w,v)||w.shapeFlag&70)?h(w.el):_;N(w,v,k,null,y,m,I,T,!0)}},He=(d,p,_,y,m,I,T)=>{if(_!==y){for(const C in y){if(Xs(C))continue;const w=y[C],v=_[C];w!==v&&C!=="value"&&r(d,C,v,w,T,p.children,m,I,at)}if(_!==G)for(const C in _)!Xs(C)&&!(C in y)&&r(d,C,_[C],null,T,p.children,m,I,at);"value"in y&&r(d,"value",_.value,y.value)}},_n=(d,p,_,y,m,I,T,C,w)=>{const v=p.el=d?d.el:a(""),k=p.anchor=d?d.anchor:a("");let{patchFlag:R,dynamicChildren:A,slotScopeIds:P}=p;P&&(C=C?C.concat(P):P),d==null?(s(v,_,y),s(k,_,y),se(p.children,_,k,m,I,T,C,w)):R>0&&R&64&&A&&d.dynamicChildren?(Pe(d.dynamicChildren,A,_,m,I,T,C),(p.key!=null||m&&p===m.subTree)&&pu(d,p,!0)):ot(d,p,_,k,m,I,T,C,w)},Oa=(d,p,_,y,m,I,T,C,w)=>{p.slotScopeIds=C,d==null?p.shapeFlag&512?m.ctx.activate(p,_,y,T,w):or(p,_,y,m,I,T,w):Re(d,p,w)},or=(d,p,_,y,m,I,T)=>{const C=d.component=Ap(d,y,m);if(Bi(d)&&(C.ctx.renderer=mn),xp(C),C.asyncDep){if(m&&m.registerDep(C,ie),!d.el){const w=C.subTree=Ye(Ge);ae(null,w,p,_)}return}ie(C,d,p,_,m,I,T)},Re=(d,p,_)=>{const y=p.component=d.component;if(Wf(d,p,_))if(y.asyncDep&&!y.asyncResolved){Z(y,p,_);return}else y.next=p,xf(y.update),y.update();else p.component=d.component,p.el=d.el,y.vnode=p},ie=(d,p,_,y,m,I,T)=>{const C=()=>{if(d.isMounted){let{next:k,bu:R,u:A,parent:P,vnode:H}=d,ne=k,z;Ht(d,!1),k?(k.el=H.el,Z(d,k,T)):k=H,R&&Zs(R),(z=k.props&&k.props.onVnodeBeforeUpdate)&&Ze(z,P,k,H),Ht(d,!0);const ee=hr(d),$e=d.subTree;d.subTree=ee,N($e,ee,h($e.el),Vs($e),d,m,I),k.el=ee.el,ne===null&&Hf(d,ee.el),A&&Ne(A,m),(z=k.props&&k.props.onVnodeUpdated)&&Ne(()=>Ze(z,P,k,H),m)}else{let k;const{el:R,props:A}=p,{bm:P,m:H,parent:ne}=d,z=Fr(p);if(Ht(d,!1),P&&Zs(P),!z&&(k=A&&A.onVnodeBeforeMount)&&Ze(k,ne,p),Ht(d,!0),R&&cr){const ee=()=>{d.subTree=hr(d),cr(R,d.subTree,d,m,null)};z?p.type.__asyncLoader().then(()=>!d.isUnmounted&&ee()):ee()}else{const ee=d.subTree=hr(d);N(null,ee,_,y,d,m,I),p.el=ee.el}if(H&&Ne(H,m),!z&&(k=A&&A.onVnodeMounted)){const ee=p;Ne(()=>Ze(k,ne,ee),m)}p.shapeFlag&256&&d.a&&Ne(d.a,m),d.isMounted=!0,p=_=y=null}},w=d.effect=new bo(C,()=>Gc(d.update),d.scope),v=d.update=w.run.bind(w);v.id=d.uid,Ht(d,!0),v()},Z=(d,p,_)=>{p.component=d;const y=d.vnode.props;d.vnode=p,d.next=null,hp(d,p.props,y,_),pp(d,p.children,_),qn(),No(void 0,d.update),zn()},ot=(d,p,_,y,m,I,T,C,w=!1)=>{const v=d&&d.children,k=d?d.shapeFlag:0,R=p.children,{patchFlag:A,shapeFlag:P}=p;if(A>0){if(A&128){Zn(v,R,_,y,m,I,T,C,w);return}else if(A&256){ar(v,R,_,y,m,I,T,C,w);return}}P&8?(k&16&&at(v,m,I),R!==v&&u(_,R)):k&16?P&16?Zn(v,R,_,y,m,I,T,C,w):at(v,m,I,!0):(k&8&&u(_,""),P&16&&se(R,_,y,m,I,T,C,w))},ar=(d,p,_,y,m,I,T,C,w)=>{d=d||Tn,p=p||Tn;const v=d.length,k=p.length,R=Math.min(v,k);let A;for(A=0;A<R;A++){const P=p[A]=w?It(p[A]):tt(p[A]);N(d[A],P,_,null,m,I,T,C,w)}v>k?at(d,m,I,!0,!1,R):se(p,_,y,m,I,T,C,w,R)},Zn=(d,p,_,y,m,I,T,C,w)=>{let v=0;const k=p.length;let R=d.length-1,A=k-1;for(;v<=R&&v<=A;){const P=d[v],H=p[v]=w?It(p[v]):tt(p[v]);if(qt(P,H))N(P,H,_,null,m,I,T,C,w);else break;v++}for(;v<=R&&v<=A;){const P=d[R],H=p[A]=w?It(p[A]):tt(p[A]);if(qt(P,H))N(P,H,_,null,m,I,T,C,w);else break;R--,A--}if(v>R){if(v<=A){const P=A+1,H=P<k?p[P].el:y;for(;v<=A;)N(null,p[v]=w?It(p[v]):tt(p[v]),_,H,m,I,T,C,w),v++}}else if(v>A)for(;v<=R;)vt(d[v],m,I,!0),v++;else{const P=v,H=v,ne=new Map;for(v=H;v<=A;v++){const Oe=p[v]=w?It(p[v]):tt(p[v]);Oe.key!=null&&ne.set(Oe.key,v)}let z,ee=0;const $e=A-H+1;let yn=!1,La=0;const es=new Array($e);for(v=0;v<$e;v++)es[v]=0;for(v=P;v<=R;v++){const Oe=d[v];if(ee>=$e){vt(Oe,m,I,!0);continue}let Xe;if(Oe.key!=null)Xe=ne.get(Oe.key);else for(z=H;z<=A;z++)if(es[z-H]===0&&qt(Oe,p[z])){Xe=z;break}Xe===void 0?vt(Oe,m,I,!0):(es[Xe-H]=v+1,Xe>=La?La=Xe:yn=!0,N(Oe,p[Xe],_,null,m,I,T,C,w),ee++)}const Fa=yn?vp(es):Tn;for(z=Fa.length-1,v=$e-1;v>=0;v--){const Oe=H+v,Xe=p[Oe],Ua=Oe+1<k?p[Oe+1].el:y;es[v]===0?N(null,Xe,_,Ua,m,I,T,C,w):yn&&(z<0||v!==Fa[z]?gn(Xe,_,Ua,2):z--)}}},gn=(d,p,_,y,m=null)=>{const{el:I,type:T,transition:C,children:w,shapeFlag:v}=d;if(v&6){gn(d.component.subTree,p,_,y);return}if(v&128){d.suspense.move(p,_,y);return}if(v&64){T.move(d,p,_,mn);return}if(T===de){s(I,p,_);for(let R=0;R<w.length;R++)gn(w[R],p,_,y);s(d.anchor,p,_);return}if(T===ei){X(d,p,_);return}if(y!==2&&v&1&&C)if(y===0)C.beforeEnter(I),s(I,p,_),Ne(()=>C.enter(I),m);else{const{leave:R,delayLeave:A,afterLeave:P}=C,H=()=>s(I,p,_),ne=()=>{R(I,()=>{H(),P&&P()})};A?A(I,H,ne):ne()}else s(I,p,_)},vt=(d,p,_,y=!1,m=!1)=>{const{type:I,props:T,ref:C,children:w,dynamicChildren:v,shapeFlag:k,patchFlag:R,dirs:A}=d;if(C!=null&&Hr(C,null,_,d,!0),k&256){p.ctx.deactivate(d);return}const P=k&1&&A,H=!Fr(d);let ne;if(H&&(ne=T&&T.onVnodeBeforeUnmount)&&Ze(ne,p,d),k&6)kd(d.component,_,y);else{if(k&128){d.suspense.unmount(_,y);return}P&&Wt(d,null,p,"beforeUnmount"),k&64?d.type.remove(d,p,_,m,mn,y):v&&(I!==de||R>0&&R&64)?at(v,p,_,!1,!0):(I===de&&R&384||!m&&k&16)&&at(w,p,_),y&&Ma(d)}(H&&(ne=T&&T.onVnodeUnmounted)||P)&&Ne(()=>{ne&&Ze(ne,p,d),P&&Wt(d,null,p,"unmounted")},_)},Ma=d=>{const{type:p,el:_,anchor:y,transition:m}=d;if(p===de){Nd(_,y);return}if(p===ei){Ce(d);return}const I=()=>{i(_),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(d.shapeFlag&1&&m&&!m.persisted){const{leave:T,delayLeave:C}=m,w=()=>T(_,I);C?C(d.el,I,w):w()}else I()},Nd=(d,p)=>{let _;for(;d!==p;)_=f(d),i(d),d=_;i(p)},kd=(d,p,_)=>{const{bum:y,scope:m,update:I,subTree:T,um:C}=d;y&&Zs(y),m.stop(),I&&(I.active=!1,vt(T,d,p,_)),C&&Ne(C,p),Ne(()=>{d.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&d.asyncDep&&!d.asyncResolved&&d.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},at=(d,p,_,y=!1,m=!1,I=0)=>{for(let T=I;T<d.length;T++)vt(d[T],p,_,y,m)},Vs=d=>d.shapeFlag&6?Vs(d.component.subTree):d.shapeFlag&128?d.suspense.next():f(d.anchor||d.el),Da=(d,p,_)=>{d==null?p._vnode&&vt(p._vnode,null,null,!0):N(p._vnode||null,d,p,null,null,null,_),Jc(),p._vnode=d},mn={p:N,um:vt,m:gn,r:Ma,mt:or,mc:se,pc:ot,pbc:Pe,n:Vs,o:t};let lr,cr;return e&&([lr,cr]=e(mn)),{render:Da,hydrate:lr,createApp:gp(Da,lr)}}function Ht({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function pu(t,e,n=!1){const s=t.children,i=e.children;if(M(s)&&M(i))for(let r=0;r<s.length;r++){const o=s[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=It(i[r]),a.el=o.el),n||pu(o,a))}}function vp(t){const e=t.slice(),n=[0];let s,i,r,o,a;const l=t.length;for(s=0;s<l;s++){const c=t[s];if(c!==0){if(i=n[n.length-1],t[i]<c){e[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,t[n[a]]<c?r=a+1:o=a;c<t[n[r]]&&(r>0&&(e[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=e[o];return n}const Ep=t=>t.__isTeleport,bp=Symbol(),de=Symbol(void 0),Oo=Symbol(void 0),Ge=Symbol(void 0),ei=Symbol(void 0),us=[];let Qt=null;function te(t=!1){us.push(Qt=t?null:[])}function Cp(){us.pop(),Qt=us[us.length-1]||null}let ui=1;function rl(t){ui+=t}function _u(t){return t.dynamicChildren=ui>0?Qt||Tn:null,Cp(),ui>0&&Qt&&Qt.push(t),t}function Ee(t,e,n,s,i,r){return _u(ce(t,e,n,s,i,r,!0))}function Mt(t,e,n,s,i){return _u(Ye(t,e,n,s,i,!0))}function Ip(t){return t?t.__v_isVNode===!0:!1}function qt(t,e){return t.type===e.type&&t.key===e.key}const Hi="__vInternal",gu=({key:t})=>t!=null?t:null,ti=({ref:t,ref_key:e,ref_for:n})=>t!=null?_e(t)||ve(t)||D(t)?{i:qe,r:t,k:e,f:!!n}:t:null;function ce(t,e=null,n=null,s=0,i=null,r=t===de?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&gu(e),ref:e&&ti(e),scopeId:Ui,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null};return a?(Mo(l,n),r&128&&t.normalize(l)):n&&(l.shapeFlag|=_e(n)?8:16),ui>0&&!o&&Qt&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&Qt.push(l),l}const Ye=wp;function wp(t,e=null,n=null,s=0,i=null,r=!1){if((!t||t===bp)&&(t=Ge),Ip(t)){const a=en(t,e,!0);return n&&Mo(a,n),a}if(Dp(t)&&(t=t.__vccOpts),e){e=Tp(e);let{class:a,style:l}=e;a&&!_e(a)&&(e.class=Vn(a)),ge(l)&&(Hc(l)&&!M(l)&&(l=Ie({},l)),e.style=xi(l))}const o=_e(t)?1:$f(t)?128:Ep(t)?64:ge(t)?4:D(t)?2:0;return ce(t,e,n,s,i,o,r,!0)}function Tp(t){return t?Hc(t)||Hi in t?Ie({},t):t:null}function en(t,e,n=!1){const{props:s,ref:i,patchFlag:r,children:o}=t,a=e?Sp(s||{},e):s;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&gu(a),ref:e&&e.ref?n&&i?M(i)?i.concat(ti(e)):[i,ti(e)]:ti(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==de?r===-1?16:r|16:r,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&en(t.ssContent),ssFallback:t.ssFallback&&en(t.ssFallback),el:t.el,anchor:t.anchor}}function mu(t=" ",e=0){return Ye(Oo,null,t,e)}function Ys(t="",e=!1){return e?(te(),Mt(Ge,null,t)):Ye(Ge,null,t)}function tt(t){return t==null||typeof t=="boolean"?Ye(Ge):M(t)?Ye(de,null,t.slice()):typeof t=="object"?It(t):Ye(Oo,null,String(t))}function It(t){return t.el===null||t.memo?t:en(t)}function Mo(t,e){let n=0;const{shapeFlag:s}=t;if(e==null)e=null;else if(M(e))n=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),Mo(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(Hi in e)?e._ctx=qe:i===3&&qe&&(qe.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else D(e)?(e={default:e,_ctx:qe},n=32):(e=String(e),s&64?(n=16,e=[mu(e)]):n=8);t.children=e,t.shapeFlag|=n}function Sp(...t){const e={};for(let n=0;n<t.length;n++){const s=t[n];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=Vn([e.class,s.class]));else if(i==="style")e.style=xi([e.style,s.style]);else if(Pi(i)){const r=e[i],o=s[i];o&&r!==o&&!(M(r)&&r.includes(o))&&(e[i]=r?[].concat(r,o):o)}else i!==""&&(e[i]=s[i])}return e}function Ze(t,e,n,s=null){Be(t,e,7,[n,s])}function bs(t,e,n,s){let i;const r=n&&n[s];if(M(t)||_e(t)){i=new Array(t.length);for(let o=0,a=t.length;o<a;o++)i[o]=e(t[o],o,void 0,r&&r[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,r&&r[o])}else if(ge(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,r&&r[a]));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];i[a]=e(t[c],c,a,r&&r[a])}}else i=[];return n&&(n[s]=i),i}const $r=t=>t?vu(t)?$i(t)||t.proxy:$r(t.parent):null,hi=Ie(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>$r(t.parent),$root:t=>$r(t.root),$emit:t=>t.emit,$options:t=>ou(t),$forceUpdate:t=>()=>Gc(t.update),$nextTick:t=>kf.bind(t.proxy),$watch:t=>qf.bind(t)}),Rp={get({_:t},e){const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const g=o[e];if(g!==void 0)switch(g){case 1:return s[e];case 2:return i[e];case 4:return n[e];case 3:return r[e]}else{if(s!==G&&W(s,e))return o[e]=1,s[e];if(i!==G&&W(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&W(c,e))return o[e]=3,r[e];if(n!==G&&W(n,e))return o[e]=4,n[e];Ur&&(o[e]=0)}}const u=hi[e];let h,f;if(u)return e==="$attrs"&&De(t,"get",e),u(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==G&&W(n,e))return o[e]=4,n[e];if(f=l.config.globalProperties,W(f,e))return f[e]},set({_:t},e,n){const{data:s,setupState:i,ctx:r}=t;return i!==G&&W(i,e)?(i[e]=n,!0):s!==G&&W(s,e)?(s[e]=n,!0):W(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(r[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:s,appContext:i,propsOptions:r}},o){let a;return!!n[o]||t!==G&&W(t,o)||e!==G&&W(e,o)||(a=r[0])&&W(a,o)||W(s,o)||W(hi,o)||W(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:W(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}},Np=fu();let kp=0;function Ap(t,e,n){const s=t.type,i=(e?e.appContext:t.appContext)||Np,r={uid:kp++,vnode:t,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new Gd(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:lu(s,i),emitsOptions:Zc(s,i),emit:null,emitted:null,propsDefaults:G,inheritAttrs:s.inheritAttrs,ctx:G,data:G,props:G,attrs:G,slots:G,refs:G,setupState:G,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=e?e.root:r,r.emit=Mf.bind(null,r),t.ce&&t.ce(r),r}let ye=null;const yu=()=>ye||qe,Mn=t=>{ye=t,t.scope.on()},Jt=()=>{ye&&ye.scope.off(),ye=null};function vu(t){return t.vnode.shapeFlag&4}let Cs=!1;function xp(t,e=!1){Cs=e;const{props:n,children:s}=t.vnode,i=vu(t);up(t,n,i,e),fp(t,s);const r=i?Pp(t,e):void 0;return Cs=!1,r}function Pp(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=$c(new Proxy(t.ctx,Rp));const{setup:s}=n;if(s){const i=t.setupContext=s.length>1?Mp(t):null;Mn(t),qn();const r=At(s,t,0,[t.props,i]);if(zn(),Jt(),Tc(r)){if(r.then(Jt,Jt),e)return r.then(o=>{ol(t,o,e)}).catch(o=>{Li(o,t,0)});t.asyncDep=r}else ol(t,r,e)}else Eu(t,e)}function ol(t,e,n){D(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:ge(e)&&(t.setupState=zc(e)),Eu(t,n)}let al;function Eu(t,e,n){const s=t.type;if(!t.render){if(!e&&al&&!s.render){const i=s.template;if(i){const{isCustomElement:r,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=s,c=Ie(Ie({isCustomElement:r,delimiters:a},o),l);s.render=al(i,c)}}t.render=s.render||Ke}Mn(t),qn(),rp(t),zn(),Jt()}function Op(t){return new Proxy(t.attrs,{get(e,n){return De(t,"get","$attrs"),e[n]}})}function Mp(t){const e=s=>{t.exposed=s||{}};let n;return{get attrs(){return n||(n=Op(t))},slots:t.slots,emit:t.emit,expose:e}}function $i(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(zc($c(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in hi)return hi[n](t)}}))}function Dp(t){return D(t)&&"__vccOpts"in t}const bu=(t,e)=>Rf(t,e,Cs),Lp="3.2.33",Fp="http://www.w3.org/2000/svg",zt=typeof document!="undefined"?document:null,ll=zt&&zt.createElement("template"),Up={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,s)=>{const i=e?zt.createElementNS(Fp,t):zt.createElement(t,n?{is:n}:void 0);return t==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:t=>zt.createTextNode(t),createComment:t=>zt.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>zt.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,s,i,r){const o=n?n.previousSibling:e.lastChild;if(i&&(i===r||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{ll.innerHTML=s?`<svg>${t}</svg>`:t;const a=ll.content;if(s){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function Bp(t,e,n){const s=t._vtc;s&&(e=(e?[e,...s]:[...s]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function Wp(t,e,n){const s=t.style,i=_e(n);if(n&&!i){for(const r in n)Vr(s,r,n[r]);if(e&&!_e(e))for(const r in e)n[r]==null&&Vr(s,r,"")}else{const r=s.display;i?e!==n&&(s.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(s.display=r)}}const cl=/\s*!important$/;function Vr(t,e,n){if(M(n))n.forEach(s=>Vr(t,e,s));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const s=Hp(t,e);cl.test(n)?t.setProperty(jn(s),n.replace(cl,""),"important"):t[s]=n}}const ul=["Webkit","Moz","ms"],pr={};function Hp(t,e){const n=pr[e];if(n)return n;let s=On(e);if(s!=="filter"&&s in t)return pr[e]=s;s=Nc(s);for(let i=0;i<ul.length;i++){const r=ul[i]+s;if(r in t)return pr[e]=r}return e}const hl="http://www.w3.org/1999/xlink";function $p(t,e,n,s,i){if(s&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(hl,e.slice(6,e.length)):t.setAttributeNS(hl,e,n);else{const r=Fd(e);n==null||r&&!Cc(n)?t.removeAttribute(e):t.setAttribute(e,r?"":n)}}function Vp(t,e,n,s,i,r,o){if(e==="innerHTML"||e==="textContent"){s&&o(s,i,r),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const l=n==null?"":n;(t.value!==l||t.tagName==="OPTION")&&(t.value=l),n==null&&t.removeAttribute(e);return}let a=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=Cc(n):n==null&&l==="string"?(n="",a=!0):l==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}const[Cu,jp]=(()=>{let t=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(t=()=>performance.now());const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let jr=0;const qp=Promise.resolve(),zp=()=>{jr=0},Kp=()=>jr||(qp.then(zp),jr=Cu());function Cn(t,e,n,s){t.addEventListener(e,n,s)}function Gp(t,e,n,s){t.removeEventListener(e,n,s)}function Yp(t,e,n,s,i=null){const r=t._vei||(t._vei={}),o=r[e];if(s&&o)o.value=s;else{const[a,l]=Qp(e);if(s){const c=r[e]=Jp(s,i);Cn(t,a,c,l)}else o&&(Gp(t,a,o,l),r[e]=void 0)}}const dl=/(?:Once|Passive|Capture)$/;function Qp(t){let e;if(dl.test(t)){e={};let n;for(;n=t.match(dl);)t=t.slice(0,t.length-n[0].length),e[n[0].toLowerCase()]=!0}return[jn(t.slice(2)),e]}function Jp(t,e){const n=s=>{const i=s.timeStamp||Cu();(jp||i>=n.attached-1)&&Be(Xp(s,n.value),e,5,[s])};return n.value=t,n.attached=Kp(),n}function Xp(t,e){if(M(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(s=>i=>!i._stopped&&s&&s(i))}else return e}const fl=/^on[a-z]/,Zp=(t,e,n,s,i=!1,r,o,a,l)=>{e==="class"?Bp(t,s,i):e==="style"?Wp(t,n,s):Pi(e)?go(e)||Yp(t,e,n,s,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):e_(t,e,s,i))?Vp(t,e,s,r,o,a,l):(e==="true-value"?t._trueValue=s:e==="false-value"&&(t._falseValue=s),$p(t,e,s,i))};function e_(t,e,n,s){return s?!!(e==="innerHTML"||e==="textContent"||e in t&&fl.test(e)&&D(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||fl.test(e)&&_e(n)?!1:e in t}function Iu(t){const e=yu();if(!e)return;const n=()=>qr(e.subTree,t(e.proxy));jf(n),Ao(()=>{const s=new MutationObserver(n);s.observe(e.subTree.el.parentNode,{childList:!0}),xo(()=>s.disconnect())})}function qr(t,e){if(t.shapeFlag&128){const n=t.suspense;t=n.activeBranch,n.pendingBranch&&!n.isHydrating&&n.effects.push(()=>{qr(n.activeBranch,e)})}for(;t.component;)t=t.component.subTree;if(t.shapeFlag&1&&t.el)pl(t.el,e);else if(t.type===de)t.children.forEach(n=>qr(n,e));else if(t.type===ei){let{el:n,anchor:s}=t;for(;n&&(pl(n,e),n!==s);)n=n.nextSibling}}function pl(t,e){if(t.nodeType===1){const n=t.style;for(const s in e)n.setProperty(`--${s}`,e[s])}}const t_={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};Gf.props;const _l=t=>{const e=t.props["onUpdate:modelValue"];return M(e)?n=>Zs(e,n):e};function n_(t){t.target.composing=!0}function gl(t){const e=t.target;e.composing&&(e.composing=!1,s_(e,"input"))}function s_(t,e){const n=document.createEvent("HTMLEvents");n.initEvent(e,!0,!0),t.dispatchEvent(n)}const wu={created(t,{modifiers:{lazy:e,trim:n,number:s}},i){t._assign=_l(i);const r=s||i.props&&i.props.type==="number";Cn(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n?a=a.trim():r&&(a=Nr(a)),t._assign(a)}),n&&Cn(t,"change",()=>{t.value=t.value.trim()}),e||(Cn(t,"compositionstart",n_),Cn(t,"compositionend",gl),Cn(t,"change",gl))},mounted(t,{value:e}){t.value=e==null?"":e},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:s,number:i}},r){if(t._assign=_l(r),t.composing||document.activeElement===t&&(n||s&&t.value.trim()===e||(i||t.type==="number")&&Nr(t.value)===e))return;const o=e==null?"":e;t.value!==o&&(t.value=o)}},i_=Ie({patchProp:Zp},Up);let ml;function r_(){return ml||(ml=mp(i_))}const o_=(...t)=>{const e=r_().createApp(...t),{mount:n}=e;return e.mount=s=>{const i=a_(s);if(!i)return;const r=e._component;!D(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function a_(t){return _e(t)?document.querySelector(t):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=function(t,e){if(!t)throw Kn(e)},Kn=function(t){return new Error("Firebase Database ("+Tu.SDK_VERSION+") INTERNAL ASSERT FAILED: "+t)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function c_(t){return ku(void 0,t)}function ku(t,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const n=e;return new Date(n.getTime());case Object:t===void 0&&(t={});break;case Array:t=[];break;default:return e}for(const n in e)!e.hasOwnProperty(n)||!u_(n)||(t[n]=ku(t[n],e[n]));return t}function u_(t){return t!=="__proto__"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function we(){return typeof navigator!="undefined"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Lo(){return typeof window!="undefined"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(we())}function h_(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function Au(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function d_(){const t=we();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function xu(){return Tu.NODE_ADMIN===!0}function f_(){return typeof indexedDB=="object"}function p_(){return new Promise((t,e)=>{try{let n=!0;const s="validate-browser-context-for-indexeddb-analytics-module",i=self.indexedDB.open(s);i.onsuccess=()=>{i.result.close(),n||self.indexedDB.deleteDatabase(s),t(!0)},i.onupgradeneeded=()=>{n=!1},i.onerror=()=>{var r;e(((r=i.error)===null||r===void 0?void 0:r.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const __="FirebaseError";class Gn extends Error{constructor(e,n,s){super(n),this.code=e,this.customData=s,this.name=__,Object.setPrototypeOf(this,Gn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ms.prototype.create)}}class Ms{constructor(e,n,s){this.service=e,this.serviceName=n,this.errors=s}create(e,...n){const s=n[0]||{},i=`${this.service}/${e}`,r=this.errors[e],o=r?g_(r,s):"Error",a=`${this.serviceName}: ${o} (${i}).`;return new Gn(i,a,s)}}function g_(t,e){return t.replace(m_,(n,s)=>{const i=e[s];return i!=null?String(i):`<${s}?>`})}const m_=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pu=function(t){let e={},n={},s={},i="";try{const r=t.split(".");e=Is(zr(r[0])||""),n=Is(zr(r[1])||""),i=r[2],s=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:s,signature:i}},y_=function(t){const e=Pu(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},v_=function(t){const e=Pu(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yn(t){const e=[];for(const[n,s]of Object.entries(t))Array.isArray(s)?s.forEach(i=>{e.push(encodeURIComponent(n)+"="+encodeURIComponent(i))}):e.push(encodeURIComponent(n)+"="+encodeURIComponent(s));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function as(t,e){return new Promise((n,s)=>{t.onsuccess=i=>{n(i.target.result)},t.onerror=i=>{var r;s(`${e}: ${(r=i.target.error)===null||r===void 0?void 0:r.message}`)}})}class vl{constructor(e){this._db=e,this.objectStoreNames=this._db.objectStoreNames}transaction(e,n="readonly"){return new Ou(this._db.transaction.call(this._db,e,n))}createObjectStore(e,n){return new Mu(this._db.createObjectStore(e,n))}close(){this._db.close()}}class Ou{constructor(e){this._transaction=e,this.complete=new Promise((n,s)=>{this._transaction.oncomplete=function(){n()},this._transaction.onerror=()=>{s(this._transaction.error)},this._transaction.onabort=()=>{s(this._transaction.error)}})}objectStore(e){return new Mu(this._transaction.objectStore(e))}}class Mu{constructor(e){this._store=e}index(e){return new El(this._store.index(e))}createIndex(e,n,s){return new El(this._store.createIndex(e,n,s))}get(e){const n=this._store.get(e);return as(n,"Error reading from IndexedDB")}put(e,n){const s=this._store.put(e,n);return as(s,"Error writing to IndexedDB")}delete(e){const n=this._store.delete(e);return as(n,"Error deleting from IndexedDB")}clear(){const e=this._store.clear();return as(e,"Error clearing IndexedDB object store")}}class El{constructor(e){this._index=e}get(e){const n=this._index.get(e);return as(n,"Error reading from IndexedDB")}}function T_(t,e,n){return new Promise((s,i)=>{try{const r=indexedDB.open(t,e);r.onsuccess=o=>{s(new vl(o.target.result))},r.onerror=o=>{var a;i(`Error opening indexedDB: ${(a=o.target.error)===null||a===void 0?void 0:a.message}`)},r.onupgradeneeded=o=>{n(new vl(r.result),o.oldVersion,o.newVersion,new Ou(r.transaction))}}catch(r){i(`Error opening indexedDB: ${r.message}`)}})}class tn{constructor(e,n,s){this.name=e,this.instanceFactory=n,this.type=s,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M_{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(D_(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function D_(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Gr="@firebase/app",bl="0.7.22";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dg="firebase-heartbeat-database",fg=1,ws="firebase-heartbeat-store";let gr=null;function Fu(){return gr||(gr=T_(dg,fg,(t,e)=>{switch(e){case 0:t.createObjectStore(ws)}}).catch(t=>{throw nn.create("storage-open",{originalErrorMessage:t.message})})),gr}async function pg(t){try{return(await Fu()).transaction(ws).objectStore(ws).get(Uu(t))}catch(e){throw nn.create("storage-get",{originalErrorMessage:e.message})}}async function Cl(t,e){try{const s=(await Fu()).transaction(ws,"readwrite");return await s.objectStore(ws).put(e,Uu(t)),s.complete}catch(n){throw nn.create("storage-set",{originalErrorMessage:n.message})}}function Uu(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _g=1024,gg=30*24*60*60*1e3;class mg{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new vg(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=Il();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s)))return this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const r=new Date(i.date).valueOf();return Date.now()-r<=gg}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Il(),{heartbeatsToSend:n,unsentEntries:s}=yg(this._heartbeatsCache.heartbeats),i=Nu(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function Il(){return new Date().toISOString().substring(0,10)}function yg(t,e=_g){const n=[];let s=t.slice();for(const i of t){const r=n.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),wl(n)>e){r.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),wl(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class vg{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return f_()?p_().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await pg(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return Cl(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return Cl(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function wl(t){return Nu(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eg(t){Ln(new tn("platform-logger",e=>new M_(e),"PRIVATE")),Ln(new tn("heartbeat",e=>new mg(e),"PRIVATE")),xt(Gr,bl,t),xt(Gr,bl,"esm2017"),xt("fire-js","")}Eg("");var bg="firebase",Cg="9.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */xt(bg,Cg,"app");function Wo(t,e){var n={};for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&e.indexOf(s)<0&&(n[s]=t[s]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,s=Object.getOwnPropertySymbols(t);i<s.length;i++)e.indexOf(s[i])<0&&Object.prototype.propertyIsEnumerable.call(t,s[i])&&(n[s[i]]=t[s[i]]);return n}function Bu(){return{["dependent-sdk-initialized-before-auth"]:"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Ig=Bu,Wu=new Ms("auth","Firebase",Bu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tl=new Fo("@firebase/auth");function ni(t,...e){Tl.logLevel<=K.ERROR&&Tl.error(`Auth (${Ds}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qr(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function Rg(){return Rl()==="http:"||Rl()==="https:"}function Rl(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls{constructor(e,n){this.shortDelay=e,this.longDelay=n,gt(n>e,"Short delay should be less than long delay!"),this.isMobile=Lo()||Au()}get(){return Ng()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xg=new Ls(3e4,6e4);function $u(t,e){return t.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:t.tenantId}):e}async function qi(t,e,n,s,i={}){return Vu(t,i,async()=>{let r={},o={};s&&(e==="GET"?o=s:r={body:JSON.stringify(s)});const a=Yn(Object.assign({key:t.config.apiKey},o)).slice(1),l=await t._getAdditionalHeaders();return l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode),Hu.fetch()(qu(t,t.config.apiHost,n,a),Object.assign({method:e,headers:l,referrerPolicy:"no-referrer"},r))})}async function Vu(t,e,n){t._canInitEmulator=!1;const s=Object.assign(Object.assign({},Ag),e);try{const i=new Pg(t),r=await Promise.race([n(),i.promise]);i.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw mr(t,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const a=r.ok?o.errorMessage:o.error.message,[l,c]=a.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw mr(t,"credential-already-in-use",o);if(l==="EMAIL_EXISTS")throw mr(t,"email-already-in-use",o);const u=s[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(c)throw wg(t,u,c);_t(t,u)}}catch(i){if(i instanceof Gn)throw i;_t(t,"network-request-failed")}}async function ju(t,e,n,s,i={}){const r=await qi(t,e,n,s,i);return"mfaPendingCredential"in r&&_t(t,"multi-factor-auth-required",{_serverResponse:r}),r}function qu(t,e,n,s){const i=`${e}${n}?${s}`;return t.config.emulator?$o(t.config,i):`${t.config.apiScheme}://${i}`}class Pg{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((n,s)=>{this.timer=setTimeout(()=>s(nt(this.auth,"network-request-failed")),xg.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function mr(t,e,n){const s={appName:t.name};n.email&&(s.email=n.email),n.phoneNumber&&(s.phoneNumber=n.phoneNumber);const i=nt(t,e,s);return i.customData._tokenResponse=n,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ts(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Gn&&Fg(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function Fg({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $g(t,e){const n=await Vu(t,{},async()=>{const s=Yn({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:r}=t.config,o=qu(t,i,"/v1/token",`key=${r}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Hu.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ku{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Ku.type="NONE";const Nl=Ku;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kl(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Qu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Gu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Xu(e))return"Blackberry";if(Zu(e))return"Webos";if(jo(e))return"Safari";if((e.includes("chrome/")||Yu(e))&&!e.includes("edge/"))return"Chrome";if(Ju(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Gu(t=we()){return/firefox\//i.test(t)}function jo(t=we()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Yu(t=we()){return/crios\//i.test(t)}function Qu(t=we()){return/iemobile/i.test(t)}function Ju(t=we()){return/android/i.test(t)}function Xu(t=we()){return/blackberry/i.test(t)}function Zu(t=we()){return/webos/i.test(t)}function zi(t=we()){return/iphone|ipad|ipod/i.test(t)}function Vg(t=we()){var e;return zi(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function jg(){return d_()&&document.documentMode===10}function eh(t=we()){return zi(t)||Ju(t)||Zu(t)||Xu(t)||/windows phone/i.test(t)||Qu(t)}function qg(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function th(t,e=[]){let n;switch(t){case"Browser":n=kl(we());break;case"Worker":n=`${kl(we())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ds}/${s}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nh{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return ct("not implemented")}_getIdTokenResponse(e){return ct("not implemented")}_linkToIdToken(e,n){return ct("not implemented")}_getReauthenticationResolver(e){return ct("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kn(t,e){return ju(t,"POST","/v1/accounts:signInWithIdp",$u(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fs extends sh{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gg(t,e){return ju(t,"POST","/v1/accounts:signUp",$u(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt{constructor(e){this.user=e.user,this.providerId=e.providerId,this._tokenResponse=e._tokenResponse,this.operationType=e.operationType}static async _fromIdTokenResponse(e,n,s,i=!1){const r=await Xt._fromIdTokenResponse(e,s,i),o=xl(s);return new Dt({user:r,providerId:o,_tokenResponse:s,operationType:n})}static async _forOperation(e,n,s){await e._updateTokensIfNecessary(s,!0);const i=xl(s);return new Dt({user:e,providerId:i,_tokenResponse:s,operationType:n})}}function xl(t){return t.providerId?t.providerId:"phoneNumber"in t?"phone":null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gi extends Gn{constructor(e,n,s,i){var r;super(n.code,n.message),this.operationType=s,this.user=i,Object.setPrototypeOf(this,gi.prototype),this.customData={appName:e.name,tenantId:(r=e.tenantId)!==null&&r!==void 0?r:void 0,_serverResponse:n.customData._serverResponse,operationType:s}}static _fromErrorAndOperation(e,n,s,i){return new gi(e,n,s,i)}}function ih(t,e,n,s){return(e==="reauthenticate"?n._getReauthenticationResolver(t):n._getIdTokenResponse(t)).catch(r=>{throw r.code==="auth/multi-factor-auth-required"?gi._fromErrorAndOperation(t,r,e,s):r})}async function Qg(t,e,n=!1){const s=await Ts(t,e._linkToIdToken(t.auth,await t.getIdToken()),n);return Dt._forOperation(t,"link",s)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xg(t,e,n=!1){const s="signIn",i=await ih(t,s,e),r=await Dt._fromIdTokenResponse(t,s,i);return n||await t._updateCurrentUser(r.user),r}function Zg(t,e,n,s){return rt(t).onAuthStateChanged(e,n,s)}const mi="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rh{constructor(e,n){this.storageRetriever=e,this.type=n}_isAvailable(){try{return this.storage?(this.storage.setItem(mi,"1"),this.storage.removeItem(mi),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,n){return this.storage.setItem(e,JSON.stringify(n)),Promise.resolve()}_get(e){const n=this.storage.getItem(e);return Promise.resolve(n?JSON.parse(n):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ah extends rh{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,n){}_removeListener(e,n){}}ah.type="SESSION";const lh=ah;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ch(){return typeof st().WorkerGlobalScope!="undefined"&&typeof st().importScripts=="function"}async function am(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function lm(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function cm(){return ch()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fh{constructor(e,n,s,i,r=!1){this.auth=e,this.resolver=s,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(s){this.reject(s)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:s,postBody:i,tenantId:r,error:o,type:a}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:n,sessionId:s,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Em;case"linkViaPopup":case"linkViaRedirect":return Cm;case"reauthViaPopup":case"reauthViaRedirect":return bm;default:_t(this.auth,"internal-error")}}resolve(e){gt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){gt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Am=10*60*1e3;class xm{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let n=!1;return this.consumers.forEach(s=>{this.isEventForConsumer(e,s)&&(n=!0,this.sendToConsumer(e,s),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!Pm(e)||(this.hasHandledPotentialRedirect=!0,n||(this.queuedRedirectEvent=e,n=!0)),n}sendToConsumer(e,n){var s;if(e.error&&!ph(e)){const i=((s=e.error.code)===null||s===void 0?void 0:s.split("auth/")[1])||"internal-error";n.onError(nt(this.auth,i))}else n.onAuthEvent(e)}isEventForConsumer(e,n){const s=n.eventId===null||!!e.eventId&&e.eventId===n.eventId;return n.filter.includes(e.type)&&s}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Am&&this.cachedEventUids.clear(),this.cachedEventUids.has(Ml(e))}saveEventToCache(e){this.cachedEventUids.add(Ml(e)),this.lastProcessedEventTime=Date.now()}}function Ml(t){return[t.type,t.eventId,t.sessionId,t.tenantId].filter(e=>e).join("-")}function ph({type:t,error:e}){return t==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function Pm(t){switch(t.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return ph(t);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Um=new Ls(3e4,6e4);function Dl(){const t=st().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function Bm(t){return new Promise((e,n)=>{var s,i,r;function o(){Dl(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Dl(),n(nt(t,"network-request-failed"))},timeout:Um.get()})}if(!((i=(s=st().gapi)===null||s===void 0?void 0:s.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((r=st().gapi)===null||r===void 0)&&r.load)o();else{const a=ym("iframefcb");return st()[a]=()=>{gapi.load?o():n(nt(t,"network-request-failed"))},mm(`https://apis.google.com/js/api.js?onload=${a}`).catch(l=>n(l))}}).catch(e=>{throw ii=null,e})}let ii=null;function Wm(t){return ii=ii||Bm(t),ii}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gm={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ym=500,Qm=600,Jm="_blank",Xm="http://localhost";class Ll{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Zm(t,e,n,s=Ym,i=Qm){const r=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const l=Object.assign(Object.assign({},Gm),{width:s.toString(),height:i.toString(),top:r,left:o}),c=we().toLowerCase();n&&(a=Yu(c)?Jm:n),Gu(c)&&(e=e||Xm,l.scrollbars="yes");const u=Object.entries(l).reduce((f,[g,b])=>`${f}${g}=${b},`,"");if(Vg(c)&&a!=="_self")return ey(e||"",a),new Ll(null);const h=window.open(e||"",a,u);O(h,t,"popup-blocked");try{h.focus()}catch{}return new Ll(h)}function ey(t,e){const n=document.createElement("a");n.href=t,n.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ty="__/auth/handler",ny="emulator/auth/handler";function Fl(t,e,n,s,i,r){O(t.config.authDomain,t,"auth-domain-config-required"),O(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:s,v:Ds,eventId:i};if(e instanceof sh){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",Kr(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[l,c]of Object.entries(r||{}))o[l]=c}if(e instanceof Fs){const l=e.getScopes().filter(c=>c!=="");l.length>0&&(o.scopes=l.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const l of Object.keys(a))a[l]===void 0&&delete a[l];return`${sy(t)}?${Yn(a).slice(1)}`}function sy({config:t}){return t.emulator?$o(t,ny):`https://${t.authDomain}/${ty}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ay(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function ly(t){Ln(new tn("auth",(e,{options:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=s.options;return((a,l)=>{O(r&&!r.includes(":"),"invalid-api-key",{appName:a.name}),O(!(o!=null&&o.includes(":")),"argument-error",{appName:a.name});const c={apiKey:r,authDomain:o,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:th(t)},u=new zg(a,l,c);return Sg(u,n),u})(s,i)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,s)=>{e.getProvider("auth-internal").initialize()})),Ln(new tn("auth-internal",e=>{const n=qo(e.getProvider("auth").getImmediate());return(s=>new oy(s))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),xt(Ul,Bl,ay(t)),xt(Ul,Bl,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cy(t=Lu()){const e=Bo(t,"auth");return e.isInitialized()?e.getImmediate():Tg(t,{popupRedirectResolver:ry,persistence:[_m,sm,lh]})}ly("Browser");const Wl="@firebase/database",Hl="0.12.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gh=function(t){try{if(typeof window!="undefined"&&typeof window[t]!="undefined"){const e=window[t];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new hy(e)}}catch{}return new dy},Gt=gh("localStorage"),Xr=gh("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const An=new Fo("@firebase/database"),fy=function(){let t=1;return function(){return t++}}(),mh=function(t){const e=w_(t),n=new E_;n.update(e);const s=n.digest();return Do.encodeByteArray(s)},Bs=function(...t){let e="";for(let n=0;n<t.length;n++){const s=t[n];Array.isArray(s)||s&&typeof s=="object"&&typeof s.length=="number"?e+=Bs.apply(null,s):typeof s=="object"?e+=pe(s):e+=s,e+=" "}return e};let Zt=null,$l=!0;const py=function(t,e){E(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(An.logLevel=K.VERBOSE,Zt=An.log.bind(An),e&&Xr.set("logging_enabled",!0)):typeof t=="function"?Zt=t:(Zt=null,Xr.remove("logging_enabled"))},me=function(...t){if($l===!0&&($l=!1,Zt===null&&Xr.get("logging_enabled")===!0&&py(!0)),Zt){const e=Bs.apply(null,t);Zt(e)}},Ws=function(t){return function(...e){me(t,...e)}},Zr=function(...t){const e="FIREBASE INTERNAL ERROR: "+Bs(...t);An.error(e)},rn=function(...t){const e=`FIREBASE FATAL ERROR: ${Bs(...t)}`;throw An.error(e),new Error(e)},Se=function(...t){const e="FIREBASE WARNING: "+Bs(...t);An.warn(e)},_y=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&Se("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},Go=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},gy=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},Fn="[MIN_NAME]",on="[MAX_NAME]",hn=function(t,e){if(t===e)return 0;if(t===Fn||e===on)return-1;if(e===Fn||t===on)return 1;{const n=Vl(t),s=Vl(e);return n!==null?s!==null?n-s===0?t.length-e.length:n-s:-1:s!==null?1:t<e?-1:1}},my=function(t,e){return t===e?0:t<e?-1:1},ts=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+pe(e))},Yo=function(t){if(typeof t!="object"||t===null)return pe(t);const e=[];for(const s in t)e.push(s);e.sort();let n="{";for(let s=0;s<e.length;s++)s!==0&&(n+=","),n+=pe(e[s]),n+=":",n+=Yo(t[e[s]]);return n+="}",n},yh=function(t,e){const n=t.length;if(n<=e)return[t];const s=[];for(let i=0;i<n;i+=e)i+e>n?s.push(t.substring(i,n)):s.push(t.substring(i,i+e));return s};function be(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const vh=function(t){E(!Go(t),"Invalid JSON number");const e=11,n=52,s=(1<<e-1)-1;let i,r,o,a,l;t===0?(r=0,o=0,i=1/t===-1/0?1:0):(i=t<0,t=Math.abs(t),t>=Math.pow(2,1-s)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),s),r=a+s,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(r=0,o=Math.round(t/Math.pow(2,1-s-n))));const c=[];for(l=n;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(r%2?1:0),r=Math.floor(r/2);c.push(i?1:0),c.reverse();const u=c.join("");let h="";for(l=0;l<64;l+=8){let f=parseInt(u.substr(l,8),2).toString(16);f.length===1&&(f="0"+f),h=h+f}return h.toLowerCase()},yy=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},vy=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function Ey(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const s=new Error(t+" at "+e._path.toString()+": "+n);return s.code=t.toUpperCase(),s}const by=new RegExp("^-?(0*)\\d{1,10}$"),Cy=-2147483648,Iy=2147483647,Vl=function(t){if(by.test(t)){const e=Number(t);if(e>=Cy&&e<=Iy)return e}return null},Qn=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw Se("Exception was thrown by user callback.",n),e},Math.floor(0))}},wy=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},ds=function(t,e){const n=setTimeout(t,e);return typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qo="5",Eh="v",bh="s",Ch="r",Ih="f",wh=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Th="ls",Ry="p",to="ac",Sh="websocket",Rh="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Py{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,n){this.closeAfterResponse=e,this.onClose=n,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,n){for(this.pendingResponses[e]=n;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&Qn(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jl="start",Oy="close",My="pLPCommand",Dy="pRTLPCB",kh="id",Ah="pw",xh="ser",Ly="cb",Fy="seg",Uy="ts",By="d",Wy="dframe",Ph=1870,Oh=30,Hy=Ph-Oh,$y=25e3,Vy=3e4;class wn{constructor(e,n,s,i,r,o,a){this.connId=e,this.repoInfo=n,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Ws(e),this.stats_=Jo(n),this.urlFn=l=>(this.appCheckToken&&(l[to]=this.appCheckToken),Nh(n,Rh,l))}open(e,n){this.curSegmentNum=0,this.onDisconnect_=n,this.myPacketOrderer=new Py(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Vy)),gy(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Xo((...r)=>{const[o,a,l,c,u]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===jl)this.id=a,this.password=l;else if(o===Oy)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const s={};s[jl]="t",s[xh]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[Ly]=this.scriptTagHolder.uniqueCallbackIdentifier),s[Eh]=Qo,this.transportSessionId&&(s[bh]=this.transportSessionId),this.lastSessionId&&(s[Th]=this.lastSessionId),this.applicationId&&(s[Ry]=this.applicationId),this.appCheckToken&&(s[to]=this.appCheckToken),typeof location!="undefined"&&location.hostname&&wh.test(location.hostname)&&(s[Ch]=Ih);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){wn.forceAllow_=!0}static forceDisallow(){wn.forceDisallow_=!0}static isAvailable(){return wn.forceAllow_?!0:!wn.forceDisallow_&&typeof document!="undefined"&&document.createElement!=null&&!yy()&&!vy()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const n=pe(e);this.bytesSent+=n.length,this.stats_.incrementCounter("bytes_sent",n.length);const s=Ru(n),i=yh(s,Hy);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,n){this.myDisconnFrame=document.createElement("iframe");const s={};s[Wy]="t",s[kh]=e,s[Ah]=n,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const n=pe(e).length;this.bytesReceived+=n,this.stats_.incrementCounter("bytes_received",n)}}class Xo{constructor(e,n,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=fy(),window[My+this.uniqueCallbackIdentifier]=e,window[Dy+this.uniqueCallbackIdentifier]=n,this.myIFrame=Xo.createIFrame_();let r="";if(this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"){const a=document.domain;r='<script>document.domain="'+a+'";<\/script>'}const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){me("frame writing exception"),a.stack&&me(a.stack),me(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||me("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.innerHTML="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,n){for(this.myID=e,this.myPW=n,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[kh]=this.myID,e[Ah]=this.myPW,e[xh]=this.currentSerial;let n=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+Oh+s.length<=Ph;){const o=this.pendingSegs.shift();s=s+"&"+Fy+i+"="+o.seg+"&"+Uy+i+"="+o.ts+"&"+By+i+"="+o.d,i++}return n=n+s,this.addLongPollTag_(n,this.currentSerial),!0}else return!1}enqueueSegment(e,n,s){this.pendingSegs.push({seg:e,ts:n,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,n){this.outstandingRequests.add(n);const s=()=>{this.outstandingRequests.delete(n),this.newRequest_()},i=setTimeout(s,Math.floor($y)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,n){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),n())},s.onerror=()=>{me("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dh{constructor(e){this.allowedEvents_=e,this.listeners_={},E(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...n){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let i=0;i<s.length;i++)s[i].callback.apply(s[i].context,n)}}on(e,n,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:n,context:s});const i=this.getInitialEvent(e);i&&n.apply(s,i)}off(e,n,s){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let r=0;r<i.length;r++)if(i[r].callback===n&&(!s||s===i[r].context)){i.splice(r,1);return}}validateEventType_(e){E(this.allowedEvents_.find(n=>n===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Qs;class Uh extends Yi{static get __EMPTY_NODE(){return Qs}static set __EMPTY_NODE(e){Qs=e}compare(e,n){return hn(e.name,n.name)}isDefinedOn(e){throw Kn("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,n){return!1}minPost(){return F.MIN}maxPost(){return new F(on,Qs)}makePost(e,n){return E(typeof e=="string","KeyIndex indexValue must always be a string."),new F(e,Qs)}toString(){return".key"}}const xn=new Uh;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let no;function dv(t){no=t}const Bh=function(t){return typeof t=="number"?"number:"+vh(t):"string:"+t},Wh=function(t){if(t.isLeafNode()){const e=t.val();E(typeof e=="string"||typeof e=="number"||typeof e=="object"&&it(e,".sv"),"Priority must be a string or number.")}else E(t===no||t.isEmpty(),"priority of unexpected type.");E(t===no||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Hh,$h;function fv(t){Hh=t}function pv(t){$h=t}class _v extends Yi{compare(e,n){const s=e.node.getPriority(),i=n.node.getPriority(),r=s.compareTo(i);return r===0?hn(e.name,n.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,n){return!e.getPriority().equals(n.getPriority())}minPost(){return F.MIN}maxPost(){return new F(on,new ue("[PRIORITY-POST]",$h))}makePost(e,n){const s=Hh(e);return new F(n,new ue("[PRIORITY-POST]",s))}toString(){return".priority"}}const oe=new _v;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vh(t){return{type:"value",snapshotNode:t}}function Un(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function Ns(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function ks(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function wv(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ia{constructor(e){this.index_=e}updateChild(e,n,s,i,r,o){E(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(n)?o.trackChildChange(Ns(n,a)):E(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Un(n,s)):o.trackChildChange(ks(n,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(n,s).withIndex(this.index_)}updateFullNode(e,n,s){return s!=null&&(e.isLeafNode()||e.forEachChild(oe,(i,r)=>{n.hasChild(i)||s.trackChildChange(Ns(i,r))}),n.isLeafNode()||n.forEachChild(oe,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(ks(i,r,o))}else s.trackChildChange(Un(i,r))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?x.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ci extends Mh{constructor(e,n,s,i){super(),this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=s,this.appCheckTokenProvider_=i,this.log_=Ws("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(E(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,n,s,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=Ci.getListenId_(e,s),a={};this.listens_[o]=a;const l=sc(e._queryParams);this.restRequest_(r+".json",l,(c,u)=>{let h=u;if(c===404&&(h=null,c=null),c===null&&this.onDataUpdate_(r,h,!1,s),Dn(this.listens_,o)===a){let f;c?c===401?f="permission_denied":f="rest_error:"+c:f="ok",i(f,null)}})}unlisten(e,n){const s=Ci.getListenId_(e,n);delete this.listens_[s]}get(e){const n=sc(e._queryParams),s=e._path.toString(),i=new Os;return this.restRequest_(s+".json",n,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(s,a,!1,null),i.resolve(a)):i.reject(new Error(a))}),i.promise}refreshAuthToken(e){}restRequest_(e,n={},s){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([i,r])=>{i&&i.accessToken&&(n.auth=i.accessToken),r&&r.token&&(n.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+Yn(n);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(s&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=Is(a.responseText)}catch{Se("Failed to parse JSON response for "+o+": "+a.responseText)}s(null,l)}else a.status!==401&&a.status!==404&&Se("Got unsuccessful REST response for "+o+" Status: "+a.status),s(a.status);s=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ii(){return{value:null,children:new Map}}function jh(t,e,n){if(B(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const s=L(e);t.children.has(s)||t.children.set(s,Ii());const i=t.children.get(s);e=Q(e),jh(i,e,n)}}function so(t,e,n){t.value!==null?n(e,t.value):Nv(t,(s,i)=>{const r=new q(e.toString()+"/"+s);so(i,r,n)})}function Nv(t,e){t.children.forEach((n,s)=>{e(s,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rc=10*1e3,Av=30*1e3,xv=5*60*1e3;class Pv{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new kv(e);const s=rc+(Av-rc)*Math.random();ds(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),n={};let s=!1;be(e,(i,r)=>{r>0&&it(this.statsToReport_,i)&&(n[i]=r,s=!0)}),s&&this.server_.reportStats(n),ds(this.reportStats_.bind(this),Math.floor(Math.random()*2*xv))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,n,s){this.source=e,this.path=n,this.children=s,this.type=ze.MERGE}operationForChild(e){if(B(this.path)){const n=this.children.subtree(new q(e));return n.isEmpty()?null:n.value?new an(this.source,$(),n.value):new Bn(this.source,$(),n)}else return E(L(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Bn(this.source,Q(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ov{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Mv(t,e,n,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(wv(o.childName,o.snapshotNode))}),is(t,i,"child_removed",e,s,n),is(t,i,"child_added",e,s,n),is(t,i,"child_moved",r,s,n),is(t,i,"child_changed",e,s,n),is(t,i,"value",e,s,n),i}function is(t,e,n,s,i,r){const o=s.filter(a=>a.type===n);o.sort((a,l)=>Lv(t,a,l)),o.forEach(a=>{const l=Dv(t,a,r);i.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,t.query_))})})}function Dv(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function Lv(t,e,n){if(e.childName==null||n.childName==null)throw Kn("Should only compare child_ events.");const s=new F(e.childName,e.snapshotNode),i=new F(n.childName,n.snapshotNode);return t.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qi(t,e){return{eventCache:t,serverCache:e}}function fs(t,e,n,s){return Qi(new ln(e,n,s),t.serverCache)}function qh(t,e,n,s){return Qi(t.eventCache,new ln(e,n,s))}function io(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function cn(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e){this.writeTree_=e}static empty(){return new Qe(new Y(null))}}function ps(t,e,n){if(B(e))return new Qe(new Y(n));{const s=t.writeTree_.findRootMostValueAndPath(e);if(s!=null){const i=s.path;let r=s.value;const o=ke(i,e);return r=r.updateChild(o,n),new Qe(t.writeTree_.set(i,r))}else{const i=new Y(n),r=t.writeTree_.setTree(e,i);return new Qe(r)}}}function ro(t,e,n){let s=t;return be(n,(i,r)=>{s=ps(s,re(e,i),r)}),s}function oc(t,e){if(B(e))return Qe.empty();{const n=t.writeTree_.setTree(e,new Y(null));return new Qe(n)}}function oo(t,e){return dn(t,e)!=null}function dn(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(ke(n.path,e)):null}function ac(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(oe,(s,i)=>{e.push(new F(s,i))}):t.writeTree_.children.inorderTraversal((s,i)=>{i.value!=null&&e.push(new F(s,i.value))}),e}function Pt(t,e){if(B(e))return t;{const n=dn(t,e);return n!=null?new Qe(new Y(n)):new Qe(t.writeTree_.subtree(e))}}function ao(t){return t.writeTree_.isEmpty()}function Wn(t,e){return zh($(),t.writeTree_,e)}function zh(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let s=null;return e.children.inorderTraversal((i,r)=>{i===".priority"?(E(r.value!==null,"Priority writes must always be leaf nodes"),s=r.value):n=zh(re(t,i),r,n)}),!n.getChild(t).isEmpty()&&s!==null&&(n=n.updateChild(re(t,".priority"),s)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ca(t,e){return Qh(e,t)}function Uv(t,e,n,s,i){E(s>t.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),t.allWrites.push({path:e,snap:n,writeId:s,visible:i}),i&&(t.visibleWrites=ps(t.visibleWrites,e,n)),t.lastWriteId=s}function Bv(t,e,n,s){E(s>t.lastWriteId,"Stacking an older merge on top of newer ones"),t.allWrites.push({path:e,children:n,writeId:s,visible:!0}),t.visibleWrites=ro(t.visibleWrites,e,n),t.lastWriteId=s}function Wv(t,e){for(let n=0;n<t.allWrites.length;n++){const s=t.allWrites[n];if(s.writeId===e)return s}return null}function Hv(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);E(n>=0,"removeWrite called with nonexistent writeId.");const s=t.allWrites[n];t.allWrites.splice(n,1);let i=s.visible,r=!1,o=t.allWrites.length-1;for(;i&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&$v(a,s.path)?i=!1:Ue(s.path,a.path)&&(r=!0)),o--}if(i){if(r)return Vv(t),!0;if(s.snap)t.visibleWrites=oc(t.visibleWrites,s.path);else{const a=s.children;be(a,l=>{t.visibleWrites=oc(t.visibleWrites,re(s.path,l))})}return!0}else return!1}function $v(t,e){if(t.snap)return Ue(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&Ue(re(t.path,n),e))return!0;return!1}function Vv(t){t.visibleWrites=Kh(t.allWrites,jv,$()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function jv(t){return t.visible}function Kh(t,e,n){let s=Qe.empty();for(let i=0;i<t.length;++i){const r=t[i];if(e(r)){const o=r.path;let a;if(r.snap)Ue(n,o)?(a=ke(n,o),s=ps(s,a,r.snap)):Ue(o,n)&&(a=ke(o,n),s=ps(s,$(),r.snap.getChild(a)));else if(r.children){if(Ue(n,o))a=ke(n,o),s=ro(s,a,r.children);else if(Ue(o,n))if(a=ke(o,n),B(a))s=ro(s,$(),r.children);else{const l=Dn(r.children,L(a));if(l){const c=l.getChild(Q(a));s=ps(s,$(),c)}}}else throw Kn("WriteRecord should have .snap or .children")}}return s}function Gh(t,e,n,s,i){if(!s&&!i){const r=dn(t.visibleWrites,e);if(r!=null)return r;{const o=Pt(t.visibleWrites,e);if(ao(o))return n;if(n==null&&!oo(o,$()))return null;{const a=n||x.EMPTY_NODE;return Wn(o,a)}}}else{const r=Pt(t.visibleWrites,e);if(!i&&ao(r))return n;if(!i&&n==null&&!oo(r,$()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(Ue(c.path,e)||Ue(e,c.path))},a=Kh(t.allWrites,o,e),l=n||x.EMPTY_NODE;return Wn(a,l)}}}function qv(t,e,n){let s=x.EMPTY_NODE;const i=dn(t.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(oe,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(n){const r=Pt(t.visibleWrites,e);return n.forEachChild(oe,(o,a)=>{const l=Wn(Pt(r,new q(o)),a);s=s.updateImmediateChild(o,l)}),ac(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Pt(t.visibleWrites,e);return ac(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function zv(t,e,n,s,i){E(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=re(e,n);if(oo(t.visibleWrites,r))return null;{const o=Pt(t.visibleWrites,r);return ao(o)?i.getChild(n):Wn(o,i.getChild(n))}}function Kv(t,e,n,s){const i=re(e,n),r=dn(t.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(n)){const o=Pt(t.visibleWrites,i);return Wn(o,s.getNode().getImmediateChild(n))}else return null}function Gv(t,e){return dn(t.visibleWrites,e)}function Yv(t,e,n,s,i,r,o){let a;const l=Pt(t.visibleWrites,e),c=dn(l,$());if(c!=null)a=c;else if(n!=null)a=Wn(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),f=r?a.getReverseIteratorFrom(s,o):a.getIteratorFrom(s,o);let g=f.getNext();for(;g&&u.length<i;)h(g,s)!==0&&u.push(g),g=f.getNext();return u}else return[]}function Qv(){return{visibleWrites:Qe.empty(),allWrites:[],lastWriteId:-1}}function Ti(t,e,n,s){return Gh(t.writeTree,t.treePath,e,n,s)}function ua(t,e){return qv(t.writeTree,t.treePath,e)}function lc(t,e,n,s){return zv(t.writeTree,t.treePath,e,n,s)}function Si(t,e){return Gv(t.writeTree,re(t.treePath,e))}function Jv(t,e,n,s,i,r){return Yv(t.writeTree,t.treePath,e,n,s,i,r)}function ha(t,e,n){return Kv(t.writeTree,t.treePath,e,n)}function Yh(t,e){return Qh(re(t.treePath,e),t.writeTree)}function Qh(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ni;class fE{constructor(){this.views=new Map}}function pE(t){E(!Ni,"__referenceConstructor has already been defined"),Ni=t}function _E(){return E(Ni,"Reference.ts has not been loaded"),Ni}function gE(t){return t.views.size===0}function fa(t,e,n,s){const i=e.source.queryId;if(i!==null){const r=t.views.get(i);return E(r!=null,"SyncTree gave us an op for an invalid query."),fc(r,e,n,s)}else{let r=[];for(const o of t.views.values())r=r.concat(fc(o,e,n,s));return r}}function mE(t,e,n,s,i){const r=e._queryIdentifier,o=t.views.get(r);if(!o){let a=Ti(n,i?s:null),l=!1;a?l=!0:s instanceof x?(a=ua(n,s),l=!1):(a=x.EMPTY_NODE,l=!1);const c=Qi(new ln(a,l,!1),new ln(s,i,!1));return new lE(e,c)}return o}function yE(t,e,n,s,i,r){const o=mE(t,e,s,i,r);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),hE(o,n),dE(o,n)}function vE(t,e,n,s){const i=e._queryIdentifier,r=[];let o=[];const a=Ft(t);if(i==="default")for(const[l,c]of t.views.entries())o=o.concat(dc(c,n,s)),hc(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=t.views.get(i);l&&(o=o.concat(dc(l,n,s)),hc(l)&&(t.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!Ft(t)&&r.push(new(_E())(e._repo,e._path)),{removed:r,events:o}}function ed(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function Pn(t,e){let n=null;for(const s of t.views.values())n=n||uE(s,e);return n}function td(t,e){if(e._queryParams.loadsAllData())return Ji(t);{const s=e._queryIdentifier;return t.views.get(s)}}function nd(t,e){return td(t,e)!=null}function Ft(t){return Ji(t)!=null}function Ji(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ki;function EE(t){E(!ki,"__referenceConstructor has already been defined"),ki=t}function bE(){return E(ki,"Reference.ts has not been loaded"),ki}let CE=1;class pc{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Y(null),this.pendingWriteTree_=Qv(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function sd(t,e,n,s,i){return Uv(t.pendingWriteTree_,e,n,s,i),i?Jn(t,new an(oa(),e,n)):[]}function IE(t,e,n,s){Bv(t.pendingWriteTree_,e,n,s);const i=Y.fromObject(n);return Jn(t,new Bn(oa(),e,i))}function Nt(t,e,n=!1){const s=Wv(t.pendingWriteTree_,e);if(Hv(t.pendingWriteTree_,e)){let r=new Y(null);return s.snap!=null?r=r.set($(),!0):be(s.children,o=>{r=r.set(new q(o),!0)}),Jn(t,new wi(s.path,r,n))}else return[]}function Xi(t,e,n){return Jn(t,new an(aa(),e,n))}function wE(t,e,n){const s=Y.fromObject(n);return Jn(t,new Bn(aa(),e,s))}function TE(t,e){return Jn(t,new xs(aa(),e))}function SE(t,e,n){const s=_a(t,n);if(s){const i=ga(s),r=i.path,o=i.queryId,a=ke(r,e),l=new xs(la(o),a);return ma(t,r,l)}else return[]}function uo(t,e,n,s){const i=e._path,r=t.syncPointTree_.get(i);let o=[];if(r&&(e._queryIdentifier==="default"||nd(r,e))){const a=vE(r,e,n,s);gE(r)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const l=a.removed;o=a.events;const c=l.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(i,(h,f)=>Ft(f));if(c&&!u){const h=t.syncPointTree_.subtree(i);if(!h.isEmpty()){const f=kE(h);for(let g=0;g<f.length;++g){const b=f[g],S=b.query,N=od(t,b);t.listenProvider_.startListening(_s(S),Ai(t,S),N.hashFn,N.onComplete)}}}!u&&l.length>0&&!s&&(c?t.listenProvider_.stopListening(_s(e),null):l.forEach(h=>{const f=t.queryToTagMap.get(Zi(h));t.listenProvider_.stopListening(_s(h),f)})),AE(t,l)}return o}function RE(t,e,n,s){const i=_a(t,s);if(i!=null){const r=ga(i),o=r.path,a=r.queryId,l=ke(o,e),c=new an(la(a),l,n);return ma(t,o,c)}else return[]}function NE(t,e,n,s){const i=_a(t,s);if(i){const r=ga(i),o=r.path,a=r.queryId,l=ke(o,e),c=Y.fromObject(n),u=new Bn(la(a),l,c);return ma(t,o,u)}else return[]}function _c(t,e,n){const s=e._path;let i=null,r=!1;t.syncPointTree_.foreachOnPath(s,(h,f)=>{const g=ke(h,s);i=i||Pn(f,g),r=r||Ft(f)});let o=t.syncPointTree_.get(s);o?(r=r||Ft(o),i=i||Pn(o,$())):(o=new fE,t.syncPointTree_=t.syncPointTree_.set(s,o));let a;i!=null?a=!0:(a=!1,i=x.EMPTY_NODE,t.syncPointTree_.subtree(s).foreachChild((f,g)=>{const b=Pn(g,$());b&&(i=i.updateImmediateChild(f,b))}));const l=nd(o,e);if(!l&&!e._queryParams.loadsAllData()){const h=Zi(e);E(!t.queryToTagMap.has(h),"View does not exist, but we have a tag");const f=xE();t.queryToTagMap.set(h,f),t.tagToQueryMap.set(f,h)}const c=ca(t.pendingWriteTree_,s);let u=yE(o,e,n,c,i,a);if(!l&&!r){const h=td(o,e);u=u.concat(PE(t,e,h))}return u}function pa(t,e,n){const i=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=ke(o,e),c=Pn(a,l);if(c)return c});return Gh(i,e,r,n,!0)}function Jn(t,e){return id(e,t.syncPointTree_,null,ca(t.pendingWriteTree_,$()))}function id(t,e,n,s){if(B(t.path))return rd(t,e,n,s);{const i=e.get($());n==null&&i!=null&&(n=Pn(i,$()));let r=[];const o=L(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=Yh(s,o);r=r.concat(id(a,l,c,u))}return i&&(r=r.concat(fa(i,t,s,n))),r}}function rd(t,e,n,s){const i=e.get($());n==null&&i!=null&&(n=Pn(i,$()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=Yh(s,o),u=t.operationForChild(o);u&&(r=r.concat(rd(u,a,l,c)))}),i&&(r=r.concat(fa(i,t,s,n))),r}function od(t,e){const n=e.query,s=Ai(t,n);return{hashFn:()=>(cE(e)||x.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?SE(t,n._path,s):TE(t,n._path);{const r=Ey(i,n);return uo(t,n,null,r)}}}}function Ai(t,e){const n=Zi(e);return t.queryToTagMap.get(n)}function Zi(t){return t._path.toString()+"$"+t._queryIdentifier}function _a(t,e){return t.tagToQueryMap.get(e)}function ga(t){const e=t.indexOf("$");return E(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new q(t.substr(0,e))}}function ma(t,e,n){const s=t.syncPointTree_.get(e);E(s,"Missing sync point for query tag that we're tracking");const i=ca(t.pendingWriteTree_,e);return fa(s,n,i,null)}function kE(t){return t.fold((e,n,s)=>{if(n&&Ft(n))return[Ji(n)];{let i=[];return n&&(i=ed(n)),be(s,(r,o)=>{i=i.concat(o)}),i}})}function _s(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(bE())(t._repo,t._path):t}function AE(t,e){for(let n=0;n<e.length;++n){const s=e[n];if(!s._queryParams.loadsAllData()){const i=Zi(s),r=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(r)}}}function xE(){return CE++}function PE(t,e,n){const s=e._path,i=Ai(t,e),r=od(t,n),o=t.listenProvider_.startListening(_s(e),i,r.hashFn,r.onComplete),a=t.syncPointTree_.subtree(s);if(i)E(!Ft(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,h)=>{if(!B(c)&&u&&Ft(u))return[Ji(u).query];{let f=[];return u&&(f=f.concat(ed(u).map(g=>g.query))),be(h,(g,b)=>{f=f.concat(b)}),f}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(_s(u),Ai(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ba{constructor(e="",n=null,s={children:{},childCount:0}){this.name=e,this.parent=n,this.node=s}}function Ca(t,e){let n=e instanceof q?e:new q(e),s=t,i=L(n);for(;i!==null;){const r=Dn(s.node.children,i)||{children:{},childCount:0};s=new ba(i,s,r),n=Q(n),i=L(n)}return s}function Xn(t){return t.node.value}function cd(t,e){t.node.value=e,ho(t)}function ud(t){return t.node.childCount>0}function LE(t){return Xn(t)===void 0&&!ud(t)}function er(t,e){be(t.node.children,(n,s)=>{e(new ba(n,t,s))})}function hd(t,e,n,s){n&&!s&&e(t),er(t,i=>{hd(i,e,!0,s)}),n&&s&&e(t)}function FE(t,e,n){let s=n?t:t.parent;for(;s!==null;){if(e(s))return!0;s=s.parent}return!1}function $s(t){return new q(t.parent===null?t.name:$s(t.parent)+"/"+t.name)}function ho(t){t.parent!==null&&UE(t.parent,t.name,t)}function UE(t,e,n){const s=LE(n),i=it(t.node.children,e);s&&i?(delete t.node.children[e],t.node.childCount--,ho(t)):!s&&!i&&(t.node.children[e]=n.node,t.node.childCount++,ho(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KE{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function nr(t,e){let n=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();n!==null&&!ta(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(i)}n&&t.eventLists_.push(n)}function _d(t,e,n){nr(t,n),gd(t,s=>ta(s,e))}function Je(t,e,n){nr(t,n),gd(t,s=>Ue(s,e)||Ue(e,s))}function gd(t,e){t.recursionDepth_++;let n=!0;for(let s=0;s<t.eventLists_.length;s++){const i=t.eventLists_[s];if(i){const r=i.path;e(r)?(GE(t.eventLists_[s]),t.eventLists_[s]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function GE(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const s=n.getEventRunner();Zt&&me("event: "+n.toString()),Qn(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YE="repo_interrupt",QE=25;class JE{constructor(e,n,s,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new KE,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ii(),this.transactionQueueTree_=new ba,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function XE(t,e,n){if(t.stats_=Jo(t.repoInfo_),t.forceRestClient_||wy())t.server_=new Ci(t.repoInfo_,(s,i,r,o)=>{mc(t,s,i,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>yc(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{pe(n)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}t.persistentConnection_=new ft(t.repoInfo_,e,(s,i,r,o)=>{mc(t,s,i,r,o)},s=>{yc(t,s)},s=>{ZE(t,s)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(s=>{t.server_.refreshAuthToken(s)}),t.appCheckProvider_.addTokenChangeListener(s=>{t.server_.refreshAppCheckToken(s.token)}),t.statsReporter_=xy(t.repoInfo_,()=>new Pv(t.stats_,t.server_)),t.infoData_=new Rv,t.infoSyncTree_=new pc({startListening:(s,i,r,o)=>{let a=[];const l=t.infoData_.getNode(s._path);return l.isEmpty()||(a=Xi(t.infoSyncTree_,s._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Ta(t,"connected",!1),t.serverSyncTree_=new pc({startListening:(s,i,r,o)=>(t.server_.listen(s,r,i,(a,l)=>{const c=o(a,l);Je(t.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{t.server_.unlisten(s,i)}})}function md(t){const n=t.infoData_.getNode(new q(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function sr(t){return OE({timestamp:md(t)})}function mc(t,e,n,s,i){t.dataUpdateCount++;const r=new q(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(s){const l=di(n,c=>fe(c));o=NE(t.serverSyncTree_,r,l,i)}else{const l=fe(n);o=RE(t.serverSyncTree_,r,l,i)}else if(s){const l=di(n,c=>fe(c));o=wE(t.serverSyncTree_,r,l)}else{const l=fe(n);o=Xi(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Hn(t,r)),Je(t.eventQueue_,a,o)}function yc(t,e){Ta(t,"connected",e),e===!1&&nb(t)}function ZE(t,e){be(e,(n,s)=>{Ta(t,n,s)})}function Ta(t,e,n){const s=new q("/.info/"+e),i=fe(n);t.infoData_.updateSnapshot(s,i);const r=Xi(t.infoSyncTree_,s,i);Je(t.eventQueue_,s,r)}function Sa(t){return t.nextWriteId_++}function eb(t,e,n,s,i){ir(t,"set",{path:e.toString(),value:n,priority:s});const r=sr(t),o=fe(n,s),a=pa(t.serverSyncTree_,e),l=ld(o,a,r),c=Sa(t),u=sd(t.serverSyncTree_,e,l,c,!0);nr(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(f,g)=>{const b=f==="ok";b||Se("set at "+e+" failed: "+f);const S=Nt(t.serverSyncTree_,c,!b);Je(t.eventQueue_,e,S),fo(t,i,f,g)});const h=Na(t,e);Hn(t,h),Je(t.eventQueue_,h,[])}function tb(t,e,n,s){ir(t,"update",{path:e.toString(),value:n});let i=!0;const r=sr(t),o={};if(be(n,(a,l)=>{i=!1,o[a]=ad(re(e,a),fe(l),t.serverSyncTree_,r)}),i)me("update() called with empty data.  Don't do anything."),fo(t,s,"ok",void 0);else{const a=Sa(t),l=IE(t.serverSyncTree_,e,o,a);nr(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,u)=>{const h=c==="ok";h||Se("update at "+e+" failed: "+c);const f=Nt(t.serverSyncTree_,a,!h),g=f.length>0?Hn(t,e):e;Je(t.eventQueue_,g,f),fo(t,s,c,u)}),be(n,c=>{const u=Na(t,re(e,c));Hn(t,u)}),Je(t.eventQueue_,e,[])}}function nb(t){ir(t,"onDisconnectEvents");const e=sr(t),n=Ii();so(t.onDisconnect_,$(),(i,r)=>{const o=ad(i,r,t.serverSyncTree_,e);jh(n,i,o)});let s=[];so(n,$(),(i,r)=>{s=s.concat(Xi(t.serverSyncTree_,i,r));const o=Na(t,i);Hn(t,o)}),t.onDisconnect_=Ii(),Je(t.eventQueue_,$(),s)}function sb(t,e,n){let s;L(e._path)===".info"?s=_c(t.infoSyncTree_,e,n):s=_c(t.serverSyncTree_,e,n),_d(t.eventQueue_,e._path,s)}function vc(t,e,n){let s;L(e._path)===".info"?s=uo(t.infoSyncTree_,e,n):s=uo(t.serverSyncTree_,e,n),_d(t.eventQueue_,e._path,s)}function ib(t){t.persistentConnection_&&t.persistentConnection_.interrupt(YE)}function ir(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),me(n,...e)}function fo(t,e,n,s){e&&Qn(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function yd(t,e,n){return pa(t.serverSyncTree_,e,n)||x.EMPTY_NODE}function Ra(t,e=t.transactionQueueTree_){if(e||rr(t,e),Xn(e)){const n=Ed(t,e);E(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&rb(t,$s(e),n)}else ud(e)&&er(e,n=>{Ra(t,n)})}function rb(t,e,n){const s=n.map(c=>c.currentWriteId),i=yd(t,e,s);let r=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];E(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const h=ke(e,u.path);r=r.updateChild(h,u.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{ir(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const h=[];for(let f=0;f<n.length;f++)n[f].status=2,u=u.concat(Nt(t.serverSyncTree_,n[f].currentWriteId)),n[f].onComplete&&h.push(()=>n[f].onComplete(null,!0,n[f].currentOutputSnapshotResolved)),n[f].unwatcher();rr(t,Ca(t.transactionQueueTree_,e)),Ra(t,t.transactionQueueTree_),Je(t.eventQueue_,e,u);for(let f=0;f<h.length;f++)Qn(h[f])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{Se("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}Hn(t,e)}},o)}function Hn(t,e){const n=vd(t,e),s=$s(n),i=Ed(t,n);return ob(t,i,s),s}function ob(t,e,n){if(e.length===0)return;const s=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=ke(n,l.path);let u=!1,h;if(E(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,h=l.abortReason,i=i.concat(Nt(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=QE)u=!0,h="maxretry",i=i.concat(Nt(t.serverSyncTree_,l.currentWriteId,!0));else{const f=yd(t,l.path,o);l.currentInputSnapshot=f;const g=e[a].update(f.val());if(g!==void 0){tr("transaction failed: Data returned ",g,l.path);let b=fe(g);typeof g=="object"&&g!=null&&it(g,".priority")||(b=b.updatePriority(f.getPriority()));const N=l.currentWriteId,U=sr(t),ae=ld(b,f,U);l.currentOutputSnapshotRaw=b,l.currentOutputSnapshotResolved=ae,l.currentWriteId=Sa(t),o.splice(o.indexOf(N),1),i=i.concat(sd(t.serverSyncTree_,l.path,ae,l.currentWriteId,l.applyLocally)),i=i.concat(Nt(t.serverSyncTree_,N,!0))}else u=!0,h="nodata",i=i.concat(Nt(t.serverSyncTree_,l.currentWriteId,!0))}Je(t.eventQueue_,n,i),i=[],u&&(e[a].status=2,function(f){setTimeout(f,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?s.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):s.push(()=>e[a].onComplete(new Error(h),!1,null))))}rr(t,t.transactionQueueTree_);for(let a=0;a<s.length;a++)Qn(s[a]);Ra(t,t.transactionQueueTree_)}function vd(t,e){let n,s=t.transactionQueueTree_;for(n=L(e);n!==null&&Xn(s)===void 0;)s=Ca(s,n),e=Q(e),n=L(e);return s}function Ed(t,e){const n=[];return bd(t,e,n),n.sort((s,i)=>s.order-i.order),n}function bd(t,e,n){const s=Xn(e);if(s)for(let i=0;i<s.length;i++)n.push(s[i]);er(e,i=>{bd(t,i,n)})}function rr(t,e){const n=Xn(e);if(n){let s=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[s]=n[i],s++);n.length=s,cd(e,n.length>0?n:void 0)}er(e,s=>{rr(t,s)})}function Na(t,e){const n=$s(vd(t,e)),s=Ca(t.transactionQueueTree_,e);return FE(s,i=>{Rr(t,i)}),Rr(t,s),hd(s,i=>{Rr(t,i)}),n}function Rr(t,e){const n=Xn(e);if(n){const s=[];let i=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(E(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(E(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(Nt(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&s.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?cd(e,void 0):n.length=r+1,Je(t.eventQueue_,$s(e),i);for(let o=0;o<s.length;o++)Qn(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cd{constructor(e,n,s,i){this.eventType=e,this.eventRegistration=n,this.snapshot=s,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+pe(this.snapshot.exportVal())}}class Id{constructor(e,n,s){this.eventRegistration=e,this.error=n,this.path=s}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ka{constructor(e,n,s,i){this._repo=e,this._path=n,this._queryParams=s,this._orderByCalled=i}get key(){return B(this._path)?null:ea(this._path)}get ref(){return new yt(this._repo,this._path)}get _queryIdentifier(){const e=ic(this._queryParams),n=Yo(e);return n==="{}"?"default":n}get _queryObject(){return ic(this._queryParams)}isEqual(e){if(e=rt(e),!(e instanceof ka))return!1;const n=this._repo===e._repo,s=ta(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+ev(this._path)}}class yt extends ka{constructor(e,n){super(e,n,new ra,!1)}get parent(){const e=Lh(this._path);return e===null?null:new yt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Ps{constructor(e,n,s){this._node=e,this.ref=n,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new q(e),s=$n(this.ref,e);return new Ps(this._node.getChild(n),s,oe)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new Ps(i,$n(this.ref,s),oe)))}hasChild(e){const n=new q(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function fn(t,e){return t=rt(t),t._checkNotDeleted("ref"),e!==void 0?$n(t._root,e):t._root}function $n(t,e){return t=rt(t),L(t._path)===null?qE("child","path",e,!1):pd("child","path",e,!1),new yt(t._repo,re(t._path,e))}function wd(t,e){t=rt(t),wa("push",t._path),fd("push",e,t._path,!0);const n=md(t._repo),s=Iv(n),i=$n(t,s),r=$n(t,s);let o;return e!=null?o=Td(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function hb(t){return wa("remove",t._path),Td(t,null)}function Td(t,e){t=rt(t),wa("set",t._path),fd("set",e,t._path,!1);const n=new Os;return eb(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Sd(t,e){jE("update",e,t._path,!1);const n=new Os;return tb(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}class Aa{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const s=n._queryParams.getIndex();return new Cd("value",this,new Ps(e.snapshotNode,new yt(n._repo,n._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Id(this,e,n):null}matches(e){return e instanceof Aa?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class xa{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Id(this,e,n):null}createEvent(e,n){E(e.childName!=null,"Child events should have a childName.");const s=$n(new yt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Cd(e.type,this,new Ps(e.snapshotNode,s,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof xa?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function db(t,e,n,s,i){let r;if(typeof s=="object"&&(r=void 0,i=s),typeof s=="function"&&(r=s),i&&i.onlyOnce){const l=n,c=(u,h)=>{vc(t._repo,t,a),l(u,h)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new ub(n,r||void 0),a=e==="value"?new Aa(o):new xa(e,o);return sb(t._repo,t,a),()=>vc(t._repo,t,a)}function Rd(t,e,n,s){return db(t,"value",e,n,s)}pE(yt);EE(yt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eb(t){uy(Ds),Ln(new tn("database",(e,{instanceIdentifier:n})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return _b(s,i,r,n)},"PUBLIC").setMultipleInstances(!0)),xt(Wl,Hl,t),xt(Wl,Hl,"esm2017")}ft.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};ft.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};Eb();const bb={apiKey:"AIzaSyAsXHXd9Spu67AO6DV06x2E_EnVOIAu9UU",authDomain:"quick-retro.firebaseapp.com",projectId:"quick-retro",storageBucket:"quick-retro.appspot.com",messagingSenderId:"293134428599",appId:"1:293134428599:web:bad71d4fedbda8080ce032",databaseURL:"https://quick-retro-default-rtdb.europe-west1.firebasedatabase.app"},Cb=hg(bb),pn=vb(Cb);function Ib(){const t=un({});return Rd(fn(pn,"boards"),e=>{Object.entries(e.val()).forEach(([n,s])=>{t[n]=s})}),t}function wb(t){const e=un({loading:!0});return Rd(fn(pn,`boards/${t}`),n=>{e.exists=n.exists(),e.loading=!1,e.exists&&Object.entries(n.val()).forEach(([s,i])=>{e[s]=i})}),e}function Tb(t,e){const n=fn(pn,`boards/${t}`);Sd(n,{cardsHidden:e})}function Sb(t,e){const n=fn(pn,`boards/${t}`);Sd(n,{title:e})}function Rb(t,e,n){const s=fn(pn,`boards/${t}/columns/${e}/cards`);wd(s,n)}function Nb(t,e,n){hb(fn(pn,`boards/${t}/columns/${e}/cards/${n}`))}async function kb(t,e){const n=fn(pn,"boards");return(await wd(n,{author:t,cardsHidden:!0,title:"",columns:e.columns.map(i=>$a(Ha({},i),{cards:{}}))})).key}function Ab(){const t=un({}),e=cy();return Yg(e).catch(n=>{console.error(n)}),Zg(e,n=>{n&&Object.entries(n).forEach(([s,i])=>{t[s]=i})}),t}var Bt=(t,e)=>{const n=t.__vccOpts||t;for(const[s,i]of e)n[s]=i;return n};const xb=Ut({props:{text:null,onClick:null},setup(t){return(e,n)=>(te(),Ee("button",{onClick:n[0]||(n[0]=(...s)=>t.onClick&&t.onClick(...s))},gs(t.text),1))}});var Pb=Bt(xb,[["__scopeId","data-v-f7270f9a"]]);const Ob=Ut({props:{text:null,color:null,author:null,onDelete:null,id:null},setup(t){const{author:e}=t;Iu(r=>({"0156c4d7":t.color}));const s=dt("user").uid===e,i=dt("board");return(r,o)=>{var a;return te(),Ee("li",{class:Vn({hidden:!s&&((a=Fe(i))==null?void 0:a.cardsHidden)})},[ce("button",{onClick:o[0]||(o[0]=l=>t.onDelete(t.id))},"\u2716"),mu(" "+gs(t.text),1)],2)}}});var Mb=Bt(Ob,[["__scopeId","data-v-a430bb28"]]);const Db=Ut({props:{title:null,color:null,boardId:null,columnId:null,cards:null},setup(t){const{columnId:e,boardId:n}=t;Iu(a=>({"62139bba":t.color}));const s=un({inputText:""}),i=dt("user");function r(a){a.preventDefault(),s.inputText.trim()!==""&&(!(i!=null&&i.uid)||(Rb(n,e,{text:s.inputText,author:i.uid}),s.inputText=""))}function o(a){Nb(n,e,a)}return(a,l)=>(te(),Ee("section",null,[ce("h2",null,gs(t.title),1),ce("ul",null,[(te(!0),Ee(de,null,bs(t.cards,(c,u)=>(te(),Mt(Mb,{id:u,author:c.author,text:c.text,color:t.color,onDelete:o},null,8,["id","author","text","color"]))),256))]),ce("form",{target:"#",onSubmit:r},[du(ce("input",{placeholder:"Add new card","onUpdate:modelValue":l[0]||(l[0]=c=>Fe(s).inputText=c)},null,512),[[wu,Fe(s).inputText]])],32)]))}});var Lb=Bt(Db,[["__scopeId","data-v-345fc8cf"]]);const Fb={class:"board"},Ub={class:"columns"},Bb={class:"options"},Wb=Ut({setup(t){const e=dt("board"),n=dt("boardId");function s(){Tb(n,!e.cardsHidden)}function i(){return e.cardsHidden?"Show all cards":"Hide other cards"}function r(c){c.key==="Enter"&&c.preventDefault()}function o(c){const u=(c==null?void 0:c.target).value.trim();Sb(n,u),l.value=u||"Untitled Retro"}function a(){l.value==="Untitled Retro"&&(l.value="")}const l=qc(e.title||"Untitled Retro");return(c,u)=>(te(),Ee(de,null,[ce("div",Fb,[du(ce("input",{class:Vn({untitled:l.value==="Untitled Retro"}),"onUpdate:modelValue":u[0]||(u[0]=h=>l.value=h),onKeypress:r,onFocusout:o,onFocusin:a},null,34),[[wu,l.value]]),ce("section",Ub,[(te(!0),Ee(de,null,bs(Fe(e).columns,(h,f)=>{var g;return te(),Mt(Lb,{cards:(g=h.cards)!=null?g:[],"column-id":String(f),"board-id":Fe(n),key:String(f),title:h.title,color:h.color},null,8,["cards","column-id","board-id","title","color"])}),128))])]),ce("section",Bb,[Ye(Pb,{"on-click":s,text:i()},null,8,["text"])])],64))}});var Hb=Bt(Wb,[["__scopeId","data-v-2a546d94"]]);const $b={},Vb={class:"loader"};function jb(t,e){return te(),Ee("div",Vb,"Loading...")}var qb=Bt($b,[["render",jb],["__scopeId","data-v-840bd5c8"]]);const zb={key:0},Kb={key:1},Gb={key:1},Yb=Ut({props:{boardId:null},setup(t){const{boardId:e}=t,n=wb(e);return li("boardId",e),li("board",n),(s,i)=>(te(),Ee(de,null,[Fe(n).loading?Ys("",!0):(te(),Ee("main",zb,[Fe(n).exists?(te(),Mt(Hb,{key:0})):Ys("",!0),Fe(n).exists?Ys("",!0):(te(),Ee("div",Kb,"Couldn't find board"))])),Fe(n).loading?(te(),Ee("main",Gb,[Ye(qb)])):Ys("",!0)],64))}});var Qb=Bt(Yb,[["__scopeId","data-v-b2bd279e"]]);const Jb={class:"columns"},Xb=Ut({props:{board:null,isTemplate:{type:Boolean}},setup(t){return(e,n)=>(te(),Ee("div",{class:Vn(["board",{template:t.isTemplate}]),onClick:n[0]||(n[0]=s=>e.$emit("click"))},[ce("h3",null,gs(t.board.title||"Untitled Retro"),1),ce("div",Jb,[(te(!0),Ee(de,null,bs(t.board.columns,s=>(te(),Ee("div",{class:"column",style:xi({backgroundColor:s.color})},gs(s.title),5))),256))])],2))}});var bc=Bt(Xb,[["__scopeId","data-v-e9104088"]]);const Zb=[{title:"Mad Sad Glad",columns:[{title:"Mad",color:"#f44336"},{title:"Sad",color:"#e91e63"},{title:"Glad",color:"#9c27b0"}]},{title:"Start Stop Continue",columns:[{title:"Start",color:"#2196f3"},{title:"Stop",color:"#ff9800"},{title:"Continue",color:"#009688"}]},{title:"Sailboat",columns:[{title:"What is the wind pushing our sails that make us go fast",color:"#f44336"},{title:"What anchors are holding us back",color:"#e91e63"},{title:"What rocks are ahead of us that risk our future",color:"#9c27b0"},{title:"What is our ideal island destination",color:"#673ab7"}]}];const Pa=t=>(Df("data-v-75b5d00f"),t=t(),Lf(),t),eC={class:"container"},tC=Pa(()=>ce("h1",null,"\u{1F680} quick retro \u{1F680}",-1)),nC=Pa(()=>ce("h2",null,"start a new board",-1)),sC=Pa(()=>ce("h2",null,"your boards",-1)),iC=Ut({props:{navigateToBoard:null},setup(t){const{navigateToBoard:e}=t,n=Ib(),s=dt("user"),i=bu(()=>Object.fromEntries(Object.entries(n).filter(([o,a])=>a.author===(s==null?void 0:s.uid))));async function r(o){if(!(s!=null&&s.uid))return;const a=await kb(s.uid,o);a&&e(a)}return(o,a)=>(te(),Ee("div",eC,[ce("main",null,[tC,nC,ce("section",null,[(te(!0),Ee(de,null,bs(Fe(Zb),l=>(te(),Mt(bc,{onClick:c=>r(l),board:l,"is-template":!0},null,8,["onClick","board"]))),256))]),sC,ce("section",null,[(te(!0),Ee(de,null,bs(Fe(i),(l,c)=>(te(),Mt(bc,{onClick:u=>t.navigateToBoard(c),board:l,"is-template":!1},null,8,["onClick","board"]))),256))])])]))}});var rC=Bt(iC,[["__scopeId","data-v-75b5d00f"]]);const oC=Ut({setup(t){const e=qc(window.location.hash.slice(1));console.log(window.location.hash);function n(i){history.pushState({},"",`#${i}`),e.value=i}addEventListener("popstate",()=>{e.value=window.location.hash.slice(1)});const s=Ab();return li("user",s),(i,r)=>e.value&&e.value.length>0?(te(),Mt(Qb,{key:0,boardId:e.value},null,8,["boardId"])):(te(),Mt(rC,{key:1,"navigate-to-board":n}))}});o_(oC).mount("#app");
