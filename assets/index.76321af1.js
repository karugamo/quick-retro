var b_=Object.defineProperty,y_=Object.defineProperties;var w_=Object.getOwnPropertyDescriptors;var hu=Object.getOwnPropertySymbols;var C_=Object.prototype.hasOwnProperty,E_=Object.prototype.propertyIsEnumerable;var fu=(t,e,n)=>e in t?b_(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,pu=(t,e)=>{for(var n in e||(e={}))C_.call(e,n)&&fu(t,n,e[n]);if(hu)for(var n of hu(e))E_.call(e,n)&&fu(t,n,e[n]);return t},gu=(t,e)=>y_(t,w_(e));var T_=(t,e)=>()=>(e||t((e={exports:{}}).exports,e),e.exports);var fN=T_((Et,Tt)=>{const I_=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerpolicy&&(s.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?s.credentials="include":i.crossorigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(i){if(i.ep)return;i.ep=!0;const s=n(i);fetch(i.href,s)}};I_();function $l(t,e){const n=Object.create(null),r=t.split(",");for(let i=0;i<r.length;i++)n[r[i]]=!0;return e?i=>!!n[i.toLowerCase()]:i=>!!n[i]}const S_="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",x_=$l(S_);function Dh(t){return!!t||t===""}function Ao(t){if(Q(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],i=Ze(r)?A_(r):Ao(r);if(i)for(const s in i)e[s]=i[s]}return e}else{if(Ze(t))return t;if(He(t))return t}}const R_=/;(?![^(]*\))/g,P_=/:(.+)/;function A_(t){const e={};return t.split(R_).forEach(n=>{if(n){const r=n.split(P_);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function Qr(t){let e="";if(Ze(t))e=t;else if(Q(t))for(let n=0;n<t.length;n++){const r=Qr(t[n]);r&&(e+=r+" ")}else if(He(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const Fr=t=>Ze(t)?t:t==null?"":Q(t)||He(t)&&(t.toString===Bh||!ne(t.toString))?JSON.stringify(t,Lh,2):String(t),Lh=(t,e)=>e&&e.__v_isRef?Lh(t,e.value):Ar(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,i])=>(n[`${r} =>`]=i,n),{})}:Fh(e)?{[`Set(${e.size})`]:[...e.values()]}:He(e)&&!Q(e)&&!Uh(e)?String(e):e,Re={},Pr=[],Dt=()=>{},N_=()=>!1,k_=/^on[^a-z]/,No=t=>k_.test(t),Bl=t=>t.startsWith("onUpdate:"),it=Object.assign,Ul=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},O_=Object.prototype.hasOwnProperty,pe=(t,e)=>O_.call(t,e),Q=Array.isArray,Ar=t=>ko(t)==="[object Map]",Fh=t=>ko(t)==="[object Set]",ne=t=>typeof t=="function",Ze=t=>typeof t=="string",Hl=t=>typeof t=="symbol",He=t=>t!==null&&typeof t=="object",$h=t=>He(t)&&ne(t.then)&&ne(t.catch),Bh=Object.prototype.toString,ko=t=>Bh.call(t),M_=t=>ko(t).slice(8,-1),Uh=t=>ko(t)==="[object Object]",zl=t=>Ze(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Ws=$l(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Oo=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},D_=/-(\w)/g,$r=Oo(t=>t.replace(D_,(e,n)=>n?n.toUpperCase():"")),L_=/\B([A-Z])/g,Zr=Oo(t=>t.replace(L_,"-$1").toLowerCase()),Hh=Oo(t=>t.charAt(0).toUpperCase()+t.slice(1)),_a=Oo(t=>t?`on${Hh(t)}`:""),Wi=(t,e)=>!Object.is(t,e),js=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},Zs=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},eo=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let mu;const F_=()=>mu||(mu=typeof globalThis!="undefined"?globalThis:typeof self!="undefined"?self:typeof window!="undefined"?window:typeof global!="undefined"?global:{});let Wt;class $_{constructor(e=!1){this.active=!0,this.effects=[],this.cleanups=[],!e&&Wt&&(this.parent=Wt,this.index=(Wt.scopes||(Wt.scopes=[])).push(this)-1)}run(e){if(this.active){const n=Wt;try{return Wt=this,e()}finally{Wt=n}}}on(){Wt=this}off(){Wt=this.parent}stop(e){if(this.active){let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.scopes)for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);if(this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.active=!1}}}function B_(t,e=Wt){e&&e.active&&e.effects.push(t)}const Wl=t=>{const e=new Set(t);return e.w=0,e.n=0,e},zh=t=>(t.w&Rn)>0,Wh=t=>(t.n&Rn)>0,U_=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=Rn},H_=t=>{const{deps:e}=t;if(e.length){let n=0;for(let r=0;r<e.length;r++){const i=e[r];zh(i)&&!Wh(i)?i.delete(t):e[n++]=i,i.w&=~Rn,i.n&=~Rn}e.length=n}},za=new WeakMap;let Ri=0,Rn=1;const Wa=30;let kt;const Qn=Symbol(""),ja=Symbol("");class jl{constructor(e,n=null,r){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,B_(this,r)}run(){if(!this.active)return this.fn();let e=kt,n=Cn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=kt,kt=this,Cn=!0,Rn=1<<++Ri,Ri<=Wa?U_(this):_u(this),this.fn()}finally{Ri<=Wa&&H_(this),Rn=1<<--Ri,kt=this.parent,Cn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){kt===this?this.deferStop=!0:this.active&&(_u(this),this.onStop&&this.onStop(),this.active=!1)}}function _u(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Cn=!0;const jh=[];function ei(){jh.push(Cn),Cn=!1}function ti(){const t=jh.pop();Cn=t===void 0?!0:t}function St(t,e,n){if(Cn&&kt){let r=za.get(t);r||za.set(t,r=new Map);let i=r.get(n);i||r.set(n,i=Wl()),Vh(i)}}function Vh(t,e){let n=!1;Ri<=Wa?Wh(t)||(t.n|=Rn,n=!zh(t)):n=!t.has(kt),n&&(t.add(kt),kt.deps.push(t))}function nn(t,e,n,r,i,s){const o=za.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&Q(t))o.forEach((l,c)=>{(c==="length"||c>=r)&&a.push(l)});else switch(n!==void 0&&a.push(o.get(n)),e){case"add":Q(t)?zl(n)&&a.push(o.get("length")):(a.push(o.get(Qn)),Ar(t)&&a.push(o.get(ja)));break;case"delete":Q(t)||(a.push(o.get(Qn)),Ar(t)&&a.push(o.get(ja)));break;case"set":Ar(t)&&a.push(o.get(Qn));break}if(a.length===1)a[0]&&Va(a[0]);else{const l=[];for(const c of a)c&&l.push(...c);Va(Wl(l))}}function Va(t,e){for(const n of Q(t)?t:[...t])(n!==kt||n.allowRecurse)&&(n.scheduler?n.scheduler():n.run())}const z_=$l("__proto__,__v_isRef,__isVue"),qh=new Set(Object.getOwnPropertyNames(Symbol).map(t=>Symbol[t]).filter(Hl)),W_=Vl(),j_=Vl(!1,!0),V_=Vl(!0),vu=q_();function q_(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const r=ve(this);for(let s=0,o=this.length;s<o;s++)St(r,"get",s+"");const i=r[e](...n);return i===-1||i===!1?r[e](...n.map(ve)):i}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){ei();const r=ve(this)[e].apply(this,n);return ti(),r}}),t}function Vl(t=!1,e=!1){return function(r,i,s){if(i==="__v_isReactive")return!t;if(i==="__v_isReadonly")return t;if(i==="__v_isShallow")return e;if(i==="__v_raw"&&s===(t?e?lv:Jh:e?Xh:Yh).get(r))return r;const o=Q(r);if(!t&&o&&pe(vu,i))return Reflect.get(vu,i,s);const a=Reflect.get(r,i,s);return(Hl(i)?qh.has(i):z_(i))||(t||St(r,"get",i),e)?a:Xe(a)?!o||!zl(i)?a.value:a:He(a)?t?Gl(a):gr(a):a}}const K_=Kh(),G_=Kh(!0);function Kh(t=!1){return function(n,r,i,s){let o=n[r];if(ji(o)&&Xe(o)&&!Xe(i))return!1;if(!t&&!ji(i)&&(Qh(i)||(i=ve(i),o=ve(o)),!Q(n)&&Xe(o)&&!Xe(i)))return o.value=i,!0;const a=Q(n)&&zl(r)?Number(r)<n.length:pe(n,r),l=Reflect.set(n,r,i,s);return n===ve(s)&&(a?Wi(i,o)&&nn(n,"set",r,i):nn(n,"add",r,i)),l}}function Y_(t,e){const n=pe(t,e);t[e];const r=Reflect.deleteProperty(t,e);return r&&n&&nn(t,"delete",e,void 0),r}function X_(t,e){const n=Reflect.has(t,e);return(!Hl(e)||!qh.has(e))&&St(t,"has",e),n}function J_(t){return St(t,"iterate",Q(t)?"length":Qn),Reflect.ownKeys(t)}const Gh={get:W_,set:K_,deleteProperty:Y_,has:X_,ownKeys:J_},Q_={get:V_,set(t,e){return!0},deleteProperty(t,e){return!0}},Z_=it({},Gh,{get:j_,set:G_}),ql=t=>t,Mo=t=>Reflect.getPrototypeOf(t);function Ss(t,e,n=!1,r=!1){t=t.__v_raw;const i=ve(t),s=ve(e);e!==s&&!n&&St(i,"get",e),!n&&St(i,"get",s);const{has:o}=Mo(i),a=r?ql:n?Xl:Vi;if(o.call(i,e))return a(t.get(e));if(o.call(i,s))return a(t.get(s));t!==i&&t.get(e)}function xs(t,e=!1){const n=this.__v_raw,r=ve(n),i=ve(t);return t!==i&&!e&&St(r,"has",t),!e&&St(r,"has",i),t===i?n.has(t):n.has(t)||n.has(i)}function Rs(t,e=!1){return t=t.__v_raw,!e&&St(ve(t),"iterate",Qn),Reflect.get(t,"size",t)}function bu(t){t=ve(t);const e=ve(this);return Mo(e).has.call(e,t)||(e.add(t),nn(e,"add",t,t)),this}function yu(t,e){e=ve(e);const n=ve(this),{has:r,get:i}=Mo(n);let s=r.call(n,t);s||(t=ve(t),s=r.call(n,t));const o=i.call(n,t);return n.set(t,e),s?Wi(e,o)&&nn(n,"set",t,e):nn(n,"add",t,e),this}function wu(t){const e=ve(this),{has:n,get:r}=Mo(e);let i=n.call(e,t);i||(t=ve(t),i=n.call(e,t)),r&&r.call(e,t);const s=e.delete(t);return i&&nn(e,"delete",t,void 0),s}function Cu(){const t=ve(this),e=t.size!==0,n=t.clear();return e&&nn(t,"clear",void 0,void 0),n}function Ps(t,e){return function(r,i){const s=this,o=s.__v_raw,a=ve(o),l=e?ql:t?Xl:Vi;return!t&&St(a,"iterate",Qn),o.forEach((c,u)=>r.call(i,l(c),l(u),s))}}function As(t,e,n){return function(...r){const i=this.__v_raw,s=ve(i),o=Ar(s),a=t==="entries"||t===Symbol.iterator&&o,l=t==="keys"&&o,c=i[t](...r),u=n?ql:e?Xl:Vi;return!e&&St(s,"iterate",l?ja:Qn),{next(){const{value:d,done:h}=c.next();return h?{value:d,done:h}:{value:a?[u(d[0]),u(d[1])]:u(d),done:h}},[Symbol.iterator](){return this}}}}function dn(t){return function(...e){return t==="delete"?!1:this}}function ev(){const t={get(s){return Ss(this,s)},get size(){return Rs(this)},has:xs,add:bu,set:yu,delete:wu,clear:Cu,forEach:Ps(!1,!1)},e={get(s){return Ss(this,s,!1,!0)},get size(){return Rs(this)},has:xs,add:bu,set:yu,delete:wu,clear:Cu,forEach:Ps(!1,!0)},n={get(s){return Ss(this,s,!0)},get size(){return Rs(this,!0)},has(s){return xs.call(this,s,!0)},add:dn("add"),set:dn("set"),delete:dn("delete"),clear:dn("clear"),forEach:Ps(!0,!1)},r={get(s){return Ss(this,s,!0,!0)},get size(){return Rs(this,!0)},has(s){return xs.call(this,s,!0)},add:dn("add"),set:dn("set"),delete:dn("delete"),clear:dn("clear"),forEach:Ps(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=As(s,!1,!1),n[s]=As(s,!0,!1),e[s]=As(s,!1,!0),r[s]=As(s,!0,!0)}),[t,n,e,r]}const[tv,nv,rv,iv]=ev();function Kl(t,e){const n=e?t?iv:rv:t?nv:tv;return(r,i,s)=>i==="__v_isReactive"?!t:i==="__v_isReadonly"?t:i==="__v_raw"?r:Reflect.get(pe(n,i)&&i in r?n:r,i,s)}const sv={get:Kl(!1,!1)},ov={get:Kl(!1,!0)},av={get:Kl(!0,!1)},Yh=new WeakMap,Xh=new WeakMap,Jh=new WeakMap,lv=new WeakMap;function cv(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function uv(t){return t.__v_skip||!Object.isExtensible(t)?0:cv(M_(t))}function gr(t){return ji(t)?t:Yl(t,!1,Gh,sv,Yh)}function dv(t){return Yl(t,!1,Z_,ov,Xh)}function Gl(t){return Yl(t,!0,Q_,av,Jh)}function Yl(t,e,n,r,i){if(!He(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const s=i.get(t);if(s)return s;const o=uv(t);if(o===0)return t;const a=new Proxy(t,o===2?r:n);return i.set(t,a),a}function Nr(t){return ji(t)?Nr(t.__v_raw):!!(t&&t.__v_isReactive)}function ji(t){return!!(t&&t.__v_isReadonly)}function Qh(t){return!!(t&&t.__v_isShallow)}function Zh(t){return Nr(t)||ji(t)}function ve(t){const e=t&&t.__v_raw;return e?ve(e):t}function ef(t){return Zs(t,"__v_skip",!0),t}const Vi=t=>He(t)?gr(t):t,Xl=t=>He(t)?Gl(t):t;function tf(t){Cn&&kt&&(t=ve(t),Vh(t.dep||(t.dep=Wl())))}function nf(t,e){t=ve(t),t.dep&&Va(t.dep)}function Xe(t){return!!(t&&t.__v_isRef===!0)}function he(t){return hv(t,!1)}function hv(t,e){return Xe(t)?t:new fv(t,e)}class fv{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:ve(e),this._value=n?e:Vi(e)}get value(){return tf(this),this._value}set value(e){e=this.__v_isShallow?e:ve(e),Wi(e,this._rawValue)&&(this._rawValue=e,this._value=this.__v_isShallow?e:Vi(e),nf(this))}}function Ct(t){return Xe(t)?t.value:t}const pv={get:(t,e,n)=>Ct(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const i=t[e];return Xe(i)&&!Xe(n)?(i.value=n,!0):Reflect.set(t,e,n,r)}};function rf(t){return Nr(t)?t:new Proxy(t,pv)}class gv{constructor(e,n,r){this._object=e,this._key=n,this._defaultValue=r,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}}function Do(t,e,n){const r=t[e];return Xe(r)?r:new gv(t,e,n)}class mv{constructor(e,n,r,i){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this._dirty=!0,this.effect=new jl(e,()=>{this._dirty||(this._dirty=!0,nf(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!i,this.__v_isReadonly=r}get value(){const e=ve(this);return tf(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function _v(t,e,n=!1){let r,i;const s=ne(t);return s?(r=t,i=Dt):(r=t.get,i=t.set),new mv(r,i,s||!i,n)}function En(t,e,n,r){let i;try{i=r?t(...r):t()}catch(s){Lo(s,e,n)}return i}function At(t,e,n,r){if(ne(t)){const s=En(t,e,n,r);return s&&$h(s)&&s.catch(o=>{Lo(o,e,n)}),s}const i=[];for(let s=0;s<t.length;s++)i.push(At(t[s],e,n,r));return i}function Lo(t,e,n,r=!0){const i=e?e.vnode:null;if(e){let s=e.parent;const o=e.proxy,a=n;for(;s;){const c=s.ec;if(c){for(let u=0;u<c.length;u++)if(c[u](t,o,a)===!1)return}s=s.parent}const l=e.appContext.config.errorHandler;if(l){En(l,null,10,[t,o,a]);return}}vv(t,n,i,r)}function vv(t,e,n,r=!0){console.error(t)}let to=!1,qa=!1;const wt=[];let Jt=0;const ki=[];let Pi=null,Tr=0;const Oi=[];let gn=null,Ir=0;const sf=Promise.resolve();let Jl=null,Ka=null;function of(t){const e=Jl||sf;return t?e.then(this?t.bind(this):t):e}function bv(t){let e=Jt+1,n=wt.length;for(;e<n;){const r=e+n>>>1;qi(wt[r])<t?e=r+1:n=r}return e}function af(t){(!wt.length||!wt.includes(t,to&&t.allowRecurse?Jt+1:Jt))&&t!==Ka&&(t.id==null?wt.push(t):wt.splice(bv(t.id),0,t),lf())}function lf(){!to&&!qa&&(qa=!0,Jl=sf.then(df))}function yv(t){const e=wt.indexOf(t);e>Jt&&wt.splice(e,1)}function cf(t,e,n,r){Q(t)?n.push(...t):(!e||!e.includes(t,t.allowRecurse?r+1:r))&&n.push(t),lf()}function wv(t){cf(t,Pi,ki,Tr)}function Cv(t){cf(t,gn,Oi,Ir)}function Ql(t,e=null){if(ki.length){for(Ka=e,Pi=[...new Set(ki)],ki.length=0,Tr=0;Tr<Pi.length;Tr++)Pi[Tr]();Pi=null,Tr=0,Ka=null,Ql(t,e)}}function uf(t){if(Oi.length){const e=[...new Set(Oi)];if(Oi.length=0,gn){gn.push(...e);return}for(gn=e,gn.sort((n,r)=>qi(n)-qi(r)),Ir=0;Ir<gn.length;Ir++)gn[Ir]();gn=null,Ir=0}}const qi=t=>t.id==null?1/0:t.id;function df(t){qa=!1,to=!0,Ql(t),wt.sort((n,r)=>qi(n)-qi(r));const e=Dt;try{for(Jt=0;Jt<wt.length;Jt++){const n=wt[Jt];n&&n.active!==!1&&En(n,null,14)}}finally{Jt=0,wt.length=0,uf(),to=!1,Jl=null,(wt.length||ki.length||Oi.length)&&df(t)}}function Ev(t,e,...n){if(t.isUnmounted)return;const r=t.vnode.props||Re;let i=n;const s=e.startsWith("update:"),o=s&&e.slice(7);if(o&&o in r){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:d,trim:h}=r[u]||Re;h?i=n.map(_=>_.trim()):d&&(i=n.map(eo))}let a,l=r[a=_a(e)]||r[a=_a($r(e))];!l&&s&&(l=r[a=_a(Zr(e))]),l&&At(l,t,6,i);const c=r[a+"Once"];if(c){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,At(c,t,6,i)}}function hf(t,e,n=!1){const r=e.emitsCache,i=r.get(t);if(i!==void 0)return i;const s=t.emits;let o={},a=!1;if(!ne(t)){const l=c=>{const u=hf(c,e,!0);u&&(a=!0,it(o,u))};!n&&e.mixins.length&&e.mixins.forEach(l),t.extends&&l(t.extends),t.mixins&&t.mixins.forEach(l)}return!s&&!a?(r.set(t,null),null):(Q(s)?s.forEach(l=>o[l]=null):it(o,s),r.set(t,o),o)}function Fo(t,e){return!t||!No(e)?!1:(e=e.slice(2).replace(/Once$/,""),pe(t,e[0].toLowerCase()+e.slice(1))||pe(t,Zr(e))||pe(t,e))}let ft=null,$o=null;function no(t){const e=ft;return ft=t,$o=t&&t.type.__scopeId||null,e}function Tv(t){$o=t}function Iv(){$o=null}function Zl(t,e=ft,n){if(!e||t._n)return t;const r=(...i)=>{r._d&&ku(-1);const s=no(e),o=t(...i);return no(s),r._d&&ku(1),o};return r._n=!0,r._c=!0,r._d=!0,r}function va(t){const{type:e,vnode:n,proxy:r,withProxy:i,props:s,propsOptions:[o],slots:a,attrs:l,emit:c,render:u,renderCache:d,data:h,setupState:_,ctx:g,inheritAttrs:C}=t;let b,O;const H=no(t);try{if(n.shapeFlag&4){const z=i||r;b=jt(u.call(z,z,d,s,_,h,g)),O=l}else{const z=e;b=jt(z.length>1?z(s,{attrs:l,slots:a,emit:c}):z(s,null)),O=e.props?l:Sv(l)}}catch(z){Mi.length=0,Lo(z,t,1),b=Qe(It)}let V=b;if(O&&C!==!1){const z=Object.keys(O),{shapeFlag:X}=V;z.length&&X&7&&(o&&z.some(Bl)&&(O=xv(O,o)),V=sr(V,O))}return n.dirs&&(V.dirs=V.dirs?V.dirs.concat(n.dirs):n.dirs),n.transition&&(V.transition=n.transition),b=V,no(H),b}const Sv=t=>{let e;for(const n in t)(n==="class"||n==="style"||No(n))&&((e||(e={}))[n]=t[n]);return e},xv=(t,e)=>{const n={};for(const r in t)(!Bl(r)||!(r.slice(9)in e))&&(n[r]=t[r]);return n};function Rv(t,e,n){const{props:r,children:i,component:s}=t,{props:o,children:a,patchFlag:l}=e,c=s.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&l>=0){if(l&1024)return!0;if(l&16)return r?Eu(r,o,c):!!o;if(l&8){const u=e.dynamicProps;for(let d=0;d<u.length;d++){const h=u[d];if(o[h]!==r[h]&&!Fo(c,h))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:r===o?!1:r?o?Eu(r,o,c):!0:!!o;return!1}function Eu(t,e,n){const r=Object.keys(e);if(r.length!==Object.keys(t).length)return!0;for(let i=0;i<r.length;i++){const s=r[i];if(e[s]!==t[s]&&!Fo(n,s))return!0}return!1}function Pv({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const Av=t=>t.__isSuspense;function Nv(t,e){e&&e.pendingBranch?Q(t)?e.effects.push(...t):e.effects.push(t):Cv(t)}function Br(t,e){if(rt){let n=rt.provides;const r=rt.parent&&rt.parent.provides;r===n&&(n=rt.provides=Object.create(r)),n[t]=e}}function qe(t,e,n=!1){const r=rt||ft;if(r){const i=r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides;if(i&&t in i)return i[t];if(arguments.length>1)return n&&ne(e)?e.call(r.proxy):e}}function Ur(t,e){return Bo(t,null,e)}function kv(t,e){return Bo(t,null,{flush:"post"})}const Tu={};function Tn(t,e,n){return Bo(t,e,n)}function Bo(t,e,{immediate:n,deep:r,flush:i,onTrack:s,onTrigger:o}=Re){const a=rt;let l,c=!1,u=!1;if(Xe(t)?(l=()=>t.value,c=Qh(t)):Nr(t)?(l=()=>t,r=!0):Q(t)?(u=!0,c=t.some(Nr),l=()=>t.map(O=>{if(Xe(O))return O.value;if(Nr(O))return qn(O);if(ne(O))return En(O,a,2)})):ne(t)?e?l=()=>En(t,a,2):l=()=>{if(!(a&&a.isUnmounted))return d&&d(),At(t,a,3,[h])}:l=Dt,e&&r){const O=l;l=()=>qn(O())}let d,h=O=>{d=b.onStop=()=>{En(O,a,4)}};if(Yi)return h=Dt,e?n&&At(e,a,3,[l(),u?[]:void 0,h]):l(),Dt;let _=u?[]:Tu;const g=()=>{if(!!b.active)if(e){const O=b.run();(r||c||(u?O.some((H,V)=>Wi(H,_[V])):Wi(O,_)))&&(d&&d(),At(e,a,3,[O,_===Tu?void 0:_,h]),_=O)}else b.run()};g.allowRecurse=!!e;let C;i==="sync"?C=g:i==="post"?C=()=>vt(g,a&&a.suspense):C=()=>{!a||a.isMounted?wv(g):g()};const b=new jl(l,C);return e?n?g():_=b.run():i==="post"?vt(b.run.bind(b),a&&a.suspense):b.run(),()=>{b.stop(),a&&a.scope&&Ul(a.scope.effects,b)}}function Ov(t,e,n){const r=this.proxy,i=Ze(t)?t.includes(".")?ff(r,t):()=>r[t]:t.bind(r,r);let s;ne(e)?s=e:(s=e.handler,n=e);const o=rt;Hr(this);const a=Bo(i,s.bind(r),n);return o?Hr(o):er(),a}function ff(t,e){const n=e.split(".");return()=>{let r=t;for(let i=0;i<n.length&&r;i++)r=r[n[i]];return r}}function qn(t,e){if(!He(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),Xe(t))qn(t.value,e);else if(Q(t))for(let n=0;n<t.length;n++)qn(t[n],e);else if(Fh(t)||Ar(t))t.forEach(n=>{qn(n,e)});else if(Uh(t))for(const n in t)qn(t[n],e);return t}function Mv(){const t={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ni(()=>{t.isMounted=!0}),Wo(()=>{t.isUnmounting=!0}),t}const Rt=[Function,Array],Dv={name:"BaseTransition",props:{mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Rt,onEnter:Rt,onAfterEnter:Rt,onEnterCancelled:Rt,onBeforeLeave:Rt,onLeave:Rt,onAfterLeave:Rt,onLeaveCancelled:Rt,onBeforeAppear:Rt,onAppear:Rt,onAfterAppear:Rt,onAppearCancelled:Rt},setup(t,{slots:e}){const n=ic(),r=Mv();let i;return()=>{const s=e.default&&mf(e.default(),!0);if(!s||!s.length)return;let o=s[0];if(s.length>1){for(const C of s)if(C.type!==It){o=C;break}}const a=ve(t),{mode:l}=a;if(r.isLeaving)return ba(o);const c=Iu(o);if(!c)return ba(o);const u=Ga(c,a,r,n);Ya(c,u);const d=n.subTree,h=d&&Iu(d);let _=!1;const{getTransitionKey:g}=c.type;if(g){const C=g();i===void 0?i=C:C!==i&&(i=C,_=!0)}if(h&&h.type!==It&&(!jn(c,h)||_)){const C=Ga(h,a,r,n);if(Ya(h,C),l==="out-in")return r.isLeaving=!0,C.afterLeave=()=>{r.isLeaving=!1,n.update()},ba(o);l==="in-out"&&c.type!==It&&(C.delayLeave=(b,O,H)=>{const V=gf(r,h);V[String(h.key)]=h,b._leaveCb=()=>{O(),b._leaveCb=void 0,delete u.delayedLeave},u.delayedLeave=H})}return o}}},pf=Dv;function gf(t,e){const{leavingVNodes:n}=t;let r=n.get(e.type);return r||(r=Object.create(null),n.set(e.type,r)),r}function Ga(t,e,n,r){const{appear:i,mode:s,persisted:o=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:c,onEnterCancelled:u,onBeforeLeave:d,onLeave:h,onAfterLeave:_,onLeaveCancelled:g,onBeforeAppear:C,onAppear:b,onAfterAppear:O,onAppearCancelled:H}=e,V=String(t.key),z=gf(n,t),X=(E,S)=>{E&&At(E,r,9,S)},me={mode:s,persisted:o,beforeEnter(E){let S=a;if(!n.isMounted)if(i)S=C||a;else return;E._leaveCb&&E._leaveCb(!0);const D=z[V];D&&jn(t,D)&&D.el._leaveCb&&D.el._leaveCb(),X(S,[E])},enter(E){let S=l,D=c,q=u;if(!n.isMounted)if(i)S=b||l,D=O||c,q=H||u;else return;let Z=!1;const L=E._enterCb=re=>{Z||(Z=!0,re?X(q,[E]):X(D,[E]),me.delayedLeave&&me.delayedLeave(),E._enterCb=void 0)};S?(S(E,L),S.length<=1&&L()):L()},leave(E,S){const D=String(t.key);if(E._enterCb&&E._enterCb(!0),n.isUnmounting)return S();X(d,[E]);let q=!1;const Z=E._leaveCb=L=>{q||(q=!0,S(),L?X(g,[E]):X(_,[E]),E._leaveCb=void 0,z[D]===t&&delete z[D])};z[D]=t,h?(h(E,Z),h.length<=1&&Z()):Z()},clone(E){return Ga(E,e,n,r)}};return me}function ba(t){if(Uo(t))return t=sr(t),t.children=null,t}function Iu(t){return Uo(t)?t.children?t.children[0]:void 0:t}function Ya(t,e){t.shapeFlag&6&&t.component?Ya(t.component.subTree,e):t.shapeFlag&128?(t.ssContent.transition=e.clone(t.ssContent),t.ssFallback.transition=e.clone(t.ssFallback)):t.transition=e}function mf(t,e=!1,n){let r=[],i=0;for(let s=0;s<t.length;s++){let o=t[s];const a=n==null?o.key:String(n)+String(o.key!=null?o.key:s);o.type===Le?(o.patchFlag&128&&i++,r=r.concat(mf(o.children,e,a))):(e||o.type!==It)&&r.push(a!=null?sr(o,{key:a}):o)}if(i>1)for(let s=0;s<r.length;s++)r[s].patchFlag=-2;return r}function Be(t){return ne(t)?{setup:t,name:t.name}:t}const ro=t=>!!t.type.__asyncLoader,Uo=t=>t.type.__isKeepAlive;function Lv(t,e){_f(t,"a",e)}function Fv(t,e){_f(t,"da",e)}function _f(t,e,n=rt){const r=t.__wdc||(t.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return t()});if(Ho(e,r,n),n){let i=n.parent;for(;i&&i.parent;)Uo(i.parent.vnode)&&$v(r,e,n,i),i=i.parent}}function $v(t,e,n,r){const i=Ho(e,t,r,!0);ec(()=>{Ul(r[e],i)},n)}function Ho(t,e,n=rt,r=!1){if(n){const i=n[t]||(n[t]=[]),s=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;ei(),Hr(n);const a=At(e,n,t,o);return er(),ti(),a});return r?i.unshift(s):i.push(s),s}}const on=t=>(e,n=rt)=>(!Yi||t==="sp")&&Ho(t,e,n),zo=on("bm"),ni=on("m"),Bv=on("bu"),Uv=on("u"),Wo=on("bum"),ec=on("um"),Hv=on("sp"),zv=on("rtg"),Wv=on("rtc");function jv(t,e=rt){Ho("ec",t,e)}let Xa=!0;function Vv(t){const e=bf(t),n=t.proxy,r=t.ctx;Xa=!1,e.beforeCreate&&Su(e.beforeCreate,t,"bc");const{data:i,computed:s,methods:o,watch:a,provide:l,inject:c,created:u,beforeMount:d,mounted:h,beforeUpdate:_,updated:g,activated:C,deactivated:b,beforeDestroy:O,beforeUnmount:H,destroyed:V,unmounted:z,render:X,renderTracked:me,renderTriggered:E,errorCaptured:S,serverPrefetch:D,expose:q,inheritAttrs:Z,components:L,directives:re,filters:ye}=e;if(c&&qv(c,r,null,t.appContext.config.unwrapInjectedRef),o)for(const fe in o){const ie=o[fe];ne(ie)&&(r[fe]=ie.bind(n))}if(i){const fe=i.call(n,n);He(fe)&&(t.data=gr(fe))}if(Xa=!0,s)for(const fe in s){const ie=s[fe],Ue=ne(ie)?ie.bind(n,n):ne(ie.get)?ie.get.bind(n,n):Dt,mt=!ne(ie)&&ne(ie.set)?ie.set.bind(n):Dt,Me=de({get:Ue,set:mt});Object.defineProperty(r,fe,{enumerable:!0,configurable:!0,get:()=>Me.value,set:ct=>Me.value=ct})}if(a)for(const fe in a)vf(a[fe],r,n,fe);if(l){const fe=ne(l)?l.call(n):l;Reflect.ownKeys(fe).forEach(ie=>{Br(ie,fe[ie])})}u&&Su(u,t,"c");function ce(fe,ie){Q(ie)?ie.forEach(Ue=>fe(Ue.bind(n))):ie&&fe(ie.bind(n))}if(ce(zo,d),ce(ni,h),ce(Bv,_),ce(Uv,g),ce(Lv,C),ce(Fv,b),ce(jv,S),ce(Wv,me),ce(zv,E),ce(Wo,H),ce(ec,z),ce(Hv,D),Q(q))if(q.length){const fe=t.exposed||(t.exposed={});q.forEach(ie=>{Object.defineProperty(fe,ie,{get:()=>n[ie],set:Ue=>n[ie]=Ue})})}else t.exposed||(t.exposed={});X&&t.render===Dt&&(t.render=X),Z!=null&&(t.inheritAttrs=Z),L&&(t.components=L),re&&(t.directives=re)}function qv(t,e,n=Dt,r=!1){Q(t)&&(t=Ja(t));for(const i in t){const s=t[i];let o;He(s)?"default"in s?o=qe(s.from||i,s.default,!0):o=qe(s.from||i):o=qe(s),Xe(o)&&r?Object.defineProperty(e,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:a=>o.value=a}):e[i]=o}}function Su(t,e,n){At(Q(t)?t.map(r=>r.bind(e.proxy)):t.bind(e.proxy),e,n)}function vf(t,e,n,r){const i=r.includes(".")?ff(n,r):()=>n[r];if(Ze(t)){const s=e[t];ne(s)&&Tn(i,s)}else if(ne(t))Tn(i,t.bind(n));else if(He(t))if(Q(t))t.forEach(s=>vf(s,e,n,r));else{const s=ne(t.handler)?t.handler.bind(n):e[t.handler];ne(s)&&Tn(i,s,t)}}function bf(t){const e=t.type,{mixins:n,extends:r}=e,{mixins:i,optionsCache:s,config:{optionMergeStrategies:o}}=t.appContext,a=s.get(e);let l;return a?l=a:!i.length&&!n&&!r?l=e:(l={},i.length&&i.forEach(c=>io(l,c,o,!0)),io(l,e,o)),s.set(e,l),l}function io(t,e,n,r=!1){const{mixins:i,extends:s}=e;s&&io(t,s,n,!0),i&&i.forEach(o=>io(t,o,n,!0));for(const o in e)if(!(r&&o==="expose")){const a=Kv[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const Kv={data:xu,props:Hn,emits:Hn,methods:Hn,computed:Hn,beforeCreate:dt,created:dt,beforeMount:dt,mounted:dt,beforeUpdate:dt,updated:dt,beforeDestroy:dt,beforeUnmount:dt,destroyed:dt,unmounted:dt,activated:dt,deactivated:dt,errorCaptured:dt,serverPrefetch:dt,components:Hn,directives:Hn,watch:Yv,provide:xu,inject:Gv};function xu(t,e){return e?t?function(){return it(ne(t)?t.call(this,this):t,ne(e)?e.call(this,this):e)}:e:t}function Gv(t,e){return Hn(Ja(t),Ja(e))}function Ja(t){if(Q(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function dt(t,e){return t?[...new Set([].concat(t,e))]:e}function Hn(t,e){return t?it(it(Object.create(null),t),e):e}function Yv(t,e){if(!t)return e;if(!e)return t;const n=it(Object.create(null),t);for(const r in e)n[r]=dt(t[r],e[r]);return n}function Xv(t,e,n,r=!1){const i={},s={};Zs(s,jo,1),t.propsDefaults=Object.create(null),yf(t,e,i,s);for(const o in t.propsOptions[0])o in i||(i[o]=void 0);n?t.props=r?i:dv(i):t.type.props?t.props=i:t.props=s,t.attrs=s}function Jv(t,e,n,r){const{props:i,attrs:s,vnode:{patchFlag:o}}=t,a=ve(i),[l]=t.propsOptions;let c=!1;if((r||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let d=0;d<u.length;d++){let h=u[d];if(Fo(t.emitsOptions,h))continue;const _=e[h];if(l)if(pe(s,h))_!==s[h]&&(s[h]=_,c=!0);else{const g=$r(h);i[g]=Qa(l,a,g,_,t,!1)}else _!==s[h]&&(s[h]=_,c=!0)}}}else{yf(t,e,i,s)&&(c=!0);let u;for(const d in a)(!e||!pe(e,d)&&((u=Zr(d))===d||!pe(e,u)))&&(l?n&&(n[d]!==void 0||n[u]!==void 0)&&(i[d]=Qa(l,a,d,void 0,t,!0)):delete i[d]);if(s!==a)for(const d in s)(!e||!pe(e,d)&&!0)&&(delete s[d],c=!0)}c&&nn(t,"set","$attrs")}function yf(t,e,n,r){const[i,s]=t.propsOptions;let o=!1,a;if(e)for(let l in e){if(Ws(l))continue;const c=e[l];let u;i&&pe(i,u=$r(l))?!s||!s.includes(u)?n[u]=c:(a||(a={}))[u]=c:Fo(t.emitsOptions,l)||(!(l in r)||c!==r[l])&&(r[l]=c,o=!0)}if(s){const l=ve(n),c=a||Re;for(let u=0;u<s.length;u++){const d=s[u];n[d]=Qa(i,l,d,c[d],t,!pe(c,d))}}return o}function Qa(t,e,n,r,i,s){const o=t[n];if(o!=null){const a=pe(o,"default");if(a&&r===void 0){const l=o.default;if(o.type!==Function&&ne(l)){const{propsDefaults:c}=i;n in c?r=c[n]:(Hr(i),r=c[n]=l.call(null,e),er())}else r=l}o[0]&&(s&&!a?r=!1:o[1]&&(r===""||r===Zr(n))&&(r=!0))}return r}function wf(t,e,n=!1){const r=e.propsCache,i=r.get(t);if(i)return i;const s=t.props,o={},a=[];let l=!1;if(!ne(t)){const u=d=>{l=!0;const[h,_]=wf(d,e,!0);it(o,h),_&&a.push(..._)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!s&&!l)return r.set(t,Pr),Pr;if(Q(s))for(let u=0;u<s.length;u++){const d=$r(s[u]);Ru(d)&&(o[d]=Re)}else if(s)for(const u in s){const d=$r(u);if(Ru(d)){const h=s[u],_=o[d]=Q(h)||ne(h)?{type:h}:h;if(_){const g=Nu(Boolean,_.type),C=Nu(String,_.type);_[0]=g>-1,_[1]=C<0||g<C,(g>-1||pe(_,"default"))&&a.push(d)}}}const c=[o,a];return r.set(t,c),c}function Ru(t){return t[0]!=="$"}function Pu(t){const e=t&&t.toString().match(/^\s*function (\w+)/);return e?e[1]:t===null?"null":""}function Au(t,e){return Pu(t)===Pu(e)}function Nu(t,e){return Q(e)?e.findIndex(n=>Au(n,t)):ne(e)&&Au(e,t)?0:-1}const Cf=t=>t[0]==="_"||t==="$stable",tc=t=>Q(t)?t.map(jt):[jt(t)],Qv=(t,e,n)=>{const r=Zl((...i)=>tc(e(...i)),n);return r._c=!1,r},Ef=(t,e,n)=>{const r=t._ctx;for(const i in t){if(Cf(i))continue;const s=t[i];if(ne(s))e[i]=Qv(i,s,r);else if(s!=null){const o=tc(s);e[i]=()=>o}}},Tf=(t,e)=>{const n=tc(e);t.slots.default=()=>n},Zv=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=ve(e),Zs(e,"_",n)):Ef(e,t.slots={})}else t.slots={},e&&Tf(t,e);Zs(t.slots,jo,1)},eb=(t,e,n)=>{const{vnode:r,slots:i}=t;let s=!0,o=Re;if(r.shapeFlag&32){const a=e._;a?n&&a===1?s=!1:(it(i,e),!n&&a===1&&delete i._):(s=!e.$stable,Ef(e,i)),o=e}else e&&(Tf(t,e),o={default:1});if(s)for(const a in i)!Cf(a)&&!(a in o)&&delete i[a]};function tb(t,e){const n=ft;if(n===null)return t;const r=qo(n)||n.proxy,i=t.dirs||(t.dirs=[]);for(let s=0;s<e.length;s++){let[o,a,l,c=Re]=e[s];ne(o)&&(o={mounted:o,updated:o}),o.deep&&qn(a),i.push({dir:o,instance:r,value:a,oldValue:void 0,arg:l,modifiers:c})}return t}function $n(t,e,n,r){const i=t.dirs,s=e&&e.dirs;for(let o=0;o<i.length;o++){const a=i[o];s&&(a.oldValue=s[o].value);let l=a.dir[r];l&&(ei(),At(l,n,8,[t.el,a,t,e]),ti())}}function If(){return{app:null,config:{isNativeTag:N_,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let nb=0;function rb(t,e){return function(r,i=null){ne(r)||(r=Object.assign({},r)),i!=null&&!He(i)&&(i=null);const s=If(),o=new Set;let a=!1;const l=s.app={_uid:nb++,_component:r,_props:i,_container:null,_context:s,_instance:null,version:Cb,get config(){return s.config},set config(c){},use(c,...u){return o.has(c)||(c&&ne(c.install)?(o.add(c),c.install(l,...u)):ne(c)&&(o.add(c),c(l,...u))),l},mixin(c){return s.mixins.includes(c)||s.mixins.push(c),l},component(c,u){return u?(s.components[c]=u,l):s.components[c]},directive(c,u){return u?(s.directives[c]=u,l):s.directives[c]},mount(c,u,d){if(!a){const h=Qe(r,i);return h.appContext=s,u&&e?e(h,c):t(h,c,d),a=!0,l._container=c,c.__vue_app__=l,qo(h.component)||h.component.proxy}},unmount(){a&&(t(null,l._container),delete l._container.__vue_app__)},provide(c,u){return s.provides[c]=u,l}};return l}}function Za(t,e,n,r,i=!1){if(Q(t)){t.forEach((h,_)=>Za(h,e&&(Q(e)?e[_]:e),n,r,i));return}if(ro(r)&&!i)return;const s=r.shapeFlag&4?qo(r.component)||r.component.proxy:r.el,o=i?null:s,{i:a,r:l}=t,c=e&&e.r,u=a.refs===Re?a.refs={}:a.refs,d=a.setupState;if(c!=null&&c!==l&&(Ze(c)?(u[c]=null,pe(d,c)&&(d[c]=null)):Xe(c)&&(c.value=null)),ne(l))En(l,a,12,[o,u]);else{const h=Ze(l),_=Xe(l);if(h||_){const g=()=>{if(t.f){const C=h?u[l]:l.value;i?Q(C)&&Ul(C,s):Q(C)?C.includes(s)||C.push(s):h?(u[l]=[s],pe(d,l)&&(d[l]=u[l])):(l.value=[s],t.k&&(u[t.k]=l.value))}else h?(u[l]=o,pe(d,l)&&(d[l]=o)):Xe(l)&&(l.value=o,t.k&&(u[t.k]=o))};o?(g.id=-1,vt(g,n)):g()}}}const vt=Nv;function ib(t){return sb(t)}function sb(t,e){const n=F_();n.__VUE__=!0;const{insert:r,remove:i,patchProp:s,createElement:o,createText:a,createComment:l,setText:c,setElementText:u,parentNode:d,nextSibling:h,setScopeId:_=Dt,cloneNode:g,insertStaticContent:C}=t,b=(f,p,v,y=null,w=null,A=null,M=!1,R=null,N=!!p.dynamicChildren)=>{if(f===p)return;f&&!jn(f,p)&&(y=cn(f),ut(f,w,A,!0),f=null),p.patchFlag===-2&&(N=!1,p.dynamicChildren=null);const{type:T,ref:U,shapeFlag:$}=p;switch(T){case nc:O(f,p,v,y);break;case It:H(f,p,v,y);break;case Vs:f==null&&V(p,v,y,M);break;case Le:re(f,p,v,y,w,A,M,R,N);break;default:$&1?me(f,p,v,y,w,A,M,R,N):$&6?ye(f,p,v,y,w,A,M,R,N):($&64||$&128)&&T.process(f,p,v,y,w,A,M,R,N,xt)}U!=null&&w&&Za(U,f&&f.ref,A,p||f,!p)},O=(f,p,v,y)=>{if(f==null)r(p.el=a(p.children),v,y);else{const w=p.el=f.el;p.children!==f.children&&c(w,p.children)}},H=(f,p,v,y)=>{f==null?r(p.el=l(p.children||""),v,y):p.el=f.el},V=(f,p,v,y)=>{[f.el,f.anchor]=C(f.children,p,v,y,f.el,f.anchor)},z=({el:f,anchor:p},v,y)=>{let w;for(;f&&f!==p;)w=h(f),r(f,v,y),f=w;r(p,v,y)},X=({el:f,anchor:p})=>{let v;for(;f&&f!==p;)v=h(f),i(f),f=v;i(p)},me=(f,p,v,y,w,A,M,R,N)=>{M=M||p.type==="svg",f==null?E(p,v,y,w,A,M,R,N):q(f,p,w,A,M,R,N)},E=(f,p,v,y,w,A,M,R)=>{let N,T;const{type:U,props:$,shapeFlag:B,transition:K,patchFlag:ae,dirs:we}=f;if(f.el&&g!==void 0&&ae===-1)N=f.el=g(f.el);else{if(N=f.el=o(f.type,A,$&&$.is,$),B&8?u(N,f.children):B&16&&D(f.children,N,null,y,w,A&&U!=="foreignObject",M,R),we&&$n(f,null,y,"created"),$){for(const Ce in $)Ce!=="value"&&!Ws(Ce)&&s(N,Ce,null,$[Ce],A,f.children,y,w,Ke);"value"in $&&s(N,"value",null,$.value),(T=$.onVnodeBeforeMount)&&Ht(T,y,f)}S(N,f,f.scopeId,M,y)}we&&$n(f,null,y,"beforeMount");const ue=(!w||w&&!w.pendingBranch)&&K&&!K.persisted;ue&&K.beforeEnter(N),r(N,p,v),((T=$&&$.onVnodeMounted)||ue||we)&&vt(()=>{T&&Ht(T,y,f),ue&&K.enter(N),we&&$n(f,null,y,"mounted")},w)},S=(f,p,v,y,w)=>{if(v&&_(f,v),y)for(let A=0;A<y.length;A++)_(f,y[A]);if(w){let A=w.subTree;if(p===A){const M=w.vnode;S(f,M,M.scopeId,M.slotScopeIds,w.parent)}}},D=(f,p,v,y,w,A,M,R,N=0)=>{for(let T=N;T<f.length;T++){const U=f[T]=R?mn(f[T]):jt(f[T]);b(null,U,p,v,y,w,A,M,R)}},q=(f,p,v,y,w,A,M)=>{const R=p.el=f.el;let{patchFlag:N,dynamicChildren:T,dirs:U}=p;N|=f.patchFlag&16;const $=f.props||Re,B=p.props||Re;let K;v&&Bn(v,!1),(K=B.onVnodeBeforeUpdate)&&Ht(K,v,p,f),U&&$n(p,f,v,"beforeUpdate"),v&&Bn(v,!0);const ae=w&&p.type!=="foreignObject";if(T?Z(f.dynamicChildren,T,R,v,y,ae,A):M||Ue(f,p,R,null,v,y,ae,A,!1),N>0){if(N&16)L(R,p,$,B,v,y,w);else if(N&2&&$.class!==B.class&&s(R,"class",null,B.class,w),N&4&&s(R,"style",$.style,B.style,w),N&8){const we=p.dynamicProps;for(let ue=0;ue<we.length;ue++){const Ce=we[ue],I=$[Ce],F=B[Ce];(F!==I||Ce==="value")&&s(R,Ce,I,F,w,f.children,v,y,Ke)}}N&1&&f.children!==p.children&&u(R,p.children)}else!M&&T==null&&L(R,p,$,B,v,y,w);((K=B.onVnodeUpdated)||U)&&vt(()=>{K&&Ht(K,v,p,f),U&&$n(p,f,v,"updated")},y)},Z=(f,p,v,y,w,A,M)=>{for(let R=0;R<p.length;R++){const N=f[R],T=p[R],U=N.el&&(N.type===Le||!jn(N,T)||N.shapeFlag&70)?d(N.el):v;b(N,T,U,null,y,w,A,M,!0)}},L=(f,p,v,y,w,A,M)=>{if(v!==y){for(const R in y){if(Ws(R))continue;const N=y[R],T=v[R];N!==T&&R!=="value"&&s(f,R,T,N,M,p.children,w,A,Ke)}if(v!==Re)for(const R in v)!Ws(R)&&!(R in y)&&s(f,R,v[R],null,M,p.children,w,A,Ke);"value"in y&&s(f,"value",v.value,y.value)}},re=(f,p,v,y,w,A,M,R,N)=>{const T=p.el=f?f.el:a(""),U=p.anchor=f?f.anchor:a("");let{patchFlag:$,dynamicChildren:B,slotScopeIds:K}=p;K&&(R=R?R.concat(K):K),f==null?(r(T,v,y),r(U,v,y),D(p.children,v,U,w,A,M,R,N)):$>0&&$&64&&B&&f.dynamicChildren?(Z(f.dynamicChildren,B,v,w,A,M,R),(p.key!=null||w&&p===w.subTree)&&Sf(f,p,!0)):Ue(f,p,v,U,w,A,M,R,N)},ye=(f,p,v,y,w,A,M,R,N)=>{p.slotScopeIds=R,f==null?p.shapeFlag&512?w.ctx.activate(p,v,y,M,N):Se(p,v,y,w,A,M,N):ce(f,p,N)},Se=(f,p,v,y,w,A,M)=>{const R=f.component=mb(f,y,w);if(Uo(f)&&(R.ctx.renderer=xt),_b(R),R.asyncDep){if(w&&w.registerDep(R,fe),!f.el){const N=R.subTree=Qe(It);H(null,N,p,v)}return}fe(R,f,p,v,w,A,M)},ce=(f,p,v)=>{const y=p.component=f.component;if(Rv(f,p,v))if(y.asyncDep&&!y.asyncResolved){ie(y,p,v);return}else y.next=p,yv(y.update),y.update();else p.component=f.component,p.el=f.el,y.vnode=p},fe=(f,p,v,y,w,A,M)=>{const R=()=>{if(f.isMounted){let{next:U,bu:$,u:B,parent:K,vnode:ae}=f,we=U,ue;Bn(f,!1),U?(U.el=ae.el,ie(f,U,M)):U=ae,$&&js($),(ue=U.props&&U.props.onVnodeBeforeUpdate)&&Ht(ue,K,U,ae),Bn(f,!0);const Ce=va(f),I=f.subTree;f.subTree=Ce,b(I,Ce,d(I.el),cn(I),f,w,A),U.el=Ce.el,we===null&&Pv(f,Ce.el),B&&vt(B,w),(ue=U.props&&U.props.onVnodeUpdated)&&vt(()=>Ht(ue,K,U,ae),w)}else{let U;const{el:$,props:B}=p,{bm:K,m:ae,parent:we}=f,ue=ro(p);if(Bn(f,!1),K&&js(K),!ue&&(U=B&&B.onVnodeBeforeMount)&&Ht(U,we,p),Bn(f,!0),$&&Mn){const Ce=()=>{f.subTree=va(f),Mn($,f.subTree,f,w,null)};ue?p.type.__asyncLoader().then(()=>!f.isUnmounted&&Ce()):Ce()}else{const Ce=f.subTree=va(f);b(null,Ce,v,y,f,w,A),p.el=Ce.el}if(ae&&vt(ae,w),!ue&&(U=B&&B.onVnodeMounted)){const Ce=p;vt(()=>Ht(U,we,Ce),w)}p.shapeFlag&256&&f.a&&vt(f.a,w),f.isMounted=!0,p=v=y=null}},N=f.effect=new jl(R,()=>af(f.update),f.scope),T=f.update=N.run.bind(N);T.id=f.uid,Bn(f,!0),T()},ie=(f,p,v)=>{p.component=f;const y=f.vnode.props;f.vnode=p,f.next=null,Jv(f,p.props,y,v),eb(f,p.children,v),ei(),Ql(void 0,f.update),ti()},Ue=(f,p,v,y,w,A,M,R,N=!1)=>{const T=f&&f.children,U=f?f.shapeFlag:0,$=p.children,{patchFlag:B,shapeFlag:K}=p;if(B>0){if(B&128){Me(T,$,v,y,w,A,M,R,N);return}else if(B&256){mt(T,$,v,y,w,A,M,R,N);return}}K&8?(U&16&&Ke(T,w,A),$!==T&&u(v,$)):U&16?K&16?Me(T,$,v,y,w,A,M,R,N):Ke(T,w,A,!0):(U&8&&u(v,""),K&16&&D($,v,y,w,A,M,R,N))},mt=(f,p,v,y,w,A,M,R,N)=>{f=f||Pr,p=p||Pr;const T=f.length,U=p.length,$=Math.min(T,U);let B;for(B=0;B<$;B++){const K=p[B]=N?mn(p[B]):jt(p[B]);b(f[B],K,v,null,w,A,M,R,N)}T>U?Ke(f,w,A,!0,!1,$):D(p,v,y,w,A,M,R,N,$)},Me=(f,p,v,y,w,A,M,R,N)=>{let T=0;const U=p.length;let $=f.length-1,B=U-1;for(;T<=$&&T<=B;){const K=f[T],ae=p[T]=N?mn(p[T]):jt(p[T]);if(jn(K,ae))b(K,ae,v,null,w,A,M,R,N);else break;T++}for(;T<=$&&T<=B;){const K=f[$],ae=p[B]=N?mn(p[B]):jt(p[B]);if(jn(K,ae))b(K,ae,v,null,w,A,M,R,N);else break;$--,B--}if(T>$){if(T<=B){const K=B+1,ae=K<U?p[K].el:y;for(;T<=B;)b(null,p[T]=N?mn(p[T]):jt(p[T]),v,ae,w,A,M,R,N),T++}}else if(T>B)for(;T<=$;)ut(f[T],w,A,!0),T++;else{const K=T,ae=T,we=new Map;for(T=ae;T<=B;T++){const be=p[T]=N?mn(p[T]):jt(p[T]);be.key!=null&&we.set(be.key,T)}let ue,Ce=0;const I=B-ae+1;let F=!1,G=0;const ge=new Array(I);for(T=0;T<I;T++)ge[T]=0;for(T=K;T<=$;T++){const be=f[T];if(Ce>=I){ut(be,w,A,!0);continue}let De;if(be.key!=null)De=we.get(be.key);else for(ue=ae;ue<=B;ue++)if(ge[ue-ae]===0&&jn(be,p[ue])){De=ue;break}De===void 0?ut(be,w,A,!0):(ge[De-ae]=T+1,De>=G?G=De:F=!0,b(be,p[De],v,null,w,A,M,R,N),Ce++)}const Oe=F?ob(ge):Pr;for(ue=Oe.length-1,T=I-1;T>=0;T--){const be=ae+T,De=p[be],Ee=be+1<U?p[be+1].el:y;ge[T]===0?b(null,De,v,Ee,w,A,M,R,N):F&&(ue<0||T!==Oe[ue]?ct(De,v,Ee,2):ue--)}}},ct=(f,p,v,y,w=null)=>{const{el:A,type:M,transition:R,children:N,shapeFlag:T}=f;if(T&6){ct(f.component.subTree,p,v,y);return}if(T&128){f.suspense.move(p,v,y);return}if(T&64){M.move(f,p,v,xt);return}if(M===Le){r(A,p,v);for(let $=0;$<N.length;$++)ct(N[$],p,v,y);r(f.anchor,p,v);return}if(M===Vs){z(f,p,v);return}if(y!==2&&T&1&&R)if(y===0)R.beforeEnter(A),r(A,p,v),vt(()=>R.enter(A),w);else{const{leave:$,delayLeave:B,afterLeave:K}=R,ae=()=>r(A,p,v),we=()=>{$(A,()=>{ae(),K&&K()})};B?B(A,ae,we):we()}else r(A,p,v)},ut=(f,p,v,y=!1,w=!1)=>{const{type:A,props:M,ref:R,children:N,dynamicChildren:T,shapeFlag:U,patchFlag:$,dirs:B}=f;if(R!=null&&Za(R,null,v,f,!0),U&256){p.ctx.deactivate(f);return}const K=U&1&&B,ae=!ro(f);let we;if(ae&&(we=M&&M.onVnodeBeforeUnmount)&&Ht(we,p,f),U&6)mi(f.component,v,y);else{if(U&128){f.suspense.unmount(v,y);return}K&&$n(f,null,p,"beforeUnmount"),U&64?f.type.remove(f,p,v,w,xt,y):T&&(A!==Le||$>0&&$&64)?Ke(T,p,v,!1,!0):(A===Le&&$&384||!w&&U&16)&&Ke(N,p,v),y&&br(f)}(ae&&(we=M&&M.onVnodeUnmounted)||K)&&vt(()=>{we&&Ht(we,p,f),K&&$n(f,null,p,"unmounted")},v)},br=f=>{const{type:p,el:v,anchor:y,transition:w}=f;if(p===Le){gi(v,y);return}if(p===Vs){X(f);return}const A=()=>{i(v),w&&!w.persisted&&w.afterLeave&&w.afterLeave()};if(f.shapeFlag&1&&w&&!w.persisted){const{leave:M,delayLeave:R}=w,N=()=>M(v,A);R?R(f.el,A,N):N()}else A()},gi=(f,p)=>{let v;for(;f!==p;)v=h(f),i(f),f=v;i(p)},mi=(f,p,v)=>{const{bum:y,scope:w,update:A,subTree:M,um:R}=f;y&&js(y),w.stop(),A&&(A.active=!1,ut(M,f,p,v)),R&&vt(R,p),vt(()=>{f.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&f.asyncDep&&!f.asyncResolved&&f.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Ke=(f,p,v,y=!1,w=!1,A=0)=>{for(let M=A;M<f.length;M++)ut(f[M],p,v,y,w)},cn=f=>f.shapeFlag&6?cn(f.component.subTree):f.shapeFlag&128?f.suspense.next():h(f.anchor||f.el),yr=(f,p,v)=>{f==null?p._vnode&&ut(p._vnode,null,null,!0):b(p._vnode||null,f,p,null,null,null,v),uf(),p._vnode=f},xt={p:b,um:ut,m:ct,r:br,mt:Se,mc:D,pc:Ue,pbc:Z,n:cn,o:t};let On,Mn;return e&&([On,Mn]=e(xt)),{render:yr,hydrate:On,createApp:rb(yr,On)}}function Bn({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function Sf(t,e,n=!1){const r=t.children,i=e.children;if(Q(r)&&Q(i))for(let s=0;s<r.length;s++){const o=r[s];let a=i[s];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[s]=mn(i[s]),a.el=o.el),n||Sf(o,a))}}function ob(t){const e=t.slice(),n=[0];let r,i,s,o,a;const l=t.length;for(r=0;r<l;r++){const c=t[r];if(c!==0){if(i=n[n.length-1],t[i]<c){e[r]=i,n.push(r);continue}for(s=0,o=n.length-1;s<o;)a=s+o>>1,t[n[a]]<c?s=a+1:o=a;c<t[n[s]]&&(s>0&&(e[r]=n[s-1]),n[s]=r)}}for(s=n.length,o=n[s-1];s-- >0;)n[s]=o,o=e[o];return n}const ab=t=>t.__isTeleport,lb=Symbol(),Le=Symbol(void 0),nc=Symbol(void 0),It=Symbol(void 0),Vs=Symbol(void 0),Mi=[];let Zn=null;function Te(t=!1){Mi.push(Zn=t?null:[])}function cb(){Mi.pop(),Zn=Mi[Mi.length-1]||null}let so=1;function ku(t){so+=t}function xf(t){return t.dynamicChildren=so>0?Zn||Pr:null,cb(),so>0&&Zn&&Zn.push(t),t}function Je(t,e,n,r,i,s){return xf(at(t,e,n,r,i,s,!0))}function Kt(t,e,n,r,i){return xf(Qe(t,e,n,r,i,!0))}function Ki(t){return t?t.__v_isVNode===!0:!1}function jn(t,e){return t.type===e.type&&t.key===e.key}const jo="__vInternal",Rf=({key:t})=>t!=null?t:null,qs=({ref:t,ref_key:e,ref_for:n})=>t!=null?Ze(t)||Xe(t)||ne(t)?{i:ft,r:t,k:e,f:!!n}:t:null;function at(t,e=null,n=null,r=0,i=null,s=t===Le?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&Rf(e),ref:e&&qs(e),scopeId:$o,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:r,dynamicProps:i,dynamicChildren:null,appContext:null};return a?(rc(l,n),s&128&&t.normalize(l)):n&&(l.shapeFlag|=Ze(n)?8:16),so>0&&!o&&Zn&&(l.patchFlag>0||s&6)&&l.patchFlag!==32&&Zn.push(l),l}const Qe=ub;function ub(t,e=null,n=null,r=0,i=null,s=!1){if((!t||t===lb)&&(t=It),Ki(t)){const a=sr(t,e,!0);return n&&rc(a,n),a}if(wb(t)&&(t=t.__vccOpts),e){e=db(e);let{class:a,style:l}=e;a&&!Ze(a)&&(e.class=Qr(a)),He(l)&&(Zh(l)&&!Q(l)&&(l=it({},l)),e.style=Ao(l))}const o=Ze(t)?1:Av(t)?128:ab(t)?64:He(t)?4:ne(t)?2:0;return at(t,e,n,r,i,o,s,!0)}function db(t){return t?Zh(t)||jo in t?it({},t):t:null}function sr(t,e,n=!1){const{props:r,ref:i,patchFlag:s,children:o}=t,a=e?Pf(r||{},e):r;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&Rf(a),ref:e&&e.ref?n&&i?Q(i)?i.concat(qs(e)):[i,qs(e)]:qs(e):i,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Le?s===-1?16:s|16:s,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&sr(t.ssContent),ssFallback:t.ssFallback&&sr(t.ssFallback),el:t.el,anchor:t.anchor}}function Vo(t=" ",e=0){return Qe(nc,null,t,e)}function Ai(t="",e=!1){return e?(Te(),Kt(It,null,t)):Qe(It,null,t)}function jt(t){return t==null||typeof t=="boolean"?Qe(It):Q(t)?Qe(Le,null,t.slice()):typeof t=="object"?mn(t):Qe(nc,null,String(t))}function mn(t){return t.el===null||t.memo?t:sr(t)}function rc(t,e){let n=0;const{shapeFlag:r}=t;if(e==null)e=null;else if(Q(e))n=16;else if(typeof e=="object")if(r&65){const i=e.default;i&&(i._c&&(i._d=!1),rc(t,i()),i._c&&(i._d=!0));return}else{n=32;const i=e._;!i&&!(jo in e)?e._ctx=ft:i===3&&ft&&(ft.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ne(e)?(e={default:e,_ctx:ft},n=32):(e=String(e),r&64?(n=16,e=[Vo(e)]):n=8);t.children=e,t.shapeFlag|=n}function Pf(...t){const e={};for(let n=0;n<t.length;n++){const r=t[n];for(const i in r)if(i==="class")e.class!==r.class&&(e.class=Qr([e.class,r.class]));else if(i==="style")e.style=Ao([e.style,r.style]);else if(No(i)){const s=e[i],o=r[i];o&&s!==o&&!(Q(s)&&s.includes(o))&&(e[i]=s?[].concat(s,o):o)}else i!==""&&(e[i]=r[i])}return e}function Ht(t,e,n,r=null){At(t,e,7,[n,r])}function Gi(t,e,n,r){let i;const s=n&&n[r];if(Q(t)||Ze(t)){i=new Array(t.length);for(let o=0,a=t.length;o<a;o++)i[o]=e(t[o],o,void 0,s&&s[o])}else if(typeof t=="number"){i=new Array(t);for(let o=0;o<t;o++)i[o]=e(o+1,o,void 0,s&&s[o])}else if(He(t))if(t[Symbol.iterator])i=Array.from(t,(o,a)=>e(o,a,void 0,s&&s[a]));else{const o=Object.keys(t);i=new Array(o.length);for(let a=0,l=o.length;a<l;a++){const c=o[a];i[a]=e(t[c],c,a,s&&s[a])}}else i=[];return n&&(n[r]=i),i}function hb(t,e,n={},r,i){if(ft.isCE||ft.parent&&ro(ft.parent)&&ft.parent.isCE)return Qe("slot",e==="default"?null:{name:e},r&&r());let s=t[e];s&&s._c&&(s._d=!1),Te();const o=s&&Af(s(n)),a=Kt(Le,{key:n.key||`_${e}`},o||(r?r():[]),o&&t._===1?64:-2);return!i&&a.scopeId&&(a.slotScopeIds=[a.scopeId+"-s"]),s&&s._c&&(s._d=!0),a}function Af(t){return t.some(e=>Ki(e)?!(e.type===It||e.type===Le&&!Af(e.children)):!0)?t:null}const el=t=>t?Nf(t)?qo(t)||t.proxy:el(t.parent):null,oo=it(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>el(t.parent),$root:t=>el(t.root),$emit:t=>t.emit,$options:t=>bf(t),$forceUpdate:t=>()=>af(t.update),$nextTick:t=>of.bind(t.proxy),$watch:t=>Ov.bind(t)}),fb={get({_:t},e){const{ctx:n,setupState:r,data:i,props:s,accessCache:o,type:a,appContext:l}=t;let c;if(e[0]!=="$"){const _=o[e];if(_!==void 0)switch(_){case 1:return r[e];case 2:return i[e];case 4:return n[e];case 3:return s[e]}else{if(r!==Re&&pe(r,e))return o[e]=1,r[e];if(i!==Re&&pe(i,e))return o[e]=2,i[e];if((c=t.propsOptions[0])&&pe(c,e))return o[e]=3,s[e];if(n!==Re&&pe(n,e))return o[e]=4,n[e];Xa&&(o[e]=0)}}const u=oo[e];let d,h;if(u)return e==="$attrs"&&St(t,"get",e),u(t);if((d=a.__cssModules)&&(d=d[e]))return d;if(n!==Re&&pe(n,e))return o[e]=4,n[e];if(h=l.config.globalProperties,pe(h,e))return h[e]},set({_:t},e,n){const{data:r,setupState:i,ctx:s}=t;return i!==Re&&pe(i,e)?(i[e]=n,!0):r!==Re&&pe(r,e)?(r[e]=n,!0):pe(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(s[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:r,appContext:i,propsOptions:s}},o){let a;return!!n[o]||t!==Re&&pe(t,o)||e!==Re&&pe(e,o)||(a=s[0])&&pe(a,o)||pe(r,o)||pe(oo,o)||pe(i.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:pe(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}},pb=If();let gb=0;function mb(t,e,n){const r=t.type,i=(e?e.appContext:t.appContext)||pb,s={uid:gb++,vnode:t,type:r,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,scope:new $_(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:wf(r,i),emitsOptions:hf(r,i),emit:null,emitted:null,propsDefaults:Re,inheritAttrs:r.inheritAttrs,ctx:Re,data:Re,props:Re,attrs:Re,slots:Re,refs:Re,setupState:Re,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=e?e.root:s,s.emit=Ev.bind(null,s),t.ce&&t.ce(s),s}let rt=null;const ic=()=>rt||ft,Hr=t=>{rt=t,t.scope.on()},er=()=>{rt&&rt.scope.off(),rt=null};function Nf(t){return t.vnode.shapeFlag&4}let Yi=!1;function _b(t,e=!1){Yi=e;const{props:n,children:r}=t.vnode,i=Nf(t);Xv(t,n,i,e),Zv(t,r);const s=i?vb(t,e):void 0;return Yi=!1,s}function vb(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=ef(new Proxy(t.ctx,fb));const{setup:r}=n;if(r){const i=t.setupContext=r.length>1?yb(t):null;Hr(t),ei();const s=En(r,t,0,[t.props,i]);if(ti(),er(),$h(s)){if(s.then(er,er),e)return s.then(o=>{Ou(t,o,e)}).catch(o=>{Lo(o,t,0)});t.asyncDep=s}else Ou(t,s,e)}else kf(t,e)}function Ou(t,e,n){ne(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:He(e)&&(t.setupState=rf(e)),kf(t,n)}let Mu;function kf(t,e,n){const r=t.type;if(!t.render){if(!e&&Mu&&!r.render){const i=r.template;if(i){const{isCustomElement:s,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:l}=r,c=it(it({isCustomElement:s,delimiters:a},o),l);r.render=Mu(i,c)}}t.render=r.render||Dt}Hr(t),ei(),Vv(t),ti(),er()}function bb(t){return new Proxy(t.attrs,{get(e,n){return St(t,"get","$attrs"),e[n]}})}function yb(t){const e=r=>{t.exposed=r||{}};let n;return{get attrs(){return n||(n=bb(t))},slots:t.slots,emit:t.emit,expose:e}}function qo(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(rf(ef(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in oo)return oo[n](t)}}))}function wb(t){return ne(t)&&"__vccOpts"in t}const de=(t,e)=>_v(t,e,Yi);function k(t,e,n){const r=arguments.length;return r===2?He(e)&&!Q(e)?Ki(e)?Qe(t,null,[e]):Qe(t,e):Qe(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&Ki(n)&&(n=[n]),Qe(t,e,n))}const Cb="3.2.33",Eb="http://www.w3.org/2000/svg",Vn=typeof document!="undefined"?document:null,Du=Vn&&Vn.createElement("template"),Tb={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,r)=>{const i=e?Vn.createElementNS(Eb,t):Vn.createElement(t,n?{is:n}:void 0);return t==="select"&&r&&r.multiple!=null&&i.setAttribute("multiple",r.multiple),i},createText:t=>Vn.createTextNode(t),createComment:t=>Vn.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Vn.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},cloneNode(t){const e=t.cloneNode(!0);return"_value"in t&&(e._value=t._value),e},insertStaticContent(t,e,n,r,i,s){const o=n?n.previousSibling:e.lastChild;if(i&&(i===s||i.nextSibling))for(;e.insertBefore(i.cloneNode(!0),n),!(i===s||!(i=i.nextSibling)););else{Du.innerHTML=r?`<svg>${t}</svg>`:t;const a=Du.content;if(r){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function Ib(t,e,n){const r=t._vtc;r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function Sb(t,e,n){const r=t.style,i=Ze(n);if(n&&!i){for(const s in n)tl(r,s,n[s]);if(e&&!Ze(e))for(const s in e)n[s]==null&&tl(r,s,"")}else{const s=r.display;i?e!==n&&(r.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(r.display=s)}}const Lu=/\s*!important$/;function tl(t,e,n){if(Q(n))n.forEach(r=>tl(t,e,r));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const r=xb(t,e);Lu.test(n)?t.setProperty(Zr(r),n.replace(Lu,""),"important"):t[r]=n}}const Fu=["Webkit","Moz","ms"],ya={};function xb(t,e){const n=ya[e];if(n)return n;let r=$r(e);if(r!=="filter"&&r in t)return ya[e]=r;r=Hh(r);for(let i=0;i<Fu.length;i++){const s=Fu[i]+r;if(s in t)return ya[e]=s}return e}const $u="http://www.w3.org/1999/xlink";function Rb(t,e,n,r,i){if(r&&e.startsWith("xlink:"))n==null?t.removeAttributeNS($u,e.slice(6,e.length)):t.setAttributeNS($u,e,n);else{const s=x_(e);n==null||s&&!Dh(n)?t.removeAttribute(e):t.setAttribute(e,s?"":n)}}function Pb(t,e,n,r,i,s,o){if(e==="innerHTML"||e==="textContent"){r&&o(r,i,s),t[e]=n==null?"":n;return}if(e==="value"&&t.tagName!=="PROGRESS"&&!t.tagName.includes("-")){t._value=n;const l=n==null?"":n;(t.value!==l||t.tagName==="OPTION")&&(t.value=l),n==null&&t.removeAttribute(e);return}let a=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=Dh(n):n==null&&l==="string"?(n="",a=!0):l==="number"&&(n=0,a=!0)}try{t[e]=n}catch{}a&&t.removeAttribute(e)}const[Of,Ab]=(()=>{let t=Date.now,e=!1;if(typeof window!="undefined"){Date.now()>document.createEvent("Event").timeStamp&&(t=()=>performance.now());const n=navigator.userAgent.match(/firefox\/(\d+)/i);e=!!(n&&Number(n[1])<=53)}return[t,e]})();let nl=0;const Nb=Promise.resolve(),kb=()=>{nl=0},Ob=()=>nl||(Nb.then(kb),nl=Of());function Sr(t,e,n,r){t.addEventListener(e,n,r)}function Mb(t,e,n,r){t.removeEventListener(e,n,r)}function Db(t,e,n,r,i=null){const s=t._vei||(t._vei={}),o=s[e];if(r&&o)o.value=r;else{const[a,l]=Lb(e);if(r){const c=s[e]=Fb(r,i);Sr(t,a,c,l)}else o&&(Mb(t,a,o,l),s[e]=void 0)}}const Bu=/(?:Once|Passive|Capture)$/;function Lb(t){let e;if(Bu.test(t)){e={};let n;for(;n=t.match(Bu);)t=t.slice(0,t.length-n[0].length),e[n[0].toLowerCase()]=!0}return[Zr(t.slice(2)),e]}function Fb(t,e){const n=r=>{const i=r.timeStamp||Of();(Ab||i>=n.attached-1)&&At($b(r,n.value),e,5,[r])};return n.value=t,n.attached=Ob(),n}function $b(t,e){if(Q(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(r=>i=>!i._stopped&&r&&r(i))}else return e}const Uu=/^on[a-z]/,Bb=(t,e,n,r,i=!1,s,o,a,l)=>{e==="class"?Ib(t,r,i):e==="style"?Sb(t,n,r):No(e)?Bl(e)||Db(t,e,n,r,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):Ub(t,e,r,i))?Pb(t,e,r,s,o,a,l):(e==="true-value"?t._trueValue=r:e==="false-value"&&(t._falseValue=r),Rb(t,e,r,i))};function Ub(t,e,n,r){return r?!!(e==="innerHTML"||e==="textContent"||e in t&&Uu.test(e)&&ne(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||Uu.test(e)&&Ze(n)?!1:e in t}function Mf(t){const e=ic();if(!e)return;const n=()=>rl(e.subTree,t(e.proxy));kv(n),ni(()=>{const r=new MutationObserver(n);r.observe(e.subTree.el.parentNode,{childList:!0}),ec(()=>r.disconnect())})}function rl(t,e){if(t.shapeFlag&128){const n=t.suspense;t=n.activeBranch,n.pendingBranch&&!n.isHydrating&&n.effects.push(()=>{rl(n.activeBranch,e)})}for(;t.component;)t=t.component.subTree;if(t.shapeFlag&1&&t.el)Hu(t.el,e);else if(t.type===Le)t.children.forEach(n=>rl(n,e));else if(t.type===Vs){let{el:n,anchor:r}=t;for(;n&&(Hu(n,e),n!==r);)n=n.nextSibling}}function Hu(t,e){if(t.nodeType===1){const n=t.style;for(const r in e)n.setProperty(`--${r}`,e[r])}}const hn="transition",bi="animation",Xi=(t,{slots:e})=>k(pf,Hb(t),e);Xi.displayName="Transition";const Df={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String};Xi.props=it({},pf.props,Df);const Un=(t,e=[])=>{Q(t)?t.forEach(n=>n(...e)):t&&t(...e)},zu=t=>t?Q(t)?t.some(e=>e.length>1):t.length>1:!1;function Hb(t){const e={};for(const L in t)L in Df||(e[L]=t[L]);if(t.css===!1)return e;const{name:n="v",type:r,duration:i,enterFromClass:s=`${n}-enter-from`,enterActiveClass:o=`${n}-enter-active`,enterToClass:a=`${n}-enter-to`,appearFromClass:l=s,appearActiveClass:c=o,appearToClass:u=a,leaveFromClass:d=`${n}-leave-from`,leaveActiveClass:h=`${n}-leave-active`,leaveToClass:_=`${n}-leave-to`}=t,g=zb(i),C=g&&g[0],b=g&&g[1],{onBeforeEnter:O,onEnter:H,onEnterCancelled:V,onLeave:z,onLeaveCancelled:X,onBeforeAppear:me=O,onAppear:E=H,onAppearCancelled:S=V}=e,D=(L,re,ye)=>{Cr(L,re?u:a),Cr(L,re?c:o),ye&&ye()},q=(L,re)=>{Cr(L,_),Cr(L,h),re&&re()},Z=L=>(re,ye)=>{const Se=L?E:H,ce=()=>D(re,L,ye);Un(Se,[re,ce]),Wu(()=>{Cr(re,L?l:s),fn(re,L?u:a),zu(Se)||ju(re,r,C,ce)})};return it(e,{onBeforeEnter(L){Un(O,[L]),fn(L,s),fn(L,o)},onBeforeAppear(L){Un(me,[L]),fn(L,l),fn(L,c)},onEnter:Z(!1),onAppear:Z(!0),onLeave(L,re){const ye=()=>q(L,re);fn(L,d),Vb(),fn(L,h),Wu(()=>{Cr(L,d),fn(L,_),zu(z)||ju(L,r,b,ye)}),Un(z,[L,ye])},onEnterCancelled(L){D(L,!1),Un(V,[L])},onAppearCancelled(L){D(L,!0),Un(S,[L])},onLeaveCancelled(L){q(L),Un(X,[L])}})}function zb(t){if(t==null)return null;if(He(t))return[wa(t.enter),wa(t.leave)];{const e=wa(t);return[e,e]}}function wa(t){return eo(t)}function fn(t,e){e.split(/\s+/).forEach(n=>n&&t.classList.add(n)),(t._vtc||(t._vtc=new Set)).add(e)}function Cr(t,e){e.split(/\s+/).forEach(r=>r&&t.classList.remove(r));const{_vtc:n}=t;n&&(n.delete(e),n.size||(t._vtc=void 0))}function Wu(t){requestAnimationFrame(()=>{requestAnimationFrame(t)})}let Wb=0;function ju(t,e,n,r){const i=t._endId=++Wb,s=()=>{i===t._endId&&r()};if(n)return setTimeout(s,n);const{type:o,timeout:a,propCount:l}=jb(t,e);if(!o)return r();const c=o+"end";let u=0;const d=()=>{t.removeEventListener(c,h),s()},h=_=>{_.target===t&&++u>=l&&d()};setTimeout(()=>{u<l&&d()},a+1),t.addEventListener(c,h)}function jb(t,e){const n=window.getComputedStyle(t),r=g=>(n[g]||"").split(", "),i=r(hn+"Delay"),s=r(hn+"Duration"),o=Vu(i,s),a=r(bi+"Delay"),l=r(bi+"Duration"),c=Vu(a,l);let u=null,d=0,h=0;e===hn?o>0&&(u=hn,d=o,h=s.length):e===bi?c>0&&(u=bi,d=c,h=l.length):(d=Math.max(o,c),u=d>0?o>c?hn:bi:null,h=u?u===hn?s.length:l.length:0);const _=u===hn&&/\b(transform|all)(,|$)/.test(n[hn+"Property"]);return{type:u,timeout:d,propCount:h,hasTransform:_}}function Vu(t,e){for(;t.length<e.length;)t=t.concat(t);return Math.max(...e.map((n,r)=>qu(n)+qu(t[r])))}function qu(t){return Number(t.slice(0,-1).replace(",","."))*1e3}function Vb(){return document.body.offsetHeight}const Ku=t=>{const e=t.props["onUpdate:modelValue"];return Q(e)?n=>js(e,n):e};function qb(t){t.target.composing=!0}function Gu(t){const e=t.target;e.composing&&(e.composing=!1,Kb(e,"input"))}function Kb(t,e){const n=document.createEvent("HTMLEvents");n.initEvent(e,!0,!0),t.dispatchEvent(n)}const Gb={created(t,{modifiers:{lazy:e,trim:n,number:r}},i){t._assign=Ku(i);const s=r||i.props&&i.props.type==="number";Sr(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n?a=a.trim():s&&(a=eo(a)),t._assign(a)}),n&&Sr(t,"change",()=>{t.value=t.value.trim()}),e||(Sr(t,"compositionstart",qb),Sr(t,"compositionend",Gu),Sr(t,"change",Gu))},mounted(t,{value:e}){t.value=e==null?"":e},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:r,number:i}},s){if(t._assign=Ku(s),t.composing||document.activeElement===t&&(n||r&&t.value.trim()===e||(i||t.type==="number")&&eo(t.value)===e))return;const o=e==null?"":e;t.value!==o&&(t.value=o)}},Yb=it({patchProp:Bb},Tb);let Yu;function Xb(){return Yu||(Yu=ib(Yb))}const Jb=(...t)=>{const e=Xb().createApp(...t),{mount:n}=e;return e.mount=r=>{const i=Qb(r);if(!i)return;const s=e._component;!ne(s)&&!s.render&&!s.template&&(s.template=i.innerHTML),i.innerHTML="";const o=n(i,!1,i instanceof SVGElement);return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},e};function Qb(t){return Ze(t)?document.querySelector(t):t}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ni(t,e){return new Promise((n,r)=>{t.onsuccess=i=>{n(i.target.result)},t.onerror=i=>{var s;r(`${e}: ${(s=i.target.error)===null||s===void 0?void 0:s.message}`)}})}class Ju{constructor(e){this._db=e,this.objectStoreNames=this._db.objectStoreNames}transaction(e,n="readonly"){return new jf(this._db.transaction.call(this._db,e,n))}createObjectStore(e,n){return new Vf(this._db.createObjectStore(e,n))}close(){this._db.close()}}class jf{constructor(e){this._transaction=e,this.complete=new Promise((n,r)=>{this._transaction.oncomplete=function(){n()},this._transaction.onerror=()=>{r(this._transaction.error)},this._transaction.onabort=()=>{r(this._transaction.error)}})}objectStore(e){return new Vf(this._transaction.objectStore(e))}}class Vf{constructor(e){this._store=e}index(e){return new Qu(this._store.index(e))}createIndex(e,n,r){return new Qu(this._store.createIndex(e,n,r))}get(e){const n=this._store.get(e);return Ni(n,"Error reading from IndexedDB")}put(e,n){const r=this._store.put(e,n);return Ni(r,"Error writing to IndexedDB")}delete(e){const n=this._store.delete(e);return Ni(n,"Error deleting from IndexedDB")}clear(){const e=this._store.clear();return Ni(e,"Error clearing IndexedDB object store")}}class Qu{constructor(e){this._index=e}get(e){const n=this._index.get(e);return Ni(n,"Error reading from IndexedDB")}}function my(t,e,n){return new Promise((r,i)=>{try{const s=indexedDB.open(t,e);s.onsuccess=o=>{r(new Ju(o.target.result))},s.onerror=o=>{var a;i(`Error opening indexedDB: ${(a=o.target.error)===null||a===void 0?void 0:a.message}`)},s.onupgradeneeded=o=>{n(new Ju(s.result),o.oldVersion,o.newVersion,new jf(s.transaction))}}catch(s){i(`Error opening indexedDB: ${s.message}`)}})}class or{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var xe;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(xe||(xe={}));const wy={debug:xe.DEBUG,verbose:xe.VERBOSE,info:xe.INFO,warn:xe.WARN,error:xe.ERROR,silent:xe.SILENT},Cy=xe.INFO,Ey={[xe.DEBUG]:"log",[xe.VERBOSE]:"log",[xe.INFO]:"info",[xe.WARN]:"warn",[xe.ERROR]:"error"},Ty=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),i=Ey[e];if(i)console[i](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class ac{constructor(e){this.name=e,this._logLevel=Cy,this._logHandler=Ty,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in xe))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?wy[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,xe.DEBUG,...e),this._logHandler(this,xe.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,xe.VERBOSE,...e),this._logHandler(this,xe.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,xe.INFO,...e),this._logHandler(this,xe.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,xe.WARN,...e),this._logHandler(this,xe.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,xe.ERROR,...e),this._logHandler(this,xe.ERROR,...e)}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iy{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Sy(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Sy(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ol="@firebase/app",Zu="0.7.22";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const co=new Map,al=new Map;function Zy(t,e){try{t.container.addComponent(e)}catch(n){lc.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Wr(t){const e=t.name;if(al.has(e))return lc.debug(`There were multiple attempts to register component ${e}.`),!1;al.set(e,t);for(const n of co.values())Zy(n,t);return!0}function cc(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o0=1024,a0=30*24*60*60*1e3;class l0{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new u0(n),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=td();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(i=>i.date===r)))return this._heartbeatsCache.heartbeats.push({date:r,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const s=new Date(i.date).valueOf();return Date.now()-s<=a0}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=td(),{heartbeatsToSend:n,unsentEntries:r}=c0(this._heartbeatsCache.heartbeats),i=Bf(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function td(){return new Date().toISOString().substring(0,10)}function c0(t,e=o0){const n=[];let r=t.slice();for(const i of t){const s=n.find(o=>o.agent===i.agent);if(s){if(s.dates.push(i.date),nd(n)>e){s.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),nd(n)>e){n.pop();break}r=r.slice(1)}return{heartbeatsToSend:n,unsentEntries:r}}class u0{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return iy()?sy().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await s0(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return ed(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return ed(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function nd(t){return Bf(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function d0(t){Wr(new or("platform-logger",e=>new Iy(e),"PRIVATE")),Wr(new or("heartbeat",e=>new l0(e),"PRIVATE")),In(ol,Zu,t),In(ol,Zu,"esm2017"),In("fire-js","")}d0("");var h0="firebase",f0="9.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rd=new ac("@firebase/auth");function Ks(t,...e){rd.logLevel<=xe.ERROR&&rd.error(`Auth (${ds}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rn(t,...e){throw dc(t,...e)}function Vt(t,...e){return dc(t,...e)}function g0(t,e,n){const r=Object.assign(Object.assign({},p0()),{[e]:n});return new us("auth","Firebase",r).create(e,{appName:t.name})}function dc(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return Jf.create(t,...e)}function ee(t,e,...n){if(!t)throw dc(e,...n)}function Qt(t){const e="INTERNAL ASSERTION FAILED: "+t;throw Ks(e),new Error(e)}function sn(t,e){t||Qt(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const id=new Map;function Zt(t){sn(t instanceof Function,"Expected a class definition");let e=id.get(t);return e?(sn(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,id.set(t,e),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function m0(t,e){const n=cc(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),s=n.getOptions();if(lo(s,e!=null?e:{}))return i;rn(i,"already-initialized")}return n.initialize({options:e})}function _0(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(Zt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ll(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function v0(){return sd()==="http:"||sd()==="https:"}function sd(){var t;return typeof self!="undefined"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hs{constructor(e,n){this.shortDelay=e,this.longDelay=n,sn(n>e,"Short delay should be less than long delay!"),this.isMobile=oc()||Hf()}get(){return b0()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hc(t,e){sn(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Di(t){if(!!t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function S0(t,e=!1){const n=Ut(t),r=await n.getIdToken(e),i=fc(r);ee(i&&i.exp&&i.auth_time&&i.iat,n.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:Di(Ia(i.auth_time)),issuedAtTime:Di(Ia(i.iat)),expirationTime:Di(Ia(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function Ia(t){return Number(t)*1e3}function fc(t){const[e,n,r]=t.split(".");if(e===void 0||n===void 0||r===void 0)return Ks("JWT malformed, contained fewer than 3 sections"),null;try{const i=il(n);return i?JSON.parse(i):(Ks("Failed to decode base64 JWT payload"),null)}catch(i){return Ks("Caught error parsing JWT payload as JSON",i),null}}function x0(t){const e=fc(t);return ee(e,"internal-error"),ee(typeof e.exp!="undefined","internal-error"),ee(typeof e.iat!="undefined","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ip{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}ip.type="NONE";const od=ip;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gs(t,e,n){return`firebase:${t}:${e}:${n}`}class kr{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Gs(this.userKey,i.apiKey,s),this.fullPersistenceKey=Gs("persistence",i.apiKey,s),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?tr._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new kr(Zt(od),e,r);const i=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let s=i[0]||Zt(od);const o=Gs(r,e.config.apiKey,e.name);let a=null;for(const c of n)try{const u=await c._get(o);if(u){const d=tr._fromJSON(e,u);c!==s&&(a=d),s=c;break}}catch{}const l=i.filter(c=>c._shouldAllowMigration);return!s._shouldAllowMigration||!l.length?new kr(s,e,r):(s=l[0],a&&await s._set(o,a.toJSON()),await Promise.all(n.map(async c=>{if(c!==s)try{await c._remove(o)}catch{}})),new kr(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ad(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(ap(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(sp(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(cp(e))return"Blackberry";if(up(e))return"Webos";if(pc(e))return"Safari";if((e.includes("chrome/")||op(e))&&!e.includes("edge/"))return"Chrome";if(lp(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function sp(t=lt()){return/firefox\//i.test(t)}function pc(t=lt()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function op(t=lt()){return/crios\//i.test(t)}function ap(t=lt()){return/iemobile/i.test(t)}function lp(t=lt()){return/android/i.test(t)}function cp(t=lt()){return/blackberry/i.test(t)}function up(t=lt()){return/webos/i.test(t)}function Xo(t=lt()){return/iphone|ipad|ipod/i.test(t)}function M0(t=lt()){var e;return Xo(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function D0(){return ry()&&document.documentMode===10}function dp(t=lt()){return Xo(t)||lp(t)||up(t)||cp(t)||/windows phone/i.test(t)||ap(t)}function L0(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hp(t,e=[]){let n;switch(t){case"Browser":n=ad(lt());break;case"Worker":n=`${ad(lt())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${ds}/${r}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function z0(t,e,n=!1){const{auth:r}=t,i="reauthenticate";try{const s=await Zi(t,gp(r,i,e,t),n);ee(s.idToken,r,"internal-error");const o=fc(s.idToken);ee(o,r,"internal-error");const{sub:a}=o;return ee(t.uid===a,r,"user-mismatch"),Pn._forOperation(t,i,s)}catch(s){throw(s==null?void 0:s.code)==="auth/user-not-found"&&rn(r,"user-mismatch"),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _c extends fp{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Or(e,this._buildIdpRequest())}_linkToIdToken(e,n){return Or(e,this._buildIdpRequest(n))}_getReauthenticationResolver(e){return Or(e,this._buildIdpRequest())}_buildIdpRequest(e){const n={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(n.idToken=e),n}}function dw(t){return W0(t.auth,new _c(t),t.bypassAuthState)}function hw(t){const{auth:e,user:n}=t;return ee(n,e,"internal-error"),z0(n,new _c(t),t.bypassAuthState)}async function fw(t){const{auth:e,user:n}=t;return ee(n,e,"internal-error"),H0(n,new _c(t),t.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pw=new hs(3e4,6e4);function fd(){const t=qt().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function Aw(t){return new Promise((e,n)=>{var r,i,s;function o(){fd(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{fd(),n(Vt(t,"network-request-failed"))},timeout:Pw.get()})}if(!((i=(r=qt().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=qt().gapi)===null||s===void 0)&&s.load)o();else{const a=cw("iframefcb");return qt()[a]=()=>{gapi.load?o():n(Vt(t,"network-request-failed"))},lw(`https://apis.google.com/js/api.js?onload=${a}`).catch(l=>n(l))}}).catch(e=>{throw Ys=null,e})}let Ys=null;function Nw(t){return Ys=Ys||Aw(t),Ys}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bw={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Uw=500,Hw=600,zw="_blank",Ww="http://localhost";class pd{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function jw(t,e,n,r=Uw,i=Hw){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const l=Object.assign(Object.assign({},Bw),{width:r.toString(),height:i.toString(),top:s,left:o}),c=lt().toLowerCase();n&&(a=op(c)?zw:n),sp(c)&&(e=e||Ww,l.scrollbars="yes");const u=Object.entries(l).reduce((h,[_,g])=>`${h}${_}=${g},`,"");if(M0(c)&&a!=="_self")return Vw(e||"",a),new pd(null);const d=window.open(e||"",a,u);ee(d,t,"popup-blocked");try{d.focus()}catch{}return new pd(d)}function Vw(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qw="__/auth/handler",Kw="emulator/auth/handler";function gd(t,e,n,r,i,s){ee(t.config.authDomain,t,"auth-domain-config-required"),ee(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:ds,eventId:i};if(e instanceof pp){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",sl(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[l,c]of Object.entries(s||{}))o[l]=c}if(e instanceof fs){const l=e.getScopes().filter(c=>c!=="");l.length>0&&(o.scopes=l.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const l of Object.keys(a))a[l]===void 0&&delete a[l];return`${Gw(t)}?${si(a).slice(1)}`}function Gw({config:t}){return t.emulator?hc(t,Kw):`https://${t.authDomain}/${qw}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eC(t=Kf()){const e=cc(t,"auth");return e.isInitialized()?e.getImmediate():m0(t,{popupRedirectResolver:Xw,persistence:[ow,G0,bp]})}Zw("Browser");const vd="@firebase/database",bd="0.12.8";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mr=new ac("@firebase/database"),iC=function(){let t=1;return function(){return t++}}(),Rp=function(t){const e=gy(t),n=new dy;n.update(e);const r=n.digest();return sc.encodeByteArray(r)},gs=function(...t){let e="";for(let n=0;n<t.length;n++){const r=t[n];Array.isArray(r)||r&&typeof r=="object"&&typeof r.length=="number"?e+=gs.apply(null,r):typeof r=="object"?e+=Ve(r):e+=r,e+=" "}return e};let nr=null,yd=!0;const sC=function(t,e){P(!e||t===!0||t===!1,"Can't turn on custom loggers persistently."),t===!0?(Mr.logLevel=xe.VERBOSE,nr=Mr.log.bind(Mr),e&&ul.set("logging_enabled",!0)):typeof t=="function"?nr=t:(nr=null,ul.remove("logging_enabled"))},nt=function(...t){if(yd===!0&&(yd=!1,nr===null&&ul.get("logging_enabled")===!0&&sC(!0)),nr){const e=gs.apply(null,t);nr(e)}},ms=function(t){return function(...e){nt(t,...e)}},dl=function(...t){const e="FIREBASE INTERNAL ERROR: "+gs(...t);Mr.error(e)},cr=function(...t){const e=`FIREBASE FATAL ERROR: ${gs(...t)}`;throw Mr.error(e),new Error(e)},gt=function(...t){const e="FIREBASE WARNING: "+gs(...t);Mr.warn(e)},oC=function(){typeof window!="undefined"&&window.location&&window.location.protocol&&window.location.protocol.indexOf("https:")!==-1&&gt("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().")},vc=function(t){return typeof t=="number"&&(t!==t||t===Number.POSITIVE_INFINITY||t===Number.NEGATIVE_INFINITY)},aC=function(t){if(document.readyState==="complete")t();else{let e=!1;const n=function(){if(!document.body){setTimeout(n,Math.floor(10));return}e||(e=!0,t())};document.addEventListener?(document.addEventListener("DOMContentLoaded",n,!1),window.addEventListener("load",n,!1)):document.attachEvent&&(document.attachEvent("onreadystatechange",()=>{document.readyState==="complete"&&n()}),window.attachEvent("onload",n))}},jr="[MIN_NAME]",ur="[MAX_NAME]",mr=function(t,e){if(t===e)return 0;if(t===jr||e===ur)return-1;if(e===jr||t===ur)return 1;{const n=wd(t),r=wd(e);return n!==null?r!==null?n-r===0?t.length-e.length:n-r:-1:r!==null?1:t<e?-1:1}},lC=function(t,e){return t===e?0:t<e?-1:1},yi=function(t,e){if(e&&t in e)return e[t];throw new Error("Missing required key ("+t+") in object: "+Ve(e))},bc=function(t){if(typeof t!="object"||t===null)return Ve(t);const e=[];for(const r in t)e.push(r);e.sort();let n="{";for(let r=0;r<e.length;r++)r!==0&&(n+=","),n+=Ve(e[r]),n+=":",n+=bc(t[e[r]]);return n+="}",n},Pp=function(t,e){const n=t.length;if(n<=e)return[t];const r=[];for(let i=0;i<n;i+=e)i+e>n?r.push(t.substring(i,n)):r.push(t.substring(i,i+e));return r};function st(t,e){for(const n in t)t.hasOwnProperty(n)&&e(n,t[n])}const Ap=function(t){P(!vc(t),"Invalid JSON number");const e=11,n=52,r=(1<<e-1)-1;let i,s,o,a,l;t===0?(s=0,o=0,i=1/t===-1/0?1:0):(i=t<0,t=Math.abs(t),t>=Math.pow(2,1-r)?(a=Math.min(Math.floor(Math.log(t)/Math.LN2),r),s=a+r,o=Math.round(t*Math.pow(2,n-a)-Math.pow(2,n))):(s=0,o=Math.round(t/Math.pow(2,1-r-n))));const c=[];for(l=n;l;l-=1)c.push(o%2?1:0),o=Math.floor(o/2);for(l=e;l;l-=1)c.push(s%2?1:0),s=Math.floor(s/2);c.push(i?1:0),c.reverse();const u=c.join("");let d="";for(l=0;l<64;l+=8){let h=parseInt(u.substr(l,8),2).toString(16);h.length===1&&(h="0"+h),d=d+h}return d.toLowerCase()},cC=function(){return!!(typeof window=="object"&&window.chrome&&window.chrome.extension&&!/^chrome/.test(window.location.href))},uC=function(){return typeof Windows=="object"&&typeof Windows.UI=="object"};function dC(t,e){let n="Unknown Error";t==="too_big"?n="The data requested exceeds the maximum size that can be accessed with a single request.":t==="permission_denied"?n="Client doesn't have permission to access the desired data.":t==="unavailable"&&(n="The service is unavailable");const r=new Error(t+" at "+e._path.toString()+": "+n);return r.code=t.toUpperCase(),r}const hC=new RegExp("^-?(0*)\\d{1,10}$"),fC=-2147483648,pC=2147483647,wd=function(t){if(hC.test(t)){const e=Number(t);if(e>=fC&&e<=pC)return e}return null},oi=function(t){try{t()}catch(e){setTimeout(()=>{const n=e.stack||"";throw gt("Exception was thrown by user callback.",n),e},Math.floor(0))}},gC=function(){return(typeof window=="object"&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0},Li=function(t,e){const n=setTimeout(t,e);return typeof n=="object"&&n.unref&&n.unref(),n};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _C{constructor(e,n,r){this.appName_=e,this.firebaseOptions_=n,this.authProvider_=r,this.auth_=null,this.auth_=r.getImmediate({optional:!0}),this.auth_||r.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(n=>n&&n.code==="auth/token-not-initialized"?(nt("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(n)):new Promise((n,r)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(n,r):n(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(n=>n.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(n=>n.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',gt(e)}}class hl{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}hl.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yc="5",Np="v",kp="s",Op="r",Mp="f",Dp=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,Lp="ls",vC="p",fl="ac",Fp="websocket",$p="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ra={},Pa={};function wc(t){const e=t.toString();return Ra[e]||(Ra[e]=new wC),Ra[e]}function CC(t,e){const n=t.toString();return Pa[n]||(Pa[n]=e()),Pa[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ec{constructor(e){this.initTransports_(e)}static get ALL_TRANSPORTS(){return[Rr,Ot]}initTransports_(e){const n=Ot&&Ot.isAvailable();let r=n&&!Ot.previouslyFailed();if(e.webSocketOnly&&(n||gt("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),r=!0),r)this.transports_=[Ot];else{const i=this.transports_=[];for(const s of Ec.ALL_TRANSPORTS)s&&s.isAvailable()&&i.push(s)}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo extends qp{constructor(){super(["online"]),this.online_=!0,typeof window!="undefined"&&typeof window.addEventListener!="undefined"&&!oc()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new mo}getInitialEvent(e){return P(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nE(t,e){return mr(t.name,e.name)}function xc(t,e){return mr(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Md="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",pE=function(){let t=0;const e=[];return function(n){const r=n===t;t=n;let i;const s=new Array(8);for(i=7;i>=0;i--)s[i]=Md.charAt(n%64),n=Math.floor(n/64);P(n===0,"Cannot push at time == 0");let o=s.join("");if(r){for(i=11;i>=0&&e[i]===63;i--)e[i]=0;e[i]++}else for(i=0;i<12;i++)e[i]=Math.floor(Math.random()*64);for(i=0;i<12;i++)o+=Md.charAt(e[i]);return P(o.length===20,"nextPushId: Length should be 20."),o}}();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pc{constructor(){this.limitSet_=!1,this.startSet_=!1,this.startNameSet_=!1,this.startAfterSet_=!1,this.endSet_=!1,this.endNameSet_=!1,this.endBeforeSet_=!1,this.limit_=0,this.viewFrom_="",this.indexStartValue_=null,this.indexStartName_="",this.indexEndValue_=null,this.indexEndName_="",this.index_=$e}hasStart(){return this.startSet_}hasStartAfter(){return this.startAfterSet_}hasEndBefore(){return this.endBeforeSet_}isViewFromLeft(){return this.viewFrom_===""?this.startSet_:this.viewFrom_==="l"}getIndexStartValue(){return P(this.startSet_,"Only valid if start has been set"),this.indexStartValue_}getIndexStartName(){return P(this.startSet_,"Only valid if start has been set"),this.startNameSet_?this.indexStartName_:jr}hasEnd(){return this.endSet_}getIndexEndValue(){return P(this.endSet_,"Only valid if end has been set"),this.indexEndValue_}getIndexEndName(){return P(this.endSet_,"Only valid if end has been set"),this.endNameSet_?this.indexEndName_:ur}hasLimit(){return this.limitSet_}hasAnchoredLimit(){return this.limitSet_&&this.viewFrom_!==""}getLimit(){return P(this.limitSet_,"Only valid if limit has been set"),this.limit_}getIndex(){return this.index_}loadsAllData(){return!(this.startSet_||this.endSet_||this.limitSet_)}isDefault(){return this.loadsAllData()&&this.index_===$e}copy(){const e=new Pc;return e.limitSet_=this.limitSet_,e.limit_=this.limit_,e.startSet_=this.startSet_,e.indexStartValue_=this.indexStartValue_,e.startNameSet_=this.startNameSet_,e.indexStartName_=this.indexStartName_,e.endSet_=this.endSet_,e.indexEndValue_=this.indexEndValue_,e.endNameSet_=this.endNameSet_,e.indexEndName_=this.indexEndName_,e.index_=this.index_,e.viewFrom_=this.viewFrom_,e}}function _E(t){return t.loadsAllData()?new Rc(t.getIndex()):t.hasLimit()?new mE(t):new is(t)}function Dd(t){const e={};if(t.isDefault())return e;let n;return t.index_===$e?n="$priority":t.index_===fE?n="$value":t.index_===Dr?n="$key":(P(t.index_ instanceof dE,"Unrecognized index type!"),n=t.index_.toString()),e.orderBy=Ve(n),t.startSet_&&(e.startAt=Ve(t.indexStartValue_),t.startNameSet_&&(e.startAt+=","+Ve(t.indexStartName_))),t.endSet_&&(e.endAt=Ve(t.indexEndValue_),t.endNameSet_&&(e.endAt+=","+Ve(t.indexEndName_))),t.limitSet_&&(t.isViewFromLeft()?e.limitToFirst=t.limit_:e.limitToLast=t.limit_),e}function Ld(t){const e={};if(t.startSet_&&(e.sp=t.indexStartValue_,t.startNameSet_&&(e.sn=t.indexStartName_)),t.endSet_&&(e.ep=t.indexEndValue_,t.endNameSet_&&(e.en=t.indexEndName_)),t.limitSet_){e.l=t.limit_;let n=t.viewFrom_;n===""&&(t.isViewFromLeft()?n="l":n="r"),e.vf=n}return t.index_!==$e&&(e.i=t.index_.toString()),e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yE{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),n=Object.assign({},e);return this.last_&&st(this.last_,(r,i)=>{n[r]=n[r]-i}),this.last_=e,n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fd=10*1e3,wE=30*1e3,CE=5*60*1e3;class EE{constructor(e,n){this.server_=n,this.statsToReport_={},this.statsListener_=new yE(e);const r=Fd+(wE-Fd)*Math.random();Li(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),n={};let r=!1;st(e,(i,s)=>{s>0&&Gt(this.statsToReport_,i)&&(n[i]=s,r=!0)}),r&&this.server_.reportStats(n),Li(this.reportStats_.bind(this),Math.floor(Math.random()*2*CE))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Mt;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Mt||(Mt={}));function Ac(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Nc(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function kc(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yo{constructor(e,n,r){this.path=e,this.affectedTree=n,this.revert=r,this.type=Mt.ACK_USER_WRITE,this.source=Ac()}operationForChild(e){if(le(this.path)){if(this.affectedTree.value!=null)return P(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new Ie(e));return new yo(_e(),n,this.revert)}}else return P(se(this.path)===e,"operationForChild called for unrelated child."),new yo(Ae(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jE{getCompleteChild(e){return null}getChildAfterChild(e,n,r){return null}}const lg=new jE;class Dc{constructor(e,n,r=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=r}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const r=this.optCompleteServerCache_!=null?new Nn(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Mc(this.writes_,e,r)}}getChildAfterChild(e,n,r){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:hr(this.viewCache_),s=zE(this.writes_,i,n,1,r,e);return s.length===0?null:s[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Io;class dg{constructor(){this.views=new Map}}function sT(t){P(!Io,"__referenceConstructor has already been defined"),Io=t}function oT(){return P(Io,"Reference.ts has not been loaded"),Io}function aT(t){return t.views.size===0}function Lc(t,e,n,r){const i=e.source.queryId;if(i!==null){const s=t.views.get(i);return P(s!=null,"SyncTree gave us an op for an invalid query."),Vd(s,e,n,r)}else{let s=[];for(const o of t.views.values())s=s.concat(Vd(o,e,n,r));return s}}function hg(t,e,n,r,i){const s=e._queryIdentifier,o=t.views.get(s);if(!o){let a=Co(n,i?r:null),l=!1;a?l=!0:r instanceof Y?(a=Oc(n,r),l=!1):(a=Y.EMPTY_NODE,l=!1);const c=ea(new Nn(a,l,!1),new Nn(r,i,!1));return new ZE(e,c)}return o}function lT(t,e,n,r,i,s){const o=hg(t,e,r,i,s);return t.views.has(e._queryIdentifier)||t.views.set(e._queryIdentifier,o),rT(o,n),iT(o,n)}function cT(t,e,n,r){const i=e._queryIdentifier,s=[];let o=[];const a=kn(t);if(i==="default")for(const[l,c]of t.views.entries())o=o.concat(jd(c,n,r)),Wd(c)&&(t.views.delete(l),c.query._queryParams.loadsAllData()||s.push(c.query));else{const l=t.views.get(i);l&&(o=o.concat(jd(l,n,r)),Wd(l)&&(t.views.delete(i),l.query._queryParams.loadsAllData()||s.push(l.query)))}return a&&!kn(t)&&s.push(new(oT())(e._repo,e._path)),{removed:s,events:o}}function fg(t){const e=[];for(const n of t.views.values())n.query._queryParams.loadsAllData()||e.push(n);return e}function xn(t,e){let n=null;for(const r of t.views.values())n=n||nT(r,e);return n}function pg(t,e){if(e._queryParams.loadsAllData())return na(t);{const r=e._queryIdentifier;return t.views.get(r)}}function gg(t,e){return pg(t,e)!=null}function kn(t){return na(t)!=null}function na(t){for(const e of t.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let So;function uT(t){P(!So,"__referenceConstructor has already been defined"),So=t}function dT(){return P(So,"Reference.ts has not been loaded"),So}let hT=1;class qd{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Pe(null),this.pendingWriteTree_=HE(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function mg(t,e,n,r,i){return PE(t.pendingWriteTree_,e,n,r,i),i?ai(t,new dr(Ac(),e,n)):[]}function fT(t,e,n,r){AE(t.pendingWriteTree_,e,n,r);const i=Pe.fromObject(n);return ai(t,new qr(Ac(),e,i))}function wn(t,e,n=!1){const r=NE(t.pendingWriteTree_,e);if(kE(t.pendingWriteTree_,e)){let s=new Pe(null);return r.snap!=null?s=s.set(_e(),!0):st(r.children,o=>{s=s.set(new Ie(o),!0)}),ai(t,new yo(r.path,s,n))}else return[]}function vs(t,e,n){return ai(t,new dr(Nc(),e,n))}function pT(t,e,n){const r=Pe.fromObject(n);return ai(t,new qr(Nc(),e,r))}function gT(t,e){return ai(t,new ss(Nc(),e))}function mT(t,e,n){const r=$c(t,n);if(r){const i=Bc(r),s=i.path,o=i.queryId,a=pt(s,e),l=new ss(kc(o),a);return Uc(t,s,l)}else return[]}function wl(t,e,n,r){const i=e._path,s=t.syncPointTree_.get(i);let o=[];if(s&&(e._queryIdentifier==="default"||gg(s,e))){const a=cT(s,e,n,r);aT(s)&&(t.syncPointTree_=t.syncPointTree_.remove(i));const l=a.removed;o=a.events;const c=l.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=t.syncPointTree_.findOnPath(i,(d,h)=>kn(h));if(c&&!u){const d=t.syncPointTree_.subtree(i);if(!d.isEmpty()){const h=yT(d);for(let _=0;_<h.length;++_){const g=h[_],C=g.query,b=bg(t,g);t.listenProvider_.startListening(Bi(C),xo(t,C),b.hashFn,b.onComplete)}}}!u&&l.length>0&&!r&&(c?t.listenProvider_.stopListening(Bi(e),null):l.forEach(d=>{const h=t.queryToTagMap.get(ra(d));t.listenProvider_.stopListening(Bi(d),h)})),wT(t,l)}return o}function _T(t,e,n,r){const i=$c(t,r);if(i!=null){const s=Bc(i),o=s.path,a=s.queryId,l=pt(o,e),c=new dr(kc(a),l,n);return Uc(t,o,c)}else return[]}function vT(t,e,n,r){const i=$c(t,r);if(i){const s=Bc(i),o=s.path,a=s.queryId,l=pt(o,e),c=Pe.fromObject(n),u=new qr(kc(a),l,c);return Uc(t,o,u)}else return[]}function Kd(t,e,n){const r=e._path;let i=null,s=!1;t.syncPointTree_.foreachOnPath(r,(d,h)=>{const _=pt(d,r);i=i||xn(h,_),s=s||kn(h)});let o=t.syncPointTree_.get(r);o?(s=s||kn(o),i=i||xn(o,_e())):(o=new dg,t.syncPointTree_=t.syncPointTree_.set(r,o));let a;i!=null?a=!0:(a=!1,i=Y.EMPTY_NODE,t.syncPointTree_.subtree(r).foreachChild((h,_)=>{const g=xn(_,_e());g&&(i=i.updateImmediateChild(h,g))}));const l=gg(o,e);if(!l&&!e._queryParams.loadsAllData()){const d=ra(e);P(!t.queryToTagMap.has(d),"View does not exist, but we have a tag");const h=CT();t.queryToTagMap.set(d,h),t.tagToQueryMap.set(h,d)}const c=ta(t.pendingWriteTree_,r);let u=lT(o,e,n,c,i,a);if(!l&&!s){const d=pg(o,e);u=u.concat(ET(t,e,d))}return u}function Fc(t,e,n){const i=t.pendingWriteTree_,s=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=pt(o,e),c=xn(a,l);if(c)return c});return sg(i,e,s,n,!0)}function bT(t,e){const n=e._path;let r=null;t.syncPointTree_.foreachOnPath(n,(c,u)=>{const d=pt(c,n);r=r||xn(u,d)});let i=t.syncPointTree_.get(n);i?r=r||xn(i,_e()):(i=new dg,t.syncPointTree_=t.syncPointTree_.set(n,i));const s=r!=null,o=s?new Nn(r,!0,!1):null,a=ta(t.pendingWriteTree_,e._path),l=hg(i,e,a,s?o.getNode():Y.EMPTY_NODE,s);return tT(l)}function ai(t,e){return _g(e,t.syncPointTree_,null,ta(t.pendingWriteTree_,_e()))}function _g(t,e,n,r){if(le(t.path))return vg(t,e,n,r);{const i=e.get(_e());n==null&&i!=null&&(n=xn(i,_e()));let s=[];const o=se(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const c=n?n.getImmediateChild(o):null,u=og(r,o);s=s.concat(_g(a,l,c,u))}return i&&(s=s.concat(Lc(i,t,r,n))),s}}function vg(t,e,n,r){const i=e.get(_e());n==null&&i!=null&&(n=xn(i,_e()));let s=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,c=og(r,o),u=t.operationForChild(o);u&&(s=s.concat(vg(u,a,l,c)))}),i&&(s=s.concat(Lc(i,t,r,n))),s}function bg(t,e){const n=e.query,r=xo(t,n);return{hashFn:()=>(eT(e)||Y.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return r?mT(t,n._path,r):gT(t,n._path);{const s=dC(i,n);return wl(t,n,null,s)}}}}function xo(t,e){const n=ra(e);return t.queryToTagMap.get(n)}function ra(t){return t._path.toString()+"$"+t._queryIdentifier}function $c(t,e){return t.tagToQueryMap.get(e)}function Bc(t){const e=t.indexOf("$");return P(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new Ie(t.substr(0,e))}}function Uc(t,e,n){const r=t.syncPointTree_.get(e);P(r,"Missing sync point for query tag that we're tracking");const i=ta(t.pendingWriteTree_,e);return Lc(r,n,i,null)}function yT(t){return t.fold((e,n,r)=>{if(n&&kn(n))return[na(n)];{let i=[];return n&&(i=fg(n)),st(r,(s,o)=>{i=i.concat(o)}),i}})}function Bi(t){return t._queryParams.loadsAllData()&&!t._queryParams.isDefault()?new(dT())(t._repo,t._path):t}function wT(t,e){for(let n=0;n<e.length;++n){const r=e[n];if(!r._queryParams.loadsAllData()){const i=ra(r),s=t.queryToTagMap.get(i);t.queryToTagMap.delete(i),t.tagToQueryMap.delete(s)}}}function CT(){return hT++}function ET(t,e,n){const r=e._path,i=xo(t,e),s=bg(t,n),o=t.listenProvider_.startListening(Bi(e),i,s.hashFn,s.onComplete),a=t.syncPointTree_.subtree(r);if(i)P(!kn(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,u,d)=>{if(!le(c)&&u&&kn(u))return[na(u).query];{let h=[];return u&&(h=h.concat(fg(u).map(_=>_.query))),st(d,(_,g)=>{h=h.concat(g)}),h}});for(let c=0;c<l.length;++c){const u=l[c];t.listenProvider_.stopListening(Bi(u),xo(t,u))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hc{constructor(e){this.node_=e}getImmediateChild(e){const n=this.node_.getImmediateChild(e);return new Hc(n)}node(){return this.node_}}class zc{constructor(e,n){this.syncTree_=e,this.path_=n}getImmediateChild(e){const n=Fe(this.path_,e);return new zc(this.syncTree_,n)}node(){return Fc(this.syncTree_,this.path_)}}const TT=function(t){return t=t||{},t.timestamp=t.timestamp||new Date().getTime(),t},Gd=function(t,e,n){if(!t||typeof t!="object")return t;if(P(".sv"in t,"Unexpected leaf node or priority contents"),typeof t[".sv"]=="string")return IT(t[".sv"],e,n);if(typeof t[".sv"]=="object")return ST(t[".sv"],e);P(!1,"Unexpected server value: "+JSON.stringify(t,null,2))},IT=function(t,e,n){switch(t){case"timestamp":return n.timestamp;default:P(!1,"Unexpected server value: "+t)}},ST=function(t,e,n){t.hasOwnProperty("increment")||P(!1,"Unexpected server value: "+JSON.stringify(t,null,2));const r=t.increment;typeof r!="number"&&P(!1,"Unexpected increment value: "+r);const i=e.node();if(P(i!==null&&typeof i!="undefined","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return r;const o=i.getValue();return typeof o!="number"?r:o+r},yg=function(t,e,n,r){return Wc(e,new zc(n,t),r)},wg=function(t,e,n){return Wc(t,new Hc(e),n)};function Wc(t,e,n){const r=t.getPriority().val(),i=Gd(r,e.getImmediateChild(".priority"),n);let s;if(t.isLeafNode()){const o=t,a=Gd(o.getValue(),e,n);return a!==o.getValue()||i!==o.getPriority().val()?new Ge(a,je(i)):t}else{const o=t;return s=o,i!==o.getPriority().val()&&(s=s.updatePriority(new Ge(i))),o.forEachChild($e,(a,l)=>{const c=Wc(l,e.getImmediateChild(a),n);c!==l&&(s=s.updateImmediateChild(a,c))}),s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AT=/[\[\].#$\/\u0000-\u001F\u007F]/,NT=/[\[\].#$\u0000-\u001F\u007F]/,Oa=10*1024*1024,qc=function(t){return typeof t=="string"&&t.length!==0&&!AT.test(t)},Ig=function(t){return typeof t=="string"&&t.length!==0&&!NT.test(t)},kT=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),Ig(t)},OT=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!vc(t)||t&&typeof t=="object"&&Gt(t,".sv")},Sg=function(t,e,n,r){r&&e===void 0||sa(Ko(t,"value"),e,n)},sa=function(t,e,n){const r=n instanceof Ie?new KC(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Wn(r));if(typeof e=="function")throw new Error(t+"contains a function "+Wn(r)+" with contents = "+e.toString());if(vc(e))throw new Error(t+"contains "+e.toString()+" "+Wn(r));if(typeof e=="string"&&e.length>Oa/3&&Go(e)>Oa)throw new Error(t+"contains a string greater than "+Oa+" utf8 bytes "+Wn(r)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,s=!1;if(st(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(s=!0,!qc(o)))throw new Error(t+" contains an invalid key ("+o+") "+Wn(r)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);GC(r,o),sa(t,a,r),YC(r)}),i&&s)throw new Error(t+' contains ".value" child '+Wn(r)+" in addition to actual children.")}},MT=function(t,e){let n,r;for(n=0;n<e.length;n++){r=e[n];const s=ts(r);for(let o=0;o<s.length;o++)if(!(s[o]===".priority"&&o===s.length-1)){if(!qc(s[o]))throw new Error(t+"contains an invalid key ("+s[o]+") in path "+r.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(qC);let i=null;for(n=0;n<e.length;n++){if(r=e[n],i!==null&&Pt(i,r))throw new Error(t+"contains a path "+i.toString()+" that is ancestor of another path "+r.toString());i=r}},DT=function(t,e,n,r){if(r&&e===void 0)return;const i=Ko(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(i+" must be an object containing the children to replace.");const s=[];st(e,(o,a)=>{const l=new Ie(o);if(sa(i,a,Fe(n,l)),Tc(l)===".priority"&&!OT(a))throw new Error(i+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");s.push(l)}),MT(i,s)},xg=function(t,e,n,r){if(!(r&&n===void 0)&&!Ig(n))throw new Error(Ko(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},LT=function(t,e,n,r){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),xg(t,e,n,r)},Kc=function(t,e){if(se(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},FT=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!qc(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!kT(n))throw new Error(Ko(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $T{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function oa(t,e){let n=null;for(let r=0;r<e.length;r++){const i=e[r],s=i.getPath();n!==null&&!Ic(s,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:s}),n.events.push(i)}n&&t.eventLists_.push(n)}function Gc(t,e,n){oa(t,n),Rg(t,r=>Ic(r,e))}function Ft(t,e,n){oa(t,n),Rg(t,r=>Pt(r,e)||Pt(e,r))}function Rg(t,e){t.recursionDepth_++;let n=!0;for(let r=0;r<t.eventLists_.length;r++){const i=t.eventLists_[r];if(i){const s=i.path;e(s)?(BT(t.eventLists_[r]),t.eventLists_[r]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function BT(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const r=n.getEventRunner();nr&&nt("event: "+n.toString()),oi(r)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const UT="repo_interrupt",HT=25;class zT{constructor(e,n,r,i){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=r,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new $T,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=bo(),this.transactionQueueTree_=new jc,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function WT(t,e,n){if(t.stats_=wc(t.repoInfo_),t.forceRestClient_||gC())t.server_=new vo(t.repoInfo_,(r,i,s,o)=>{Yd(t,r,i,s,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>Xd(t,!0),0);else{if(typeof n!="undefined"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{Ve(n)}catch(r){throw new Error("Invalid authOverride provided: "+r)}}t.persistentConnection_=new tn(t.repoInfo_,e,(r,i,s,o)=>{Yd(t,r,i,s,o)},r=>{Xd(t,r)},r=>{jT(t,r)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(r=>{t.server_.refreshAuthToken(r)}),t.appCheckProvider_.addTokenChangeListener(r=>{t.server_.refreshAppCheckToken(r.token)}),t.statsReporter_=CC(t.repoInfo_,()=>new EE(t.stats_,t.server_)),t.infoData_=new vE,t.infoSyncTree_=new qd({startListening:(r,i,s,o)=>{let a=[];const l=t.infoData_.getNode(r._path);return l.isEmpty()||(a=vs(t.infoSyncTree_,r._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),Yc(t,"connected",!1),t.serverSyncTree_=new qd({startListening:(r,i,s,o)=>(t.server_.listen(r,s,i,(a,l)=>{const c=o(a,l);Ft(t.eventQueue_,r._path,c)}),[]),stopListening:(r,i)=>{t.server_.unlisten(r,i)}})}function Pg(t){const n=t.infoData_.getNode(new Ie(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function aa(t){return TT({timestamp:Pg(t)})}function Yd(t,e,n,r,i){t.dataUpdateCount++;const s=new Ie(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(i)if(r){const l=ao(n,c=>je(c));o=vT(t.serverSyncTree_,s,l,i)}else{const l=je(n);o=_T(t.serverSyncTree_,s,l,i)}else if(r){const l=ao(n,c=>je(c));o=pT(t.serverSyncTree_,s,l)}else{const l=je(n);o=vs(t.serverSyncTree_,s,l)}let a=s;o.length>0&&(a=Gr(t,s)),Ft(t.eventQueue_,a,o)}function Xd(t,e){Yc(t,"connected",e),e===!1&&GT(t)}function jT(t,e){st(e,(n,r)=>{Yc(t,n,r)})}function Yc(t,e,n){const r=new Ie("/.info/"+e),i=je(n);t.infoData_.updateSnapshot(r,i);const s=vs(t.infoSyncTree_,r,i);Ft(t.eventQueue_,r,s)}function Xc(t){return t.nextWriteId_++}function VT(t,e){const n=bT(t.serverSyncTree_,e);return n!=null?Promise.resolve(n):t.server_.get(e).then(r=>{const i=je(r).withIndex(e._queryParams.getIndex()),s=vs(t.serverSyncTree_,e._path,i);return Gc(t.eventQueue_,e._path,s),Promise.resolve(i)},r=>(ys(t,"get for query "+Ve(e)+" failed: "+r),Promise.reject(new Error(r))))}function qT(t,e,n,r,i){ys(t,"set",{path:e.toString(),value:n,priority:r});const s=aa(t),o=je(n,r),a=Fc(t.serverSyncTree_,e),l=wg(o,a,s),c=Xc(t),u=mg(t.serverSyncTree_,e,l,c,!0);oa(t.eventQueue_,u),t.server_.put(e.toString(),o.val(!0),(h,_)=>{const g=h==="ok";g||gt("set at "+e+" failed: "+h);const C=wn(t.serverSyncTree_,c,!g);Ft(t.eventQueue_,e,C),El(t,i,h,_)});const d=Qc(t,e);Gr(t,d),Ft(t.eventQueue_,d,[])}function KT(t,e,n,r){ys(t,"update",{path:e.toString(),value:n});let i=!0;const s=aa(t),o={};if(st(n,(a,l)=>{i=!1,o[a]=yg(Fe(e,a),je(l),t.serverSyncTree_,s)}),i)nt("update() called with empty data.  Don't do anything."),El(t,r,"ok",void 0);else{const a=Xc(t),l=fT(t.serverSyncTree_,e,o,a);oa(t.eventQueue_,l),t.server_.merge(e.toString(),n,(c,u)=>{const d=c==="ok";d||gt("update at "+e+" failed: "+c);const h=wn(t.serverSyncTree_,a,!d),_=h.length>0?Gr(t,e):e;Ft(t.eventQueue_,_,h),El(t,r,c,u)}),st(n,c=>{const u=Qc(t,Fe(e,c));Gr(t,u)}),Ft(t.eventQueue_,e,[])}}function GT(t){ys(t,"onDisconnectEvents");const e=aa(t),n=bo();gl(t.onDisconnect_,_e(),(i,s)=>{const o=yg(i,s,t.serverSyncTree_,e);tg(n,i,o)});let r=[];gl(n,_e(),(i,s)=>{r=r.concat(vs(t.serverSyncTree_,i,s));const o=Qc(t,i);Gr(t,o)}),t.onDisconnect_=bo(),Ft(t.eventQueue_,_e(),r)}function YT(t,e,n){let r;se(e._path)===".info"?r=Kd(t.infoSyncTree_,e,n):r=Kd(t.serverSyncTree_,e,n),Gc(t.eventQueue_,e._path,r)}function Jd(t,e,n){let r;se(e._path)===".info"?r=wl(t.infoSyncTree_,e,n):r=wl(t.serverSyncTree_,e,n),Gc(t.eventQueue_,e._path,r)}function XT(t){t.persistentConnection_&&t.persistentConnection_.interrupt(UT)}function ys(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),nt(n,...e)}function El(t,e,n,r){e&&oi(()=>{if(n==="ok")e(null);else{const i=(n||"error").toUpperCase();let s=i;r&&(s+=": "+r);const o=new Error(s);o.code=i,e(o)}})}function Ag(t,e,n){return Fc(t.serverSyncTree_,e,n)||Y.EMPTY_NODE}function Jc(t,e=t.transactionQueueTree_){if(e||la(t,e),li(e)){const n=kg(t,e);P(n.length>0,"Sending zero length transaction queue"),n.every(i=>i.status===0)&&JT(t,bs(e),n)}else Eg(e)&&ia(e,n=>{Jc(t,n)})}function JT(t,e,n){const r=n.map(c=>c.currentWriteId),i=Ag(t,e,r);let s=i;const o=i.hash();for(let c=0;c<n.length;c++){const u=n[c];P(u.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),u.status=1,u.retryCount++;const d=pt(e,u.path);s=s.updateChild(d,u.currentOutputSnapshotRaw)}const a=s.val(!0),l=e;t.server_.put(l.toString(),a,c=>{ys(t,"transaction put response",{path:l.toString(),status:c});let u=[];if(c==="ok"){const d=[];for(let h=0;h<n.length;h++)n[h].status=2,u=u.concat(wn(t.serverSyncTree_,n[h].currentWriteId)),n[h].onComplete&&d.push(()=>n[h].onComplete(null,!0,n[h].currentOutputSnapshotResolved)),n[h].unwatcher();la(t,Vc(t.transactionQueueTree_,e)),Jc(t,t.transactionQueueTree_),Ft(t.eventQueue_,e,u);for(let h=0;h<d.length;h++)oi(d[h])}else{if(c==="datastale")for(let d=0;d<n.length;d++)n[d].status===3?n[d].status=4:n[d].status=0;else{gt("transaction at "+l.toString()+" failed: "+c);for(let d=0;d<n.length;d++)n[d].status=4,n[d].abortReason=c}Gr(t,e)}},o)}function Gr(t,e){const n=Ng(t,e),r=bs(n),i=kg(t,n);return QT(t,i,r),r}function QT(t,e,n){if(e.length===0)return;const r=[];let i=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=pt(n,l.path);let u=!1,d;if(P(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)u=!0,d=l.abortReason,i=i.concat(wn(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=HT)u=!0,d="maxretry",i=i.concat(wn(t.serverSyncTree_,l.currentWriteId,!0));else{const h=Ag(t,l.path,o);l.currentInputSnapshot=h;const _=e[a].update(h.val());if(_!==void 0){sa("transaction failed: Data returned ",_,l.path);let g=je(_);typeof _=="object"&&_!=null&&Gt(_,".priority")||(g=g.updatePriority(h.getPriority()));const b=l.currentWriteId,O=aa(t),H=wg(g,h,O);l.currentOutputSnapshotRaw=g,l.currentOutputSnapshotResolved=H,l.currentWriteId=Xc(t),o.splice(o.indexOf(b),1),i=i.concat(mg(t.serverSyncTree_,l.path,H,l.currentWriteId,l.applyLocally)),i=i.concat(wn(t.serverSyncTree_,b,!0))}else u=!0,d="nodata",i=i.concat(wn(t.serverSyncTree_,l.currentWriteId,!0))}Ft(t.eventQueue_,n,i),i=[],u&&(e[a].status=2,function(h){setTimeout(h,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(d==="nodata"?r.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):r.push(()=>e[a].onComplete(new Error(d),!1,null))))}la(t,t.transactionQueueTree_);for(let a=0;a<r.length;a++)oi(r[a]);Jc(t,t.transactionQueueTree_)}function Ng(t,e){let n,r=t.transactionQueueTree_;for(n=se(e);n!==null&&li(r)===void 0;)r=Vc(r,n),e=Ae(e),n=se(e);return r}function kg(t,e){const n=[];return Og(t,e,n),n.sort((r,i)=>r.order-i.order),n}function Og(t,e,n){const r=li(e);if(r)for(let i=0;i<r.length;i++)n.push(r[i]);ia(e,i=>{Og(t,i,n)})}function la(t,e){const n=li(e);if(n){let r=0;for(let i=0;i<n.length;i++)n[i].status!==2&&(n[r]=n[i],r++);n.length=r,Cg(e,n.length>0?n:void 0)}ia(e,r=>{la(t,r)})}function Qc(t,e){const n=bs(Ng(t,e)),r=Vc(t.transactionQueueTree_,e);return RT(r,i=>{Ma(t,i)}),Ma(t,r),Tg(r,i=>{Ma(t,i)}),n}function Ma(t,e){const n=li(e);if(n){const r=[];let i=[],s=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(P(s===o-1,"All SENT items should be at beginning of queue."),s=o,n[o].status=3,n[o].abortReason="set"):(P(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),i=i.concat(wn(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&r.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));s===-1?Cg(e,void 0):n.length=s+1,Ft(t.eventQueue_,bs(e),i);for(let o=0;o<r.length;o++)oi(r[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zc{constructor(e,n,r,i){this._repo=e,this._path=n,this._queryParams=r,this._orderByCalled=i}get key(){return le(this._path)?null:Tc(this._path)}get ref(){return new Yt(this._repo,this._path)}get _queryIdentifier(){const e=Ld(this._queryParams),n=bc(e);return n==="{}"?"default":n}get _queryObject(){return Ld(this._queryParams)}isEqual(e){if(e=Ut(e),!(e instanceof Zc))return!1;const n=this._repo===e._repo,r=Ic(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return n&&r&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+VC(this._path)}}class Yt extends Zc{constructor(e,n){super(e,n,new Pc,!1)}get parent(){const e=Kp(this._path);return e===null?null:new Yt(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Yr{constructor(e,n,r){this._node=e,this.ref=n,this._index=r}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new Ie(e),r=Xr(this.ref,e);return new Yr(this._node.getChild(n),r,$e)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(r,i)=>e(new Yr(i,Xr(this.ref,r),$e)))}hasChild(e){const n=new Ie(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function $t(t,e){return t=Ut(t),t._checkNotDeleted("ref"),e!==void 0?Xr(t._root,e):t._root}function Xr(t,e){return t=Ut(t),se(t._path)===null?LT("child","path",e,!1):xg("child","path",e,!1),new Yt(t._repo,Fe(t._path,e))}function eu(t,e){t=Ut(t),Kc("push",t._path),Sg("push",e,t._path,!0);const n=Pg(t._repo),r=pE(n),i=Xr(t,r),s=Xr(t,r);let o;return e!=null?o=tu(s,e).then(()=>s):o=Promise.resolve(s),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function rI(t){return Kc("remove",t._path),tu(t,null)}function tu(t,e){t=Ut(t),Kc("set",t._path),Sg("set",e,t._path,!1);const n=new cs;return qT(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}function Lg(t,e){DT("update",e,t._path,!1);const n=new cs;return KT(t._repo,t._path,e,n.wrapCallback(()=>{})),n.promise}function Fg(t){return t=Ut(t),VT(t._repo,t).then(e=>new Yr(e,new Yt(t._repo,t._path),t._queryParams.getIndex()))}class nu{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const r=n._queryParams.getIndex();return new Mg("value",this,new Yr(e.snapshotNode,new Yt(n._repo,n._path),r))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Dg(this,e,n):null}matches(e){return e instanceof nu?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class ru{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new Dg(this,e,n):null}createEvent(e,n){P(e.childName!=null,"Child events should have a childName.");const r=Xr(new Yt(n._repo,n._path),e.childName),i=n._queryParams.getIndex();return new Mg(e.type,this,new Yr(e.snapshotNode,r,i),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof ru?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function iI(t,e,n,r,i){let s;if(typeof r=="object"&&(s=void 0,i=r),typeof r=="function"&&(s=r),i&&i.onlyOnce){const l=n,c=(u,d)=>{Jd(t._repo,t,a),l(u,d)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new nI(n,s||void 0),a=e==="value"?new nu(o):new ru(e,o);return YT(t._repo,t,a),()=>Jd(t._repo,t,a)}function Tl(t,e,n,r){return iI(t,"value",e,n,r)}sT(Yt);uT(Yt);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sI="FIREBASE_DATABASE_EMULATOR_HOST",Il={};let oI=!1;function aI(t,e,n,r,i){let s=r||t.options.databaseURL;s===void 0&&(t.options.projectId||cr("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),nt("Using default host for project ",t.options.projectId),s=`${t.options.projectId}-default-rtdb.firebaseio.com`);let o=Qd(s,i),a=o.repoInfo,l,c;typeof process!="undefined"&&process.env&&(c=process.env[sI]),c?(l=!0,s=`http://${c}?ns=${a.namespace}`,o=Qd(s,i),a=o.repoInfo):l=!o.repoInfo.secure;const u=i&&l?new hl(hl.OWNER):new _C(t.name,t.options,e);FT("Invalid Firebase Database URL",o),le(o.path)||cr("Database URL must point to the root of a Firebase Database (not including a child path).");const d=cI(a,t,u,new mC(t.name,n));return new uI(d,t)}function lI(t,e){const n=Il[e];(!n||n[t.key]!==t)&&cr(`Database ${e}(${t.repoInfo_}) has already been deleted.`),XT(t),delete n[t.key]}function cI(t,e,n,r){let i=Il[e.name];i||(i={},Il[e.name]=i);let s=i[t.toURLString()];return s&&cr("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),s=new zT(t,oI,n,r),i[t.toURLString()]=s,s}class uI{constructor(e,n){this._repoInternal=e,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(WT(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Yt(this._repo,_e())),this._rootInternal}_delete(){return this._rootInternal!==null&&(lI(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&cr("Cannot call "+e+" on a deleted database.")}}function dI(t=Kf(),e){return cc(t,"database").getImmediate({identifier:e})}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hI(t){tC(ds),Wr(new or("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return aI(r,i,s,n)},"PUBLIC").setMultipleInstances(!0)),In(vd,bd,t),In(vd,bd,"esm2017")}tn.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};tn.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};hI();const fI={apiKey:"AIzaSyAsXHXd9Spu67AO6DV06x2E_EnVOIAu9UU",authDomain:"quick-retro.firebaseapp.com",projectId:"quick-retro",storageBucket:"quick-retro.appspot.com",messagingSenderId:"293134428599",appId:"1:293134428599:web:bad71d4fedbda8080ce032",databaseURL:"https://quick-retro-default-rtdb.europe-west1.firebasedatabase.app"},pI=n0(fI),Bt=dI(pI),Os=gr({});function gI(t){if(!t)return Os;const e=$t(Bt,`users/${t}/boards`),n={};Tl(e,r,s);function r(o){const a=o.exists()?Object.values(o.val()):[];for(const l of a){if(n[l])continue;const c=Tl($t(Bt,`boards/${l}`),i.bind(null,l),s);n[l]=c}for(const l in n)a.includes(l)||(n[l](),delete n[l],console.log("delete",l),delete Os[l])}function i(o,a){Os[o]=a.val()}function s(o){console.error(o)}return Os}function mI(t){const e=gr({loading:!0});Tl($t(Bt,`boards/${t}`),r=>{e.exists=r.exists(),e.loading=!1,e.exists&&Object.entries(r.val()).forEach(([i,s])=>{e[i]=s})},n);function n(r){console.log(r),e.exists=!1,e.loading=!1}return e}function _I(t,e){const n=$t(Bt,`boards/${t}`);Lg(n,{cardsHidden:e})}function vI(t,e){const n=$t(Bt,`boards/${t}`);Lg(n,{title:e})}function bI(t,e,n){const r=$t(Bt,`boards/${t}/columns/${e}/cards`);eu(r,n)}function yI(t,e,n){rI($t(Bt,`boards/${t}/columns/${e}/cards/${n}`))}async function wI(t,e){const n=$t(Bt,"boards"),r=await eu(n,{author:t,cardsHidden:!0,title:"",columns:e.columns.map(i=>gu(pu({},i),{cards:{}}))});if(!!r.key)return await $g(t,r.key),r.key}async function CI(t,e){const n=$t(Bt,`users/${t}/boards`),r=await Fg(n);if(!r.exists())return;const i=Object.fromEntries(Object.entries(r.val()).filter(([s,o])=>e!==o));await tu(n,i)}async function $g(t,e){const n=await Fg($t(Bt,`users/${t}/boards`));if((n.exists()?Object.values(n.val()):[]).includes(e))return;const i=$t(Bt,`users/${t}/boards`);await eu(i,e)}function EI(){const t=gr({}),e=eC();return U0(e).catch(n=>{console.error(n)}),j0(e,n=>{n&&Object.entries(n).forEach(([r,i])=>{t[r]=i})}),t}var an=(t,e)=>{const n=t.__vccOpts||t;for(const[r,i]of e)n[r]=i;return n};const TI=Be({props:{text:null},setup(t){return(e,n)=>(Te(),Je("button",null,Fr(t.text),1))}});var II=an(TI,[["__scopeId","data-v-1ee2b704"]]);function SI(t,e){const n=t.trim().split(/\s+/g),r={top:n[0]};switch(n.length){case 1:r.right=n[0],r.bottom=n[0],r.left=n[0];break;case 2:r.right=n[1],r.left=n[1],r.bottom=n[0];break;case 3:r.right=n[1],r.bottom=n[2],r.left=n[1];break;case 4:r.right=n[1],r.bottom=n[2],r.left=n[3];break;default:throw new Error("[seemly/getMargin]:"+t+" is not a valid value.")}return e===void 0?r:r[e]}var Zd={black:"#000",silver:"#C0C0C0",gray:"#808080",white:"#FFF",maroon:"#800000",red:"#F00",purple:"#800080",fuchsia:"#F0F",green:"#008000",lime:"#0F0",olive:"#808000",yellow:"#FF0",navy:"#000080",blue:"#00F",teal:"#008080",aqua:"#0FF",transparent:"#0000"};const ci="^\\s*",ui="\\s*$",Gn="\\s*((\\.\\d+)|(\\d+(\\.\\d*)?))\\s*",Yn="([0-9A-Fa-f])",Xn="([0-9A-Fa-f]{2})",xI=new RegExp(`${ci}rgb\\s*\\(${Gn},${Gn},${Gn}\\)${ui}`),RI=new RegExp(`${ci}rgba\\s*\\(${Gn},${Gn},${Gn},${Gn}\\)${ui}`),PI=new RegExp(`${ci}#${Yn}${Yn}${Yn}${ui}`),AI=new RegExp(`${ci}#${Xn}${Xn}${Xn}${ui}`),NI=new RegExp(`${ci}#${Yn}${Yn}${Yn}${Yn}${ui}`),kI=new RegExp(`${ci}#${Xn}${Xn}${Xn}${Xn}${ui}`);function _t(t){return parseInt(t,16)}function fr(t){try{let e;if(e=AI.exec(t))return[_t(e[1]),_t(e[2]),_t(e[3]),1];if(e=xI.exec(t))return[ot(e[1]),ot(e[5]),ot(e[9]),1];if(e=RI.exec(t))return[ot(e[1]),ot(e[5]),ot(e[9]),Ui(e[13])];if(e=PI.exec(t))return[_t(e[1]+e[1]),_t(e[2]+e[2]),_t(e[3]+e[3]),1];if(e=kI.exec(t))return[_t(e[1]),_t(e[2]),_t(e[3]),Ui(_t(e[4])/255)];if(e=NI.exec(t))return[_t(e[1]+e[1]),_t(e[2]+e[2]),_t(e[3]+e[3]),Ui(_t(e[4]+e[4])/255)];if(t in Zd)return fr(Zd[t]);throw new Error(`[seemly/rgba]: Invalid color value ${t}.`)}catch(e){throw e}}function OI(t){return t>1?1:t<0?0:t}function Sl(t,e,n,r){return`rgba(${ot(t)}, ${ot(e)}, ${ot(n)}, ${OI(r)})`}function Da(t,e,n,r,i){return ot((t*e*(1-r)+n*r)/i)}function MI(t,e){Array.isArray(t)||(t=fr(t)),Array.isArray(e)||(e=fr(e));const n=t[3],r=e[3],i=Ui(n+r-n*r);return Sl(Da(t[0],n,e[0],r,i),Da(t[1],n,e[1],r,i),Da(t[2],n,e[2],r,i),i)}function La(t,e){const[n,r,i,s=1]=Array.isArray(t)?t:fr(t);return e.alpha?Sl(n,r,i,e.alpha):Sl(n,r,i,s)}function Ms(t,e){const[n,r,i,s=1]=Array.isArray(t)?t:fr(t),{lightness:o=1,alpha:a=1}=e;return DI([n*o,r*o,i*o,s*a])}function Ui(t){const e=Math.round(Number(t)*100)/100;return e>1?1:e<0?0:e}function ot(t){const e=Math.round(Number(t));return e>255?255:e<0?0:e}function DI(t){const[e,n,r]=t;return 3 in t?`rgba(${ot(e)}, ${ot(n)}, ${ot(r)}, ${Ui(t[3])})`:`rgba(${ot(e)}, ${ot(n)}, ${ot(r)}, 1)`}function ht(t,...e){if(Array.isArray(t))t.forEach(n=>ht(n,...e));else return t(...e)}function LI(t,e){throw new Error(`[naive/${t}]: ${e}`)}function ca(t){return t.some(e=>Ki(e)?!(e.type===It||e.type===Le&&!ca(e.children)):!0)?t:null}function Xs(t,e){return t&&ca(t())||e()}function FI(t,e,n){return t&&ca(t(e))||n(e)}function Ds(t,e){const n=t&&ca(t());return e(n||null)}function $I(t){let e=0;for(let n=0;n<t.length;++n)t[n]==="&"&&++e;return e}const Bg=/\s*,(?![^(]*\))\s*/g,BI=/\s+/g;function UI(t,e){const n=[];return e.split(Bg).forEach(r=>{let i=$I(r);if(i){if(i===1){t.forEach(o=>{n.push(r.replace("&",o))});return}}else{t.forEach(o=>{n.push((o&&o+" ")+r)});return}let s=[r];for(;i--;){const o=[];s.forEach(a=>{t.forEach(l=>{o.push(a.replace("&",l))})}),s=o}s.forEach(o=>n.push(o))}),n}function HI(t,e){const n=[];return e.split(Bg).forEach(r=>{t.forEach(i=>{n.push((i&&i+" ")+r)})}),n}function zI(t){let e=[""];return t.forEach(n=>{n=n&&n.trim(),n&&(n.includes("&")?e=UI(e,n):e=HI(e,n))}),e.join(", ").replace(BI," ")}function eh(t){if(!t)return;const e=t.parentElement;e&&e.removeChild(t)}function ua(t){return document.querySelector(`style[cssr-id="${t}"]`)}function WI(t){const e=document.createElement("style");return e.setAttribute("cssr-id",t),e}function Ls(t){return t?/^\s*@(s|m)/.test(t):!1}const jI=/[A-Z]/g;function Ug(t){return t.replace(jI,e=>"-"+e.toLowerCase())}function VI(t,e="  "){return typeof t=="object"&&t!==null?` {
`+Object.entries(t).map(n=>e+`  ${Ug(n[0])}: ${n[1]};`).join(`
`)+`
`+e+"}":`: ${t};`}function qI(t,e,n){return typeof t=="function"?t({context:e.context,props:n}):t}function th(t,e,n,r){if(!e)return"";const i=qI(e,n,r);if(!i)return"";if(typeof i=="string")return`${t} {
${i}
...
`,[j("input, textarea",`
 ...
 box-shadow: var(--n-box-shadow-focus-${t});
 border: var(--n-border-focus-${t});
 `)])])]))]);const DA=Object.assign(Object.assign({},Es.props),{bordered:{type:Boolean,default:void 0},type:{type:String,default:"text"},placeholder:[Array,String],defaultValue:{type:[String,Array],default:null},value:[String,Array],disabled:{type:Boolean,default:void 0},size:String,rows:{type:[Number,String],default:3},round:Boolean,minlength:[String,Number],maxlength:[String,Number],clearable:Boolean,autosize:{type:[Boolean,Object],default:!1},pair:Boolean,separator:String,readonly:{type:[String,Boolean],default:!1},passivelyActivated:Boolean,showPasswordOn:String,stateful:{type:Boolean,default:!0},autofocus:Boolean,inputProps:Object,resizable:{type:Boolean,default:!0},showCount:Boolean,loading:{type:Boolean,default:void 0},onMousedown:Function,onKeydown:Function,onKeyup:Function,onInput:[Function,Array],onFocus:[Function,Array],onBlur:[Function,Array],onClick:[Function,Array],onChange:[Function,Array],onClear:[Function,Array],status:String,"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],textDecoration:[String,Array],attrSize:{type:Number,default:20},onInputBlur:[Function,Array],onInputFocus:[Function,Array],onDeactivate:[Function,Array],onActivate:[Function,Array],onWrapperFocus:[Function,Array],onWrapperBlur:[Function,Array],internalDeactivateOnEnter:Boolean,internalForceFocus:Boolean,internalLoadingBeforeSuffix:Boolean,showPasswordToggle:Boolean});var LA=Be({name:"Input",props:DA,setup(t){const{mergedClsPrefixRef:e,mergedBorderedRef:n,inlineThemeDisabled:r,mergedRtlRef:i}=Im(t),s=Es("Input","-input",MA,kA,t,e),o=he(null),a=he(null),l=he(null),c=he(null),u=he(null),d=he(null),h=he(null),{localeRef:_}=sA("Input"),g=he(t.defaultValue),C=Do(t,"value"),b=dS(C,g),O=BS(t),{mergedSizeRef:H,mergedDisabledRef:V,mergedStatusRef:z}=O,X=he(!1),me=he(!1),E=he(!1),S=he(!1);let D=null;const q=de(()=>{const{placeholder:m,pair:x}=t;return x?Array.isArray(m)?m:m===void 0?["",""]:[m,m]:m===void 0?[_.value.placeholder]:[m]}),Z=de(()=>{const{value:m}=E,{value:x}=b,{value:J}=q;return!m&&(zs(x)||Array.isArray(x)&&zs(x[0]))&&J[0]}),L=de(()=>{const{value:m}=E,{value:x}=b,{value:J}=q;return!m&&J[1]&&(zs(x)||Array.isArray(x)&&zs(x[1]))}),re=rh(()=>t.internalForceFocus||X.value),ye=rh(()=>{if(V.value||t.readonly||!t.clearable||!re.value&&!me.value)return!1;const{value:m}=b,{value:x}=re;return t.pair?!!(Array.isArray(m)&&(m[0]||m[1]))&&(me.value||x):!!m&&(me.value||x)}),Se=de(()=>{const{showPasswordOn:m}=t;if(m)return m;if(t.showPasswordToggle)return"click"}),ce=he(!1),fe=de(()=>{const{textDecoration:m}=t;return m?Array.isArray(m)?m.map(x=>({textDecoration:x})):[{textDecoration:m}]:["",""]}),ie=he(void 0),Ue=()=>{var m,x;if(t.type==="textarea"){const{autosize:J}=t;if(J&&(ie.value=(x=(m=h.value)===null||m===void 0?void 0:m.$el)===null||x===void 0?void 0:x.offsetWidth),!a.value||typeof J=="boolean")return;const{paddingTop:ze,paddingBottom:We,lineHeight:et}=window.getComputedStyle(a.value),Dn=Number(ze.slice(0,-2)),Ln=Number(We.slice(0,-2)),Fn=Number(et.slice(0,-2)),{value:_i}=l;if(!_i)return;if(J.minRows){const vi=Math.max(J.minRows,1),ma=`${Dn+Ln+Fn*vi}px`;_i.style.minHeight=ma}if(J.maxRows){const vi=`${Dn+Ln+Fn*J.maxRows}px`;_i.style.maxHeight=vi}}},mt=de(()=>{const{maxlength:m}=t;return m===void 0?void 0:Number(m)});ni(()=>{const{value:m}=b;Array.isArray(m)||Ee(m)});const Me=ic().proxy;function ct(m){const{onUpdateValue:x,"onUpdate:value":J,onInput:ze}=t,{nTriggerFormInput:We}=O;x&&ht(x,m),J&&ht(J,m),ze&&ht(ze,m),g.value=m,We()}function ut(m){const{onChange:x}=t,{nTriggerFormChange:J}=O;x&&ht(x,m),g.value=m,J()}function br(m){const{onBlur:x}=t,{nTriggerFormBlur:J}=O;x&&ht(x,m),J()}function gi(m){const{onFocus:x}=t,{nTriggerFormFocus:J}=O;x&&ht(x,m),J()}function mi(m){const{onClear:x}=t;x&&ht(x,m)}function Ke(m){const{onInputBlur:x}=t;x&&ht(x,m)}function cn(m){const{onInputFocus:x}=t;x&&ht(x,m)}function yr(){const{onDeactivate:m}=t;m&&ht(m)}function xt(){const{onActivate:m}=t;m&&ht(m)}function On(m){const{onClick:x}=t;x&&ht(x,m)}function Mn(m){const{onWrapperFocus:x}=t;x&&ht(x,m)}function f(m){const{onWrapperBlur:x}=t;x&&ht(x,m)}function p(){E.value=!0}function v(m){E.value=!1,m.target===d.value?y(m,1):y(m,0)}function y(m,x=0,J="input"){const ze=m.target.value;if(Ee(ze),t.type==="textarea"){const{value:et}=h;et&&et.syncUnifiedContainer()}if(D=ze,E.value)return;const We=ze;if(!t.pair)J==="input"?ct(We):ut(We);else{let{value:et}=b;Array.isArray(et)?et=[...et]:et=["",""],et[x]=We,J==="input"?ct(et):ut(et)}Me.$forceUpdate()}function w(m){Ke(m),m.relatedTarget===o.value&&yr(),m.relatedTarget!==null&&(m.relatedTarget===u.value||m.relatedTarget===d.value||m.relatedTarget===a.value)||(S.value=!1),N(m,"blur")}function A(m){cn(m),X.value=!0,S.value=!0,xt(),N(m,"focus")}function M(m){t.passivelyActivated&&(f(m),N(m,"blur"))}function R(m){t.passivelyActivated&&(X.value=!0,Mn(m),N(m,"focus"))}function N(m,x){m.relatedTarget!==null&&(m.relatedTarget===u.value||m.relatedTarget===d.value||m.relatedTarget===a.value||m.relatedTarget===o.value)||(x==="focus"?(gi(m),X.value=!0):x==="blur"&&(br(m),X.value=!1))}function T(m,x){y(m,x,"change")}function U(m){On(m)}function $(m){mi(m),t.pair?(ct(["",""]),ut(["",""])):(ct(""),ut(""))}function B(m){const{onMousedown:x}=t;x&&x(m);const{tagName:J}=m.target;if(J!=="INPUT"&&J!=="TEXTAREA"){if(t.resizable){const{value:ze}=o;if(ze){const{left:We,top:et,width:Dn,height:Ln}=ze.getBoundingClientRect(),Fn=14;if(We+Dn-Fn<m.clientX&&m.clientY<We+Dn&&et+Ln-Fn<m.clientY&&m.clientY<et+Ln)return}}m.preventDefault(),X.value||G()}}function K(){var m;me.value=!0,t.type==="textarea"&&((m=h.value)===null||m===void 0||m.handleMouseEnterWrapper())}function ae(){var m;me.value=!1,t.type==="textarea"&&((m=h.value)===null||m===void 0||m.handleMouseLeaveWrapper())}function we(){V.value||Se.value==="click"&&(ce.value=!ce.value)}function ue(m){if(V.value)return;m.preventDefault();const x=ze=>{ze.preventDefault(),Xt("mouseup",document,x)};if(Jn("mouseup",document,x),Se.value!=="mousedown")return;ce.value=!0;const J=()=>{ce.value=!1,Xt("mouseup",document,J)};Jn("mouseup",document,J)}function Ce(m){var x;switch((x=t.onKeydown)===null||x===void 0||x.call(t,m),m.code){case"Escape":F();break;case"Enter":case"NumpadEnter":I(m);break}}function I(m){var x,J;if(t.passivelyActivated){const{value:ze}=S;if(ze){t.internalDeactivateOnEnter&&F();return}m.preventDefault(),t.type==="textarea"?(x=a.value)===null||x===void 0||x.focus():(J=u.value)===null||J===void 0||J.focus()}}function F(){t.passivelyActivated&&(S.value=!1,of(()=>{var m;(m=o.value)===null||m===void 0||m.focus()}))}function G(){var m,x,J;V.value||(t.passivelyActivated?(m=o.value)===null||m===void 0||m.focus():((x=a.value)===null||x===void 0||x.focus(),(J=u.value)===null||J===void 0||J.focus()))}function ge(){var m;!((m=o.value)===null||m===void 0)&&m.contains(document.activeElement)&&document.activeElement.blur()}function Oe(){var m,x;(m=a.value)===null||m===void 0||m.select(),(x=u.value)===null||x===void 0||x.select()}function be(){V.value||(a.value?a.value.focus():u.value&&u.value.focus())}function De(){const{value:m}=o;(m==null?void 0:m.contains(document.activeElement))&&m!==document.activeElement&&F()}function Ee(m){const{type:x,pair:J,autosize:ze}=t;if(!J&&ze)if(x==="textarea"){const{value:We}=l;We&&(We.textContent=(m!=null?m:"")+`\r
`)}else{const{value:We}=c;We&&(m?We.textContent=m:We.innerHTML="&nbsp;")}}function Nt(){Ue()}const un=he({top:"0"});function Om(m){var x;const{scrollTop:J}=m.target;un.value.top=`${-J}px`,(x=h.value)===null||x===void 0||x.syncUnifiedContainer()}let Ts=null;Ur(()=>{const{autosize:m,type:x}=t;m&&x==="textarea"?Ts=Tn(b,J=>{!Array.isArray(J)&&J!==D&&Ee(J)}):Ts==null||Ts()});let Is=null;Ur(()=>{t.type==="textarea"?Is=Tn(b,m=>{var x;!Array.isArray(m)&&m!==D&&((x=h.value)===null||x===void 0||x.syncUnifiedContainer())}):Is==null||Is()}),Br(Am,{mergedValueRef:b,maxlengthRef:mt,mergedClsPrefixRef:e});const Mm={wrapperElRef:o,inputElRef:u,textareaElRef:a,isCompositing:E,focus:G,blur:ge,select:Oe,deactivate:De,activate:be},Dm=SA("Input",i,e),du=de(()=>{const{value:m}=H,{common:{cubicBezierEaseInOut:x},self:{color:J,borderRadius:ze,textColor:We,caretColor:et,caretColorError:Dn,caretColorWarning:Ln,textDecorationColor:Fn,border:_i,borderDisabled:vi,borderHover:ma,borderFocus:Lm,placeholderColor:Fm,placeholderColorDisabled:$m,lineHeightTextarea:Bm,colorDisabled:Um,colorFocus:Hm,textColorDisabled:zm,boxShadowFocus:Wm,iconSize:jm,colorFocusWarning:Vm,boxShadowFocusWarning:qm,borderWarning:Km,borderFocusWarning:Gm,borderHoverWarning:Ym,colorFocusError:Xm,boxShadowFocusError:Jm,borderError:Qm,borderFocusError:Zm,borderHoverError:e_,clearSize:t_,clearColor:n_,clearColorHover:r_,clearColorPressed:i_,iconColor:s_,iconColorDisabled:o_,suffixTextColor:a_,countTextColor:l_,iconColorHover:c_,iconColorPressed:u_,loadingColor:d_,loadingColorError:h_,loadingColorWarning:f_,[Js("padding",m)]:p_,[Js("fontSize",m)]:g_,[Js("height",m)]:m_}}=s.value,{left:__,right:v_}=SI(p_);return{"--n-bezier":x,"--n-count-text-color":l_,"--n-color":J,"--n-font-size":g_,"--n-border-radius":ze,"--n-height":m_,"--n-padding-left":__,"--n-padding-right":v_,"--n-text-color":We,"--n-caret-color":et,"--n-text-decoration-color":Fn,"--n-border":_i,"--n-border-disabled":vi,"--n-border-hover":ma,"--n-border-focus":Lm,"--n-placeholder-color":Fm,"--n-placeholder-color-disabled":$m,"--n-icon-size":jm,"--n-line-height-textarea":Bm,"--n-color-disabled":Um,"--n-color-focus":Hm,"--n-text-color-disabled":zm,"--n-box-shadow-focus":Wm,"--n-loading-color":d_,"--n-caret-color-warning":Ln,"--n-color-focus-warning":Vm,"--n-box-shadow-focus-warning":qm,"--n-border-warning":Km,"--n-border-focus-warning":Gm,"--n-border-hover-warning":Ym,"--n-loading-color-warning":f_,"--n-caret-color-error":Dn,"--n-color-focus-error":Xm,"--n-box-shadow-focus-error":Jm,"--n-border-error":Qm,"--n-border-focus-error":Zm,"--n-border-hover-error":e_,"--n-loading-color-error":h_,"--n-clear-color":n_,"--n-clear-size":t_,"--n-clear-color-hover":r_,"--n-clear-color-pressed":i_,"--n-icon-color":s_,"--n-icon-color-hover":c_,"--n-icon-color-pressed":u_,"--n-icon-color-disabled":o_,"--n-suffix-text-color":a_}}),wr=r?Sm("input",de(()=>{const{value:m}=H;return m[0]}),du,t):void 0;return Object.assign(Object.assign({},Mm),{wrapperElRef:o,inputElRef:u,inputMirrorElRef:c,inputEl2Ref:d,textareaElRef:a,textareaMirrorElRef:l,textareaScrollbarInstRef:h,rtlEnabled:Dm,uncontrolledValue:g,mergedValue:b,passwordVisible:ce,mergedPlaceholder:q,showPlaceholder1:Z,showPlaceholder2:L,mergedFocus:re,isComposing:E,activated:S,showClearButton:ye,mergedSize:H,mergedDisabled:V,textDecorationStyle:fe,mergedClsPrefix:e,mergedBordered:n,mergedShowPasswordOn:Se,placeholderStyle:un,mergedStatus:z,textAreaScrollContainerWidth:ie,handleTextAreaScroll:Om,handleCompositionStart:p,handleCompositionEnd:v,handleInput:y,handleInputBlur:w,handleInputFocus:A,handleWrapperBlur:M,handleWrapperFocus:R,handleMouseEnter:K,handleMouseLeave:ae,handleMouseDown:B,handleChange:T,handleClick:U,handleClear:$,handlePasswordToggleClick:we,handlePasswordToggleMousedown:ue,handleWrapperKeyDown:Ce,handleTextAreaMirrorResize:Nt,getTextareaScrollContainer:()=>a.value,mergedTheme:s,cssVars:r?void 0:du,themeClass:wr==null?void 0:wr.themeClass,onRender:wr==null?void 0:wr.onRender})},render(){const{mergedClsPrefix:t,mergedStatus:e,themeClass:n,onRender:r,$slots:i}=this;return r==null||r(),k("div",{ref:"wrapperElRef",class:[`${t}-input`,n,e&&`${t}-input--${e}-status`,{[`${t}-input--rtl`]:this.rtlEnabled,[`${t}-input--disabled`]:this.mergedDisabled,[`${t}-input--textarea`]:this.type==="textarea",[`${t}-input--resizable`]:this.resizable&&!this.autosize,[`${t}-input--autosize`]:this.autosize,[`${t}-input--round`]:this.round&&this.type!=="textarea",[`${t}-input--pair`]:this.pair,[`${t}-input--focus`]:this.mergedFocus,[`${t}-input--stateful`]:this.stateful}],style:this.cssVars,tabindex:!this.mergedDisabled&&this.passivelyActivated&&!this.activated?0:void 0,onFocus:this.handleWrapperFocus,onBlur:this.handleWrapperBlur,onClick:this.handleClick,onMousedown:this.handleMouseDown,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd,onKeyup:this.onKeyup,onKeydown:this.handleWrapperKeyDown},k("div",{class:`${t}-input-wrapper`},Ds(i.prefix,s=>s&&k("div",{class:`${t}-input__prefix`},s)),this.type==="textarea"?k(IA,{ref:"textareaScrollbarInstRef",class:`${t}-input__textarea`,container:this.getTextareaScrollContainer,triggerDisplayManually:!0,useUnifiedContainer:!0},{default:()=>{const{textAreaScrollContainerWidth:s}=this,o={width:this.autosize&&s&&`${s}px`};return k(Le,null,k("textarea",Object.assign({},this.inputProps,{ref:"textareaElRef",class:`${t}-input__textarea-el`,autofocus:this.autofocus,rows:Number(this.rows),placeholder:this.placeholder,value:this.mergedValue,disabled:this.mergedDisabled,maxlength:this.maxlength,minlength:this.minlength,readonly:this.readonly,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,style:[this.textDecorationStyle[0],o],onBlur:this.handleInputBlur,onFocus:this.handleInputFocus,onInput:this.handleInput,onChange:this.handleChange,onScroll:this.handleTextAreaScroll})),this.showPlaceholder1?k("div",{class:`${t}-input__placeholder`,style:[this.placeholderStyle,o],key:"placeholder"},this.mergedPlaceholder[0]):null,this.autosize?k(Al,{onResize:this.handleTextAreaMirrorResize},{default:()=>k("div",{ref:"textareaMirrorElRef",class:`${t}-input__textarea-mirror`,key:"mirror"})}):null)}}):k("div",{class:`${t}-input__input`},k("input",Object.assign({type:this.type==="password"&&this.mergedShowPasswordOn&&this.passwordVisible?"text":this.type},this.inputProps,{ref:"inputElRef",class:`${t}-input__input-el`,style:this.textDecorationStyle[0],tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[0],disabled:this.mergedDisabled,maxlength:this.maxlength,minlength:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[0]:this.mergedValue,readonly:this.readonly,autofocus:this.autofocus,size:this.attrSize,onBlur:this.handleInputBlur,onFocus:this.handleInputFocus,onInput:s=>this.handleInput(s,0),onChange:s=>this.handleChange(s,0)})),this.showPlaceholder1?k("div",{class:`${t}-input__placeholder`},k("span",null,this.mergedPlaceholder[0])):null,this.autosize?k("div",{class:`${t}-input__input-mirror`,key:"mirror",ref:"inputMirrorElRef"},"\xA0"):null),!this.pair&&Ds(i.suffix,s=>s||this.clearable||this.showCount||this.mergedShowPasswordOn||this.loading!==void 0?k("div",{class:`${t}-input__suffix`},[Ds(i.clear,o=>(this.clearable||o)&&k(Fl,{clsPrefix:t,show:this.showClearButton,onClear:this.handleClear},{default:()=>o})),this.internalLoadingBeforeSuffix?null:s,this.loading!==void 0?k(RA,{clsPrefix:t,loading:this.loading,showArrow:!1,showClear:!1,style:this.cssVars}):null,this.internalLoadingBeforeSuffix?s:null,this.showCount&&this.type!=="textarea"?k(Oh,null,{default:o=>{var a;return(a=i.count)===null||a===void 0?void 0:a.call(i,o)}}):null,this.mergedShowPasswordOn&&this.type==="password"?k(uu,{clsPrefix:t,class:`${t}-input__eye`,onMousedown:this.handlePasswordToggleMousedown,onClick:this.handlePasswordToggleClick},{default:()=>this.passwordVisible?Xs(i["password-visible-icon"],()=>[k(aA,null)]):Xs(i["password-invisible-icon"],()=>[k(lA,null)])}):null]):null)),this.pair?k("span",{class:`${t}-input__separator`},Xs(i.separator,()=>[this.separator])):null,this.pair?k("div",{class:`${t}-input-wrapper`},k("div",{class:`${t}-input__input`},k("input",{ref:"inputEl2Ref",type:this.type,class:`${t}-input__input-el`,tabindex:this.passivelyActivated&&!this.activated?-1:void 0,placeholder:this.mergedPlaceholder[1],disabled:this.mergedDisabled,maxlength:this.maxlength,minlength:this.minlength,value:Array.isArray(this.mergedValue)?this.mergedValue[1]:void 0,readonly:this.readonly,style:this.textDecorationStyle[1],onBlur:this.handleInputBlur,onFocus:this.handleInputFocus,onInput:s=>this.handleInput(s,1),onChange:s=>this.handleChange(s,1)}),this.showPlaceholder2?k("div",{class:`${t}-input__placeholder`},k("span",null,this.mergedPlaceholder[1])):null),Ds(i.suffix,s=>(this.clearable||s)&&k("div",{class:`${t}-input__suffix`},[this.clearable&&k(Fl,{clsPrefix:t,show:this.showClearButton,onClear:this.handleClear},{default:()=>{var o;return(o=i.clear)===null||o===void 0?void 0:o.call(i)}}),s]))):null,this.mergedBordered?k("div",{class:`${t}-input__border`}):null,this.mergedBordered?k("div",{class:`${t}-input__state-border`}):null,this.showCount&&this.type==="textarea"?k(Oh,null,{default:s=>{var o;return(o=i.count)===null||o===void 0?void 0:o.call(i,s)}}):null)}});const FA=Be({props:{color:null},setup(t){return Mf(e=>({"190e8038":t.color||"white"})),(e,n)=>(Te(),Je("button",null,"\u2716"))}});var Nm=an(FA,[["__scopeId","data-v-1f8d5a2e"]]);const $A=Vo("\u2716"),BA=Be({props:{text:null,color:null,author:null,onDelete:null,id:null},setup(t){const{author:e}=t;Mf(s=>({"6ea6424b":t.color}));const r=qe("user").uid===e,i=qe("board");return(s,o)=>{var a;return Te(),Je("li",{class:Qr({hidden:!r&&((a=Ct(i))==null?void 0:a.cardsHidden)})},[Qe(Nm,{onClick:o[0]||(o[0]=l=>t.onDelete(String(t.id)))},{default:Zl(()=>[$A]),_:1}),Vo(" "+Fr(t.text),1)],2)}}});var UA=an(BA,[["__scopeId","data-v-3028bc20"]]);const HA=Be({props:{title:null,color:null,boardId:null,columnId:null,cards:null},setup(t){const{columnId:e,boardId:n}=t,r=gr({inputText:""}),i=qe("user");function s(){r.inputText.trim()!==""&&(!(i!=null&&i.uid)||(bI(n,e,{text:r.inputText,author:i.uid}),r.inputText=""))}function o(l){yI(n,e,l)}function a(l){l.metaKey&&l.key==="Enter"&&(l.preventDefault(),s())}return(l,c)=>(Te(),Je("section",null,[at("h2",null,Fr(t.title),1),at("ul",null,[(Te(!0),Je(Le,null,Gi(t.cards,(u,d)=>(Te(),Kt(UA,{id:d,author:u.author,text:u.text,color:t.color,onDelete:o},null,8,["id","author","text","color"]))),256))]),Qe(Ct(LA),{class:"input",value:Ct(r).inputText,"onUpdate:value":c[0]||(c[0]=u=>Ct(r).inputText=u),type:"textarea",autosize:"",placeholder:"Add new card",onKeydown:a},null,8,["value"])]))}});var zA=an(HA,[["__scopeId","data-v-b7fa6ae8"]]);const WA={class:"board"},jA={class:"columns"},VA={class:"options"},qA=Be({setup(t){const e=qe("board"),n=qe("boardId"),r=qe("user");Ur(()=>{r.uid&&$g(r.uid,n)});function i(){_I(n,!e.cardsHidden)}function s(){return e.cardsHidden?"Show all cards":"Hide other cards"}function o(u){u.key==="Enter"&&(u.target.blur(),u.preventDefault())}function a(u){const d=(u==null?void 0:u.target).value.trim();vI(n,d),c.value=d||"Untitled Retro"}function l(){c.value==="Untitled Retro"&&(c.value="")}const c=he(e.title||"Untitled Retro");return Tn(e,u=>{c.value=u.title||"Untitled Retro"}),(u,d)=>(Te(),Je(Le,null,[at("div",WA,[tb(at("input",{class:Qr({untitled:c.value==="Untitled Retro"}),"onUpdate:modelValue":d[0]||(d[0]=h=>c.value=h),onKeypress:o,onFocusout:a,onFocusin:l},null,34),[[Gb,c.value]]),at("section",jA,[(Te(!0),Je(Le,null,Gi(Ct(e).columns,(h,_)=>{var g;return Te(),Kt(zA,{cards:(g=h.cards)!=null?g:[],"column-id":String(_),"board-id":Ct(n),key:String(_),title:h.title,color:h.color},null,8,["cards","column-id","board-id","title","color"])}),128))])]),at("section",VA,[Qe(II,{onClick:i,text:s()},null,8,["text"])])],64))}});var KA=an(qA,[["__scopeId","data-v-a2bc0e1e"]]);const GA={},YA={class:"loader"};function XA(t,e){return Te(),Je("div",YA,"Loading...")}var JA=an(GA,[["render",XA],["__scopeId","data-v-840bd5c8"]]);const QA={key:0},ZA={key:1},eN={key:1},tN=Be({props:{boardId:null},setup(t){const{boardId:e}=t,n=mI(e);return Br("boardId",e),Br("board",n),(r,i)=>(Te(),Je(Le,null,[Ct(n).loading?Ai("",!0):(Te(),Je("main",QA,[Ct(n).exists?(Te(),Kt(KA,{key:0})):Ai("",!0),Ct(n).exists?Ai("",!0):(Te(),Je("div",ZA,"Couldn't find board"))])),Ct(n).loading?(Te(),Je("main",eN,[Qe(JA)])):Ai("",!0)],64))}});var nN=an(tN,[["__scopeId","data-v-b2bd279e"]]);const rN=Vo("\u2716"),iN={class:"columns"},sN=Be({props:{board:null,isTemplate:{type:Boolean}},emits:["delete"],setup(t,{emit:e}){function n(r){r.stopPropagation(),e("delete")}return(r,i)=>(Te(),Je("div",{class:Qr(["board",{template:t.isTemplate}])},[t.isTemplate?Ai("",!0):(Te(),Kt(Nm,{key:0,color:"black",onClick:n},{default:Zl(()=>[rN]),_:1})),at("h3",null,Fr(t.board.title||"Untitled Retro"),1),at("div",iN,[(Te(!0),Je(Le,null,Gi(t.board.columns,s=>(Te(),Je("div",{class:"column",style:Ao({backgroundColor:s.color})},Fr(s.title),5))),256))])],2))}});var Mh=an(sN,[["__scopeId","data-v-4421a504"]]);const oN=[{title:"Mad Sad Glad",columns:[{title:"Mad",color:"#f44336"},{title:"Sad",color:"#e91e63"},{title:"Glad",color:"#9c27b0"}]},{title:"Start Stop Continue",columns:[{title:"Start",color:"#2196f3"},{title:"Stop",color:"#ff9800"},{title:"Continue",color:"#009688"}]},{title:"Sailboat",columns:[{title:"What is the wind pushing our sails that make us go fast",color:"#f44336"},{title:"What anchors are holding us back",color:"#e91e63"},{title:"What rocks are ahead of us that risk our future",color:"#9c27b0"},{title:"What is our ideal island destination",color:"#673ab7"}]}],km=t=>(Tv("data-v-591383d7"),t=t(),Iv(),t),aN={class:"container"},lN=km(()=>at("h2",null,"start a new board",-1)),cN=km(()=>at("h2",null,"your boards",-1)),uN=Be({props:{navigateToBoard:null},setup(t){const{navigateToBoard:e}=t,n=qe("user"),r=de(()=>gI(n.uid));function i(o){CI(n.uid,o)}async function s(o){if(!(n!=null&&n.uid))return;const a=await wI(n.uid,o);a&&e(a)}return(o,a)=>(Te(),Je("div",aN,[at("main",null,[at("h1",null,"\u{1F680} quick retro "+Fr("")+"\u{1F680}",1),lN,at("section",null,[(Te(!0),Je(Le,null,Gi(Ct(oN),l=>(Te(),Kt(Mh,{onClick:c=>s(l),board:l,"is-template":!0},null,8,["onClick","board"]))),256))]),cN,at("section",null,[(Te(!0),Je(Le,null,Gi(Ct(r),(l,c)=>(Te(),Kt(Mh,{onClick:u=>t.navigateToBoard(c),onDelete:u=>i(c),board:l,"is-template":!1},null,8,["onClick","onDelete","board"]))),256))])])]))}});var dN=an(uN,[["__scopeId","data-v-591383d7"]]);const hN=Be({setup(t){const e=he(window.location.hash.slice(1));function n(i){console.log("navigating to board",i),history.pushState({},"",`#${i}`),e.value=i}addEventListener("popstate",()=>{console.log(window.location.hash.slice(1)),e.value=window.location.hash.slice(1)});const r=EI();return Br("user",r),(i,s)=>e.value&&e.value.length>0?(Te(),Kt(nN,{key:0,boardId:e.value},null,8,["boardId"])):(Te(),Kt(dN,{key:1,"navigate-to-board":n}))}});Jb(hN).mount("#app")});export default fN();
